...
void sensi_coor(
  ...
  char description[13] = "            ", *lakon = NULL, cflag[1] = " ",
       fneig[132] = "", stiffmatrix[132] = "", *lakonfa = NULL,
       *objectset = NULL;

  static int outputnormals = 1;

  ITG *inum = NULL, k, *irow = NULL, ielas = 0, icmd = 0, iinc = 1, nasym = 0,
      mass[2] = {0, 0}, stiffness = 1, buckling = 0, rhsi = 1, intscheme = 0,
      *ncocon = NULL, *nshcon = NULL, mode = -1, noddiam = -1, coriolis = 0,
      iout, *itg = NULL, ntg = 0, ngraph = 1, mt = mi[1] + 1, ne0,
      *integerglob = NULL, icfd = 0, *inomat = NULL, *islavact = NULL,
      *islavnode = NULL, *nslavnode = NULL, *islavsurf = NULL, nmethodl,
      *kon = NULL, *ipkon = NULL, *ielmat = NULL, nzss, *mast1 = NULL,
      *irows = NULL, *jqs = NULL, *ipointer = NULL, i, iread,
      *nactdofinv = NULL, iobject, *iponoel = NULL, node, *nodedesi = NULL,
      *ipoface = NULL, *nodface = NULL, *inoel = NULL, icoordinate = 1,
      ishapeenergy = 0, imass = 0, idisplacement = 0, *istartdesi = NULL,
      *ialdesi = NULL, *ipoeldi = NULL, *ieldi = NULL, *istartelem = NULL,
      *ialelem = NULL, ieigenfrequency = 0, cyclicsymmetry = 0, nherm, nev, iev,
      inoelsize, *itmp = NULL, nmd, nevd, *nm = NULL, *ielorien = NULL,
      igreen = 0, iglob = 0, idesvar = 0, inorm = 0, irand = 0,
      *nodedesiinv = NULL, iregion = 0, *konfa = NULL, *ipkonfa = NULL, nsurfs,
      ifree, *iponor = NULL, *iponoelfa = NULL, *inoelfa = NULL, ifreemax,
      *iponexp = NULL, *ipretinfo = NULL, nfield, iforce, *nod2nd3rd = NULL,
      *nod1st = NULL, ishape = 0, iscaleflag, istart, modalstress = 0,
      ifeasd = 0, *nx = NULL, *ny = NULL, *nz = NULL, *nodes = NULL;

  double *stn = NULL, *v = NULL, *een = NULL, cam[5], *xstiff = NULL,
         *stiini = NULL, *tper, *f = NULL, *fn = NULL, qa[4], *epn = NULL,
         *xstateini = NULL, *xdesi = NULL, *vini = NULL, *stx = NULL,
         *enern = NULL, *xbounact = NULL, *xforcact = NULL, *xloadact = NULL,
         *t1act = NULL, *ampli = NULL, *xstaten = NULL, *eei = NULL,
         *enerini = NULL, *cocon = NULL, *shcon = NULL, *qfx = NULL,
         *dfm = NULL, *qfn = NULL, *cgr = NULL, *xbodyact = NULL,
         *springarea = NULL, *emn = NULL, *clearini = NULL, ptime = 0.,
         *emeini = NULL, *doubleglob = NULL, *au = NULL, *ad = NULL, *b = NULL,
         *aub = NULL, *adb = NULL, *pslavsurf = NULL, *pmastsurf = NULL,
         *cdn = NULL, *xstate = NULL, *fnext = NULL, *energyini = NULL,
         *energy = NULL, *ener = NULL, *dxstiff = NULL, *d = NULL, *z = NULL,
         distmin, *df = NULL, *dgdx = NULL, sigma = 0, *extnor = NULL,
         *veold = NULL, *accold = NULL, bet, gam, sigmak = 1., sigmal = 1.,
         dtime, time, reltime = 1., *fint = NULL, *xnor = NULL, *dgdxdy = NULL,
         *x = NULL, *y = NULL, *xo = NULL, *yo = NULL, *zo = NULL, *dist = NULL,
         *dummy = NULL;
  ...
  /* determining the global values to be used as boundary conditions for a
   * submodel */
  ...
  if (ieigenfrequency == 1) {
    ...
    if ((f1 = fopen(fneig, "rb")) == NULL) {
      ...
      printf(
          " *INFO  in sensi_coor: if there are problems reading the .eig file "
          "this may be due to:\n");
    ...
    if (fread(&cyclicsymmetry, sizeof(ITG), 1, f1) != 1) {
      printf(
          " *ERROR in sensi_coor reading the cyclic symmetry flag in the "
          "eigenvalue file");
      printf(
          " *INFO  in sensi_coor: if there are problems reading the .eig file "
          "this may be due to:\n");
    ...
    if (fread(&nherm, sizeof(ITG), 1, f1) != 1) {
      printf(
          " *ERROR in sensi_coor reading the Hermitian flag in the eigenvalue "
          "file");
      printf(
          " *INFO  in sensi_coor: if there are problems reading the .eig file "
          "this may be due to:\n");
    ...
    if (nherm != 1) {
      printf(
          " *ERROR in sensi_coor: the eigenvectors in the .eig-file result\n");
    ...
    if (fread(&iperturb[0], sizeof(ITG), 1, f1) != 1) {
      printf(
          " *ERROR in sensi_coor reading the perturbation flag in the "
          "eigenvalue file");
      printf(
          " *INFO  in sensi_coor: if there are problems reading the .eig file "
          "this may be due to:\n");
    ...
    if (iperturb[0] == 1) {
      if (fread(vold, sizeof(double), mt * *nk, f1) != mt * *nk) {
        printf(
            " *ERROR in sensi_coor reading the reference displacements in the "
            "eigenvalue file...");
        exit(0);
      }
    }
  ...
  FORTRAN(findextsurface, (nodface, ipoface, ne, ipkon, lakon, kon, konfa,
                           ipkonfa, nk, lakonfa, &nsurfs, &ifreemax, &ifree));
  ...
  FORTRAN(extfacepernode,
          (iponoelfa, inoelfa, lakonfa, ipkonfa, konfa, &nsurfs, &inoelsize));
  ...
  if (*ne2d != 0) {
    ...
    FORTRAN(getdesiinfo2d,
            (set, istartset, iendset, ialset, nset, mi, nactdof, ndesi,
             nodedesi, ntie, tieset, nodedesiinv, lakon, ipkon, kon, iponoelfa,
             nod2nd3rd, iponor2d, knor2d, iponoel2d, inoel2d, nobject,
             objectset, nod1st, ne, jobnamef, rig));

  } else {
    FORTRAN(getdesiinfo3d,
            (set, istartset, iendset, ialset, nset, mi, nactdof, ndesi,
             nodedesi, ntie, tieset, itmp, nmpc, nodempc, ipompc, nodedesiinv,
             iponoel, inoel, lakon, ipkon, kon, &iregion, ipoface, nodface, nk,
             jobnamef, ipkonfa, lakonfa, konfa, &nsurfs));
  }
  ...
  FORTRAN(elemperdesi,
          (ndesi, nodedesi, iponoel, inoel, istartdesi, ialdesi, lakon, ipkon,
           kon, nodedesiinv, &icoordinate, &iregion));
  ...
  FORTRAN(normalsonsurface_se,
          (ipkon, kon, lakon, extnor, co, nk, ipoface, nodface, nactdof, mi,
           nodedesiinv, &iregion, iponoelfa, ndesi, nodedesi, nod2nd3rd, ikboun,
           nboun, ne2d));
  ...
  FORTRAN(writeinputdeck,
          (nk, co, iponoelfa, inoelfa, konfa, ipkonfa, lakonfa, &nsurfs, iponor,
           xnor, nodedesiinv, jobnamef, iponexp, nmpc, labmpc, ipompc, nodempc,
           ipretinfo, kon, ipkon, lakon, iponoel, inoel, iponor2d, knor2d,
           ipoface, nodface, ne, x, y, z, xo, yo, zo, nx, ny, nz, nodes, dist,
           ne2d, nod1st, nod2nd3rd, extnor, nodedesi, ndesi));
  ...
  if (outputnormals == 1) {
    ...
    if (strcmp1(&filab[4], "I") == 0) {
      FORTRAN(map3dto1d2d, (extnor, ipkon, inum, kon, lakon, &nfield, nk, ne,
    ...
    frd_sen(co, nk, stn, inum, nmethod, kode, filab, &ptime, nstate_, istep,
            ...
            istartset, iendset, ialset, jobnamec, output, extnor, &iobject,
  ...
  mastructse(kon, ipkon, lakon, ne, ipompc, nodempc, nmpc, nactdof, jqs, &mast1,
             &irows, ipointer, &nzss, mi, mortar, nodedesi, ndesi, &icoordinate,
             ielorien, istartdesi, ialdesi);
  ...
  if (ieigenfrequency == 1) {
    ...
    if (!cyclicsymmetry) {
      if (fread(&nev, sizeof(ITG), 1, f1) != 1) {
        printf(
            " *ERROR in sensi_coor reading the number of eigenvalues in the "
            "eigenvalue file");
        printf(
            " *INFO  in sensi_coor: if there are problems reading the .eig "
      ...
      if (fread(d, sizeof(double), nev, f1) != nev) {
        printf(
            " *ERROR in sensi_coor reading the eigenvalues in the eigenvalue "
            "file");
        printf(
            " *INFO  in sensi_coor: if there are problems reading the .eig "
            "file this may be due to:\n");
      ...
      if (fread(ad, sizeof(double), neq[1], f1) != neq[1]) {
        printf(
            " *ERROR in sensi_coor reading the diagonal of the stiffness "
      ...
      if (fread(au, sizeof(double), nzsprevstep[2], f1) != nzsprevstep[2]) {
        printf(
            " *ERROR in sensi_coor reading the off-diagonals of the stiffness "
            "matrix in the eigenvalue file");
        printf(
            " *INFO  in sensi_coor: if there are problems reading the .eig "
            "file this may be due to:\n");
      ...
      if (fread(adb, sizeof(double), neq[1], f1) != neq[1]) {
        printf(
            " *ERROR in sensi_coor reading the diagonal of the mass matrix in "
            "the eigenvalue file");
        printf(
            " *INFO  in sensi_coor: if there are problems reading the .eig "
            "file this may be due to:\n");
      ...
      if (fread(aub, sizeof(double), nzs[1], f1) != nzs[1]) {
        printf(
            " *ERROR in sensi_coor reading the off-diagonals of the mass "
            "matrix in the  eigenvalue file");
        printf(
            " *INFO  in sensi_coor: if there are problems reading the .eig "
            "file this may be due to:\n");
      ...
      if (fread(z, sizeof(double), neq[1] * nev, f1) != neq[1] * nev) {
        printf(
            " *ERROR in sensi_coor reading the eigenvectors in the eigenvalue "
            "file");
        printf(
            " *INFO  in sensi_coor: if there are problems reading the .eig "
            "file this may be due to:\n");
      ...
      do {
        ...
        if (fread(&nevd, sizeof(ITG), 1, f1) != 1) {
          printf(
              " *ERROR in sensi_coor reading the number of eigenvalues for "
        ...
        if (fread(&d[nev], sizeof(double), nevd, f1) != nevd) {
          printf(
              " *ERROR in sensi_coor reading the eigenvalues for nodal "
        ...
        if (nev == 0) {
          ...
          if (fread(ad, sizeof(double), neq[1], f1) != neq[1]) {
            ...
            printf("        1) the nonexistence of the .eig file\n");
            printf(
                "        2) other boundary conditions than in the input "
                "deck\n");
            printf("           which created the .eig file\n\n");
            exit(0);
          }
          ...
          if (fread(au, sizeof(double), nzs[1], f1) != nzs[1]) {
            printf(
                " *ERROR in sensi_coor reading the off-diagonals of the "
          ...
          if (fread(adb, sizeof(double), neq[1], f1) != neq[1]) {
            printf(
                " *ERROR in sensi_coor reading the diagonal of the mass matrix "
        ...
        if (fread(&z[(long long)neq[1] * nev], sizeof(double), neq[1] * nevd,
                  f1) != neq[1] * nevd) {
          printf(
              " *ERROR in sensi_coor reading the eigenvectors for nodal "
              "diameter %" ITGFORMAT " in the eigenvalue file",
              nmd);
          printf(
              " *INFO  in sensi_coor: if there are problems reading the .eig "
    ...
    if ((idisplacement == 1) || ((ishapeenergy == 1) && (iperturb[1] == 1))) {
      /* reading the stiffness matrix from previous step for sensitivity
       * analysis */
      ...
      */
      ...
      if ((f1 = fopen(stiffmatrix, "rb")) == NULL) {
        printf(
            " *ERROR in sensi_coor: cannot open stiffness-matrix file for "
            "reading");
        exit(0);
      }
      ...
      if (fread(&nasym, sizeof(ITG), 1, f1) != 1) {
        printf(
            " *ERROR in sensi_coor reading the symmetry flag of the stiffness "
            "matrix file...");
        exit(0);
      }
      ...
      if (fread(nzs, sizeof(ITG), 3, f1) != 3) {
        printf(
            " *ERROR in sensi_coor reading the number of subdiagonal nonzeros "
            "in the stiffness matrix file...");
        exit(0);
      }
      ...
      if (fread(irow, sizeof(ITG), nzs[2], f1) != nzs[2]) {
        printf(
            " *ERROR in sensi_coor reading irow in the stiffness matrix "
            "file...");
        exit(0);
      }
      ...
      if (fread(jq, sizeof(ITG), neq[1] + 1, f1) != neq[1] + 1) {
        printf(
            " *ERROR in sensi_coor reading jq in the stiffness matrix file...");
        exit(0);
      }

      if (fread(icol, sizeof(ITG), neq[1], f1) != neq[1]) {
        printf(
            " *ERROR in sensi_coor reading icol in the stiffness matrix "
            "file...");
        exit(0);
      }
      ...
      if (fread(ad, sizeof(double), neq[1], f1) != neq[1]) {
        printf(
            " *ERROR in sensi_coor reading the diagonal of the stiffness "
            "matrix in the .stm-file");
        exit(0);
      }

      if (fread(au, sizeof(double), (nasym + 1) * nzs[2], f1) !=
          (nasym + 1) * nzs[2]) {
        printf(
            " *ERROR in sensi_coor reading the off-diagonals of the stiffness "
            "matrix in the .stm-file");
  ...
  /* loop over all eigenvalues, or, if it is not an eigenvalue sensitivity
     study, loop over just one value */
  ...
  for (iev = 0; iev < nev; iev++) {
    ...
    if (iread == 0) {
      ...
      results_se(co, nk, kon, ipkon, lakon, ne, v, stn, inum, stx, elcon,
                 nelcon, rhcon, nrhcon, alcon, nalcon, alzero, ielmat, ielorien,
                 norien, orab, ntmat_, t0, t1act, ithermal, prestr, iprestr,
                 filab, eme, emn, een, iperturb, f, fn, nactdof, &iout, qa,
                 vold, b, nodeboun, ndirboun, xbounact, nboun, ipompc, nodempc,
                 coefmpc, labmpc, nmpc, nmethod, cam, neq, veold, accold, &bet,
                 ...
                 istep, &iinc, springarea, &reltime, &ne0, xforc, nforc, thicke,
                 shcon, nshcon, sideload, xloadact, xloadold, &icfd, inomat,
                 pslavsurf, pmastsurf, mortar, islavact, cdn, islavnode,
                 nslavnode, ntie, clearini, islavsurf, ielprop, prop, energyini,
                 energy, df, &distmin, ndesi, nodedesi, sti, nkon, jqs, irows,
                 nactdofinv, &icoordinate, dxstiff, istartdesi, ialdesi, xdesi,
      ...
      if (ieigenfrequency == 0) {
        ...
        if (!cyclicsymmetry) {
          ...
          FORTRAN(resultsnoddir,
                  (nk, &v[mt * *nk], nactdof, &z[iev * neq[1] + neq[1] / 2],
                   ipompc, nodempc, coefmpc, nmpc, mi));
        }
      ...
      mafillsmmain_se(
          ...
          nactdof, neq, &nmethodl, ikmpc, ilmpc, ikboun, ilboun, elcon, nelcon,
          rhcon, nrhcon, alcon, nalcon, alzero, ielmat, ielorien, norien, orab,
          ntmat_, t0, t1act, ithermal, prestr, iprestr, vold, iperturb, sti,
          stx, iexpl, plicon, nplicon, plkcon, nplkcon, xstiff, npmat_, &dtime,
          ...
          ielprop, prop, &ne0, fnext, &distmin, ndesi, nodedesi, df, &nzss, jqs,
          irows, &icoordinate, dxstiff, xdesi, istartelem, ialelem, v, &sigma,
          &cyclicsymmetry, labmpc, ics, cs, mcs, &ieigenfrequency, set, nset,
          &sigmak);
      ...
      if (modalstress) {
        ...
        mafillsmmain_se(
            ...
            ipompc, nodempc, coefmpc, nmpc, nodeforc, ndirforc, xforcact, nforc,
            nelemload, sideload, xloadact, nload, xbodyact, ipobody, nbody, cgr,
            nactdof, neq, &nmethodl, ikmpc, ilmpc, ikboun, ilboun, elcon,
            nelcon, rhcon, nrhcon, alcon, nalcon, alzero, ielmat, ielorien,
            norien, orab, ntmat_, t0, t1act, ithermal, prestr, iprestr, vold,
            iperturb, sti, stx, iexpl, plicon, nplicon, plkcon, nplkcon, xstiff,
            npmat_, &dtime, matname, mi, ncmat_, mass, &stiffness, &buckling,
            &rhsi, &intscheme, physcon, shcon, nshcon, cocon, ncocon, ttime,
            ...
            pslavsurf, pmastsurf, mortar, clearini, ielprop, prop, &ne0, fnext,
            &distmin, ndesi, nodedesi, dfm, &nzss, jqs, irows, &icoordinate,
            dxstiff, xdesi, istartelem, ialelem, v, &sigmal, &cyclicsymmetry,
            labmpc, ics, cs, mcs, &ieigenfrequency, set, nset, &sigmak);
      }
      ...
      objectivemain_se(
          ...
          rhcon, nrhcon, alcon, nalcon, alzero, ielmat, ielorien, norien, orab,
          ntmat_, t0, t1act, ithermal, prestr, iprestr, filab, eme, emn, een,
          iperturb, f, fn, nactdof, &iout, qa, vold, nodeboun, ndirboun,
          xbounact, nboun, ipompc, nodempc, coefmpc, labmpc, nmpc, nmethod, cam,
          neq, veold, accold, &bet, &gam, &dtime, &time, ttime, plicon, nplicon,
          ...
          islavsurf, ielprop, prop, energyini, energy, &distmin, ndesi,
          nodedesi, nobject, objectset, g0, dgdx, sti, df, nactdofinv, jqs,
          irows, &idisplacement, nzs, jobnamec, isolver, icol, irow, jq, kode,
          cs, output, istartdesi, ialdesi, xdesi, orname, &icoordinate, &iev, d,
          z, au, ad, aub, adb, &cyclicsymmetry, &nzss, &nev, &ishapeenergy,
          fint, nlabel, &igreen, &nasym, iponoel, inoel, nodedesiinv, dgdxdy,
          nkon, nod2nd3rd, nod1st, ics, mcs, mpcend, &noddiam, ipobody, ibody,
          xbody, nbody, nobjectstart, dfm, physcon, ne2d);
      iout = 1;
    ...
    filterbackwardmain(co, dgdxglob, nobject, nk, nodedesi, ndesi, objectset,
                       xdesi, nobjectstart, iponoelfa, inoelfa, lakonfa, konfa,
                       ipkonfa, nodedesiinv, istartdesi, ialdesi, ipkon, lakon,
                       ipoface, nodface, kon, &iregion, isolver, dgdx, ne,
                       &nsurfs);
    ...
    if (*ne2d != 0) {
      FORTRAN(extrapol2dto3d,
              (dgdxglob, nod2nd3rd, ndesi, nodedesi, nobject, nk));
    }
    ...
    for (iobject = *nobjectstart; iobject < *nobject; iobject++) {
      ...
      if (strcmp1(&filab[4], "I") == 0) {
        FORTRAN(map3dto1d2d,
                (&dgdxglob[2 * *nk * iobject], ipkon, inum, kon, lakon, &nfield,
                 nk, ne, cflag, co, vold, &iforce, mi, ielprop, prop));
      }

      frd_sen(co, nk, stn, inum, nmethod, kode, filab, &ptime, nstate_, istep,
              &iinc, &mode, &noddiam, description, mi, &ngraph, ne, cs, set,
              nset, istartset, iendset, ialset, jobnamec, output, dgdxglob,

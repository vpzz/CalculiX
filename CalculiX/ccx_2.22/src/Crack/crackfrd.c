...
void crackfrd(ITG *nk, ITG *ngraph, ITG *noddiam, double *cs, ITG *kode,
              ...
              char *output, double *dkeqglob, double *wk1glob, double *wk2glob,
              double *wk3glob, double *phiglob, double *dadnglob,
  ...
  char m1[4] = " -1", m2[4] = " -2", m3[4] = " -3", fneig[132] = "",
       filab[87] = "";

  ITG icounter = 0, nkcoords;

  ITG null, i, j, noutloc, iset, iselect, nfield[2], ifieldstate[15],
      icompstate[15], ioutall = 0, nout, noutplus, noutmin, nstate_;
  ...
  frdset(filab, set, &iset, istartset, iendset, ialset, inum, &noutloc, &nout,
         nset, &noutmin, &noutplus, &iselect, ngraph);
  ...
  frdselect(xstaten, xstaten, &iset, &nkcoords, inum, m1, istartset, iendset,
            ialset, ngraph, &nstate_, ifieldstate, icompstate, nfield, &iselect,
            m2, f1, output, m3);

...
void dyna(double **cop, ITG *nk, ITG **konp, ITG **ipkonp, char **lakonp,
  ...
  char fneig[132] = "", description[13] = "            ", *lakon = NULL,
       *labmpc = NULL, *labmpcold = NULL, *tchar1 = NULL, *tchar2 = NULL,
       *tchar3 = NULL, cflag[1] = " ", jobnamef[396] = "";

  ITG nev, i, j, k, idof,
      *inum = NULL, id, intscheme = 0, iinc = 0, jprint = 0, l, iout, ielas = 0,
      icmd = 3, iprescribedboundary, init, mode = -1, noddiam = -1, *kon = NULL,
      *ipkon = NULL, *ielmat = NULL, *ielorien = NULL, *inotr = NULL,
      *nodeboun = NULL, *ndirboun = NULL, *iamboun = NULL, *ikboun = NULL,
      *ilboun = NULL, *nactdof = NULL, *ipompc = NULL, *nodempc = NULL,
      *ikmpc = NULL, *ilmpc = NULL, nsectors, nmpcold, mpcendold,
      *ipompcold = NULL, *nodempcold = NULL, *ikmpcold = NULL, *ilmpcold = NULL,
      kflag = 2, nmd, nevd, *nm = NULL, *iamt1 = NULL, *itg = NULL, ntg = 0,
      symmetryflag = 0, inputformat = 0, dashpot, lrw, liw, iddebdf = 0,
      *iwork = NULL, ngraph = 1, nkg, neg, ncont = 0, ne0, *ipneigh = NULL,
      *neigh = NULL, inext, itp = 0, *islavact = NULL, isteadystate, im,
      cyclicsymmetry, imax, *icole = NULL, *irowe = NULL, *jqe = NULL, nzse[3],
      nalset_ = *nalset, *ialset = *ialsetp, *istartset_ = NULL,
      *iendset_ = NULL, *itiefac = NULL, *islavsurf = NULL, *islavnode = NULL,
      mt = mi[1] + 1, *nslavnode = NULL, mortar = 0, *imddof = NULL, nmddof,
      kchdep = 0, *ikactmech = NULL, nactmech, iabsload = 0, iprev = 1,
      inonlinmpc = 0, ielem, *imdnode = NULL, nmdnode, *imdboun = NULL, nmdboun,
      *imdmpc = NULL, nmdmpc, intpointvar, *izdof = NULL, nzdof, iload, iforc,
      *iponoel = NULL, *inoel = NULL, *imdelem = NULL, nmdelem, nasym = 0,
      *nshcon = NULL, nherm, icfd = 0, *inomat = NULL, network = 0, iperturbsav,
  ...
  double *d = NULL, *z = NULL, *b = NULL, *zeta = NULL, *stiini = NULL,
         ...
         *t1act = NULL, *ampli = NULL, *aa = NULL, *bb = NULL, *aanew = NULL,
         *bj = NULL, *v = NULL, *aamech = NULL, *emn = NULL, *cdn = NULL, ptime,
         *stn = NULL, *stx = NULL, *een = NULL, *adb = NULL, *xstiff = NULL,
         *bjp = NULL, *aub = NULL, *temp_array1 = NULL, *temp_array2 = NULL,
         *aux = NULL, *f = NULL, *fn = NULL, *xbounact = NULL, *epn = NULL,
         *xstateini = NULL, *enern = NULL, *xstaten = NULL, *eei = NULL,
         *enerini = NULL, *qfn = NULL, *qfx = NULL, *xbodyact = NULL,
         *cgr = NULL, *au = NULL, *vbounact = NULL, *abounact = NULL, dtime,
         reltime, *t0 = NULL, *t1 = NULL, *t1old = NULL, physcon[1], zetaj, dj,
         ddj, h1, h2, h3, h4, h5, h6, sum, aai, bbi, tstart, tend, qa[4],
         cam[5], *accold = NULL, bet, gam, *ad = NULL, sigma = 0., alpham,
         betam, *bact = NULL, *bmin = NULL, *co = NULL, *xboun = NULL,
         *xbounold = NULL, *vold = NULL, *eme = NULL, *ener = NULL,
         *coefmpc = NULL, *fmpc = NULL, *coefmpcold, *veold = NULL,
         *xini = NULL, *rwork = NULL, *adc = NULL, *auc = NULL, *zc = NULL,
         *rpar = NULL, setnull, deltmx, fextmax, dd, dtheta, dthetaref, theta,
         *vini = NULL, *bcont = NULL, *vr = NULL, *vi = NULL, *stnr = NULL,
         *stni = NULL, *vmax = NULL, *stnmax = NULL, precision, resultmaxprev,
         resultmax, func, funcp, fexp, fexm, fcos, fsin, sump, *bp = NULL, h14,
         *bv = NULL, *cstr = NULL, *aube = NULL, *adbe = NULL, *sti = *stip,
         time0 = 0.0, time = 0.0, *xforcdiff = NULL, *xloaddiff = NULL,
         *xbodydiff = NULL, *t1diff = NULL, *xboundiff = NULL, *bprev = NULL,
         *bdiff = NULL, *springarea = NULL, *fextold = NULL, *eenmax = NULL,
         *fnr = NULL, *fni = NULL, *emeini = NULL, *xstate = NULL,
         *clearini = NULL, *shcon = NULL, *xmr = NULL, *xmi = NULL,
         *pslavsurf = NULL, *pmastsurf = NULL, *cdnr = NULL, *cdni = NULL,
         *tinc, *tper, *tmin, *tmax, *energyini = NULL, *energy = NULL,
         *fext = NULL, *smscale = NULL, *aut = NULL, *fnext = NULL;
  ...
  *nzl = 0;
  ...
  if ((f1 = fopen(fneig, "rb")) == NULL) {
    ...
    printf(
        " *INFO  in dyna: if there are problems reading the .eig file this may "
        "be due to:\n");
  ...
  if (fread(&cyclicsymmetry, sizeof(ITG), 1, f1) != 1) {
    printf(
        " *ERROR in dyna reading the cyclic symmetry flag in the eigenvalue "
        "file");
    printf(
        " *INFO  in dyna: if there are problems reading the .eig file this may "
        "be due to:\n");
  ...
  if (fread(&iperturb[0], sizeof(ITG), 1, f1) != 1) {
    printf(
        " *ERROR in dyna reading the perturbation flag in the eigenvalue file");
    printf(
        " *INFO  in dyna: if there are problems reading the .eig file this may "
        "be due to:\n");
    printf("        1) the nonexistence of the .eig file\n");
  ...
  if (iperturbsav != iperturb[0]) {
    if (iperturb[0] == 0) {
      printf(
          " *ERROR in dyna: the .eig-file was created without perturbation "
          "info\n");
      printf(
          "        the present *MODAL DYNAMIC step, however, contains the\n");
      printf("        perturbation parameter on the *STEP card.\n");
    } else if (iperturb[0] == 1) {
      printf(
          " *ERROR in dyna: the .eig-file was created with perturbation "
          "info\n");
      printf(
          "        the present *MODAL DYNAMIC step, however, does not contain "
          "the\n");
      printf("        perturbation parameter on the *STEP card.\n");
    }
    FORTRAN(stop, ());
  ...
  if (iperturb[0] == 1) {
    ...
    if (fread(vold, sizeof(double), mt * *nk, f1) != mt * *nk) {
      printf(
          " *ERROR in dyna reading the reference displacements in the "
          "eigenvalue file...");
      printf(
  ...
  if (!cyclicsymmetry) {
    ...
    if (fread(&nev, sizeof(ITG), 1, f1) != 1) {
      printf(
          " *ERROR in dyna reading the number of eigenvalues in the eigenvalue "
          "file");
      printf(
          " *INFO  in dyna: if there are problems reading the .eig file this "
          "may be due to:\n");
    ...
    if (fread(ad, sizeof(double), neq[1], f1) != neq[1]) {
      printf(
          " *ERROR in dyna reading the diagonal of the stiffness matrix in the "
          "eigenvalue file");
      printf(
          " *INFO  in dyna: if there are problems reading the .eig file this "
          "may be due to:\n");
    ...
    if (fread(au, sizeof(double), nzs[2], f1) != nzs[2]) {
      printf(
          " *ERROR in dyna reading the off-diagonals of the stiffness matrix "
    ...
    if (fread(adb, sizeof(double), neq[1], f1) != neq[1]) {
      printf(
          " *ERROR in dyna reading the diagonal of the mass matrix in the "
          "eigenvalue file");
      printf(
          " *INFO  in dyna: if there are problems reading the .eig file this "
          "may be due to:\n");
    ...
    if (fread(aub, sizeof(double), nzs[1], f1) != nzs[1]) {
      printf(
          " *ERROR in dyna reading the off-diagonals of the mass matrix in the "
          " eigenvalue file");
      printf(
          " *INFO  in dyna: if there are problems reading the .eig file this "
          "may be due to:\n");
    ...
    do {
      ...
      if (fread(&nevd, sizeof(ITG), 1, f1) != 1) {
        printf(
            " *ERROR in dyna reading the number of eigenvalues for nodal "
      ...
      if (fread(&d[nev], sizeof(double), nevd, f1) != nevd) {
        printf(
            " *ERROR in dyna reading the eigenvalues for nodal diameter "
            "%" ITGFORMAT " in the eigenvalue file",
            nmd);
        printf(
            " *INFO  in dyna: if there are problems reading the .eig file this "
            "may be due to:\n");
      ...
      if (nev == 0) {
        ...
        if (fread(ad, sizeof(double), neq[1], f1) != neq[1]) {
          printf(
              " *ERROR in dyna reading the diagonal of the stiffness matrix in "
              "the eigenvalue file");
          printf(
              " *INFO  in dyna: if there are problems reading the .eig file "
              "this may be due to:\n");
          printf("        1) the nonexistence of the .eig file\n");
          printf(
        ...
        if (fread(au, sizeof(double), nzs[1], f1) != nzs[1]) {
          printf(
              " *ERROR in dyna reading the off-diagonals of the stiffness "
        ...
        if (fread(aub, sizeof(double), nzs[1], f1) != nzs[1]) {
          printf(
              " *ERROR in dyna reading the off-diagonals of the mass matrix in "
              "the eigenvalue file");
          printf(
              " *INFO  in dyna: if there are problems reading the .eig file "
              "this may be due to:\n");
      ...
      if (fread(&z[(long long)neq[1] * nev], sizeof(double), neq[1] * nevd,
                f1) != neq[1] * nevd) {
        printf(
            " *ERROR in dyna reading the eigenvectors for nodal diameter "
            "%" ITGFORMAT " in the eigenvalue file",
            nmd);
        printf(
            " *INFO  in dyna: if there are problems reading the .eig file this "
  ...
  *tmax = *tmax / (*tper);
  ...
  if (dashpot) {
    if (cyclicsymmetry) {
      printf(
          " *ERROR in dyna: dashpots are not allowed in combination with "
          "cyclic symmetry\n");
      FORTRAN(stop, ());
    }
    ...
    FORTRAN(mafilldm,
            (co, nk, kon, ipkon, lakon, ne, nodeboun, ndirboun, xboun, nboun,
             ...
             nelemload, sideload, xload, nload, xbody, ipobody, nbody, cgr, adc,
             auc, nactdof, icol, jq, irow, neq, nzl, nmethod, ikmpc, ilmpc,
             ikboun, ilboun, elcon, nelcon, rhcon, nrhcon, alcon, nalcon,
             alzero, ielmat, ielorien, norien, orab, ntmat_, t0, t0, ithermal,
             prestr, iprestr, vold, iperturb, sti, nzs, stx, adb, aub, iexpl,
             plicon, nplicon, plkcon, nplkcon, xstiff, npmat_, &dtime, matname,
             mi, ncmat_, ttime, &time0, istep, &iinc, ibody, clearini, &mortar,
    ...
    for (i = 0; i < nev; i++) {
      opmain(&neq[1], &z[i * neq[1]], &zc[i * neq[1]], adc, auc, jq, irow);
    }
  ...
  //  else{
    ...
    if (nev < (ITG)xmodal[10]) {
      imax = nev;
      printf(
          " *WARNING in dyna: too many modal damping coefficients applied\n");
      printf(
  ...
  FORTRAN(temploaddiff,
          (xforcold, xforc, xforcact, iamforc, nforc, xloadold, xload, xloadact,
           ...
           &ntg, amname, ikboun, ilboun, nelemload, sideload, mi, xforcdiff,
           xloaddiff, xbodydiff, t1diff, xboundiff, &iabsload,
  ...
  rhsmain(co, nk, kon, ipkon, lakon, ne, ipompc, nodempc, coefmpc, nmpc,
          nodeforc, ndirforc, xforcact, nforc, nelemload, sideload, xloadact,
          nload, xbodyact, ipobody, nbody, cgr, fext, nactdof, &neq[1], nmethod,
          ikmpc, ilmpc, elcon, nelcon, rhcon, nrhcon, alcon, nalcon, alzero,
          ielmat, ielorien, norien, orab, ntmat_, t0, t1act, ithermal, iprestr,
          vold, iperturb, iexpl, plicon, nplicon, plkcon, nplkcon, npmat_,
          ttime, &time0, istep, &iinc, &dtime, physcon, ibody, xbodyold,
          &reltime, veold, matname, mi, ikactmech, &nactmech, ielprop, prop,
          sti, xstateini, xstate, nstate_, ntrans, inotr, trab, fnext);
  ...
  if (iprescribedboundary) {
    if (cyclicsymmetry) {
      printf(
          " *ERROR in dyna: prescribed boundaries are not allowed in "
    ...
    if (*idrct != 1) {
      printf(
          " *ERROR in dyna: variable increment length is not allwed in "
          "combination with prescribed boundaries\n");
      FORTRAN(stop, ());
    }
    ...
    dynboun(amta, namta, nam, ampli, &time0, ttime, &dtime, xbounold, xboun,
            xbounact, iamboun, nboun, nodeboun, ndirboun, ad, au, adb, aub,
            icol, irow, neq, nzs, &sigma, fext, isolver, &alpham, &betam, nzl,
            &init, bact, bmin, jq, amname, bv, bprev, bdiff, &nactmech,
            &iabsload, &iprev, &reltime);
    init = 0;
  }
  ...
  while (1. - theta > 1.e-6) {
    ...
    if ((*idrct != 1) && (iinc != 1)) {
      ...
      dthetaref = dtheta;
      checkinclength(&time0, ttime, &theta, &dtheta, idrct, tper, tmax, tmin,
                     ctrl, amta, namta, itpamp, &inext, &dthetaref, &itp,
                     &jprint, jout);
    }
    ...
    if (iabsload != 2) {
      rhsmain(co, nk, kon, ipkon, lakon, ne, ipompc, nodempc, coefmpc, nmpc,
              nodeforc, ndirforc, xforcdiff, nforc, nelemload, sideload,
              xloaddiff, nload, xbodydiff, ipobody, nbody, cgr, fext, nactdof,
              &neq[1], nmethod, ikmpc, ilmpc, elcon, nelcon, rhcon, nrhcon,
              alcon, nalcon, alzero, ielmat, ielorien, norien, orab, ntmat_, t0,
              t1diff, ithermal, iprestr, vold, iperturb, iexpl, plicon, nplicon,
              plkcon, nplkcon, npmat_, ttime, &time, istep, &iinc, &dtime,
      ...
      rhsmain(co, nk, kon, ipkon, lakon, ne, ipompc, nodempc, coefmpc, nmpc,
              ...
              &neq[1], nmethod, ikmpc, ilmpc, elcon, nelcon, rhcon, nrhcon,
              alcon, nalcon, alzero, ielmat, ielorien, norien, orab, ntmat_, t0,
              t1act, ithermal, iprestr, vold, iperturb, iexpl, plicon, nplicon,
              plkcon, nplkcon, npmat_, ttime, &time, istep, &iinc, &dtime,
              physcon, ibody, xbodyold, &reltime, veold, matname, mi, ikactmech,
              &nactmech, ielprop, prop, sti, xstateini, xstate, nstate_, ntrans,
              inotr, trab, fnext);
      ...
      if ((fextmax > deltmx) &&
        ...
        FORTRAN(temploaddiff,
                (xforcold, xforc, xforcact, iamforc, nforc, xloadold, xload,
                 ...
                 ilboun, nelemload, sideload, mi, xforcdiff, xloaddiff,
                 xbodydiff, t1diff, xboundiff, &iabsload, &iprescribedboundary,
                 ntrans, trab, inotr, veold, nactdof, bcont, fn, ipobody,
                 iponoel, inoel, ipkon, kon, lakon, ielprop, prop, ielmat,
                 shcon, nshcon, rhcon, nrhcon, ntmat_, cocon, ncocon));
        ...
        if (iabsload != 2) {
          ...
          rhsmain(co, nk, kon, ipkon, lakon, ne, ipompc, nodempc, coefmpc, nmpc,
                  ...
                  &dtime, physcon, ibody, xbodyold, &reltime, veold, matname,
                  mi, ikactmech, &nactmech, ielprop, prop, sti, xstateini,
                  xstate, nstate_, ntrans, inotr, trab, fnext);
        }

        /* correction for nonzero SPC's */

        if (iprescribedboundary) {
          dynboun(amta, namta, nam, ampli, &time, ttime, &dtime, xbounold,
                  xboun, xbounact, iamboun, nboun, nodeboun, ndirboun, ad, au,
                  adb, aub, icol, irow, neq, nzs, &sigma, fext, isolver,
      ...
      for (j = 0; j < nactmech; j++) {
        ...
        if (id != 0) {
          if (izdof[id - 1] == ikactmech[j]) {
            for (i = 0; i < nev; i++) {
              aamech[i] +=
                  z[(long long)i * nzdof + id - 1] * fext[ikactmech[j]];
            }
          } else {
            printf(" *ERROR in dyna\n");
            FORTRAN(stop, ());
    ...
    if (dashpot) {
      FORTRAN(subspace,
              (d, aa, bb, cc, &alpham, &betam, &nev, xini, cd, cv, &time, rwork,
               &lrw, &iinc, jout, rpar, bj, iwork, &liw, &iddebdf, bjp));
      if (iddebdf == 2) {
        liw = 56 + 2 * nev;
        RENEW(iwork, ITG, liw);
        for (i = 0; i < liw; i++) {
        ...
        iddebdf = 1;
        FORTRAN(subspace, (d, aa, bb, cc, &alpham, &betam, &nev, xini, cd, cv,
                           &time, rwork, &lrw, &iinc, jout, rpar, bj, iwork,
                           &liw, &iddebdf, bjp));
      }
    } else {
      for (l = 0; l < nev; l++) {
        ...
        if (fabs(d[l]) <= 1.e-10) {
          ...
          sum = tend * (aai * time +
                ...
                tstart * (aai * time + tstart * ((bbi * time - aai) / 2. -
                                                 bbi * tstart / 3.));
          sump = tend * (aai + bbi * tend / 2.) -
                 tstart * (aai + bbi * tstart / 2.);
        ...
        /*   subcritical damping */
          ...
          h14 = h1 / ddj;
          tstart = 0.;
          FORTRAN(fsub, (&time, &dtime, &aa[l], &bb[l], &ddj, &h1, &h2, &h3,
                         &h4, &func, &funcp));
          sum = func;
          sump = funcp;
          FORTRAN(fsub, (&time, &tstart, &aa[l], &bb[l], &ddj, &h1, &h2, &h3,
                         &h4, &func, &funcp));
          sum -= func;
          sump -= funcp;
          fexp = exp(-h1 * dtime);
          ...
          bj[l] =
              sum / ddj +
              fexp * (fcos + zetaj / sqrt(1. - zetaj * zetaj) * fsin) * cd[l] +
              fexp * fsin * cv[l] / ddj;
          bjp[l] = sump / ddj +
                   fexp *
                       ((-h1 + ddj * h14) * fcos + (-ddj - h1 * h14) * fsin) *
                       cd[l] +
        ...
        /*      supercritical damping */
          ...
          h6 = h4 * h4;
          tstart = 0.;
          FORTRAN(fsuper, (&time, &dtime, &aa[l], &bb[l], &h1, &h2, &h3, &h4,
                           &h5, &h6, &func, &funcp));
          sum = func;
          sump = funcp;
          FORTRAN(fsuper, (&time, &tstart, &aa[l], &bb[l], &h1, &h2, &h3, &h4,
                           &h5, &h6, &func, &funcp));
          sum -= func;
          sump -= funcp;
          ...
          h14 = zetaj * dj / ddj;
          bj[l] =
              sum / (2. * ddj) + (fexm + fexp) * cd[l] / 2. +
              zetaj * (fexm - fexp) / (2. * sqrt(zetaj * zetaj - 1.)) * cd[l] +
              (fexm - fexp) * cv[l] / (2. * ddj);
        ...
        /* critical damping */
          ...
          h4 = h2 * h3;
          tstart = 0.;
          FORTRAN(fcrit, (&time, &dtime, &aa[l], &bb[l], &zetaj, &dj, &ddj, &h1,
                          &h2, &h3, &h4, &func, &funcp));
          sum = func;
          sump = funcp;
          FORTRAN(fcrit, (&time, &tstart, &aa[l], &bb[l], &zetaj, &dj, &ddj,
    ...
    FORTRAN(dynresults, (nk, v, ithermal, nactdof, vold, nodeboun, ndirboun,
                         xbounact, nboun, ipompc, nodempc, coefmpc, labmpc,
                         nmpc, b, bp, veold, &dtime, mi, imdnode, &nmdnode,
                         imdboun, &nmdboun, imdmpc, &nmdmpc, nmethod, &time));
    ...
    if ((iout == 2) || (iout == -2)) {
      ...
      if (nmdnode > 0) {
        if ((intpointvar == 1)) {
          for (k = 0; k < ne0; k++) {
            if (ipkon[k] < -1) {
              printf(
                  " *ERROR in dyna: contact remeshing of quadratic elements is "
                  "not allowed\n\n");
              FORTRAN(stop, ());
            } else if (ipkon[k] != -1) {
              ipkon[k] = -ipkon[k] - 2;
      ...
      results(co, nk, kon, ipkon, lakon, ne, v, stn, inum, stx, elcon, nelcon,
              ...
              &reltime, &ne0, thicke, shcon, nshcon, sideload, xload, xloadold,
              &icfd, inomat, pslavsurf, pmastsurf, &mortar, islavact, cdn,
              islavnode, nslavnode, ntie, clearini, islavsurf, ielprop, prop,
              energyini, energy, &iit, iponoel, inoel, nener, orname, &network,
    ...
    if (iout == 2) {
      ...
      ptime = *ttime + time;
      frd(co, &nkg, kon, ipkon, lakon, &neg, v, stn, inum, nmethod, kode, filab,
    ...
    if (isteadystate == 1) {
      ...
      if (*ithermal < 2) {
        ...
        printf(
            " *ERROR in dyna: coupled temperature-displacement calculations "
            "are not allowed\n");
      }

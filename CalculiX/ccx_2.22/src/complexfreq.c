...
void complexfreq(
  ...
  char fneig[132] = "", description[13] = "            ", *lakon = NULL,
       *labmpc = NULL, *lakont = NULL, *turdir = NULL, *labmpc2 = NULL;

  ITG nev, i, j, k, idof,
      *inum = NULL, id, iinc = 0, l, iout = 1, ielas, icmd = 3, ifreebody, mode,
      m, nherm, *kon = NULL, *ipkon = NULL, *ielmat = NULL, *ielorien = NULL,
      *islavact = NULL, *inotr = NULL, *nodeboun = NULL, *ndirboun = NULL,
      *iamboun = NULL, *ikboun = NULL, *ilboun = NULL, *nactdof = NULL,
      *ipompc = NULL, *nodempc = NULL, *ikmpc = NULL, *ilmpc = NULL, nsectors,
      nmd, nevd, *nm = NULL, *iamt1 = NULL, *islavnode = NULL, ngraph = 1, nkg,
      neg, ne0, ij, lprev, nope, indexe, ilength, *nslavnode = NULL,
      ...
      *iter = NULL, lint, lfin, kk, kkv, kk6, kkx, icomplex, igeneralizedforce,
      idir, *inumt = NULL, icntrl, imag, jj, is, l1, *inocs = NULL, ml1, l2,
      nkt, net, *ipkont = NULL, *ielmatt = NULL, *inotrt = NULL, *kont = NULL,
      node, iel, *ielcs = NULL, ielset, *istartnmd = NULL, *iendnmd = NULL,
      inmd, neqact, *nshcon = NULL, *ipev = NULL, icfd = 0, *inomat = NULL,
      mortar = 0, *islavsurf = NULL, *iponoel = NULL, *inoel = NULL,
      iperturbsav, nevcomplex, *itiefac = NULL, mscalmethod = 0,
      *islavquadel = NULL, *irowt = NULL, *jqt = NULL, nboun2,
      *ndirboun2 = NULL, *nodeboun2 = NULL, nmpc2, *ipompc2 = NULL,
      *nodempc2 = NULL, *ikboun2 = NULL, *ilboun2 = NULL, *ikmpc2 = NULL,
      *ilmpc2 = NULL, mortartrafoflag = 0, intscheme = 0;

  long long i2;

  double *d = NULL, *z = NULL, *stiini = NULL, *cc = NULL, *v = NULL,
         *zz = NULL, *emn = NULL, *stn = NULL, *stx = NULL, *een = NULL,
         *adb = NULL, *xstiff = NULL, *cdn = NULL, *aub = NULL, *f = NULL,
         *fn = NULL, *epn = NULL, *xstateini = NULL, *enern = NULL,
         *xstaten = NULL, *eei = NULL, *enerini = NULL, *qfn = NULL,
         *qfx = NULL, *cgr = NULL, *au = NULL, dtime, reltime, *t0 = NULL,
         *t1 = NULL, *t1old = NULL, sum, qa[4], cam[5], accold[1], bet, gam,
         *ad = NULL, alpham, betam, *co = NULL, *xboun = NULL, *xbounold = NULL,
         *vold = NULL, *emeini = NULL, *eme = NULL, *ener = NULL,
         *coefmpc = NULL, *fmpc = NULL, *veold = NULL, *adc = NULL, *auc = NULL,
         *zc = NULL, *fnr = NULL, *fni = NULL, setnull, deltmx, dd, theta,
         *vini = NULL, *vr = NULL, *vi = NULL, *stnr = NULL, *stni = NULL,
         *vmax = NULL, *stnmax = NULL, *cstr = NULL, *sti = *stip, time0 = 0.0,
         time = 0.0, zero = 0.0, *springarea = NULL, *eenmax = NULL, *aa = NULL,
         *bb = NULL, *xx = NULL, *eiga = NULL, *eigb = NULL, *eigxx = NULL,
         *temp = NULL, *coefmpcnew = NULL, xreal, ximag, t[3], *vt = NULL,
         *t1t = NULL, *stnt = NULL, *eent = NULL, *fnt = NULL, *enernt = NULL,
         *stxt = NULL, pi, ctl, stl, *cot = NULL, *qfnt = NULL, vreal, vimag,
         constant, stnreal, stnimag, freq, *emnt = NULL, *shcon = NULL,
         *eig = NULL, *clearini = NULL, *eigxr = NULL, *eigxi = NULL,
         *xmac = NULL, *bett = NULL, *betm = NULL, *xmaccpx = NULL, fmin = 0.,
         fmax = 1.e30, *xmr = NULL, *xmi = NULL, *zi = NULL, *eigx = NULL,
         *pslavsurf = NULL, *pmastsurf = NULL, *cdnr = NULL, *cdni = NULL,
         *tinc, *tper, *tmin, *tmax, *energyini = NULL, *energy = NULL, e1[3],
         e2[3], xn[3], *smscale = NULL, *aut = NULL, *xboun2 = NULL,
         *coefmpc2 = NULL, *physcon = NULL;
  ...
  *nzl = 0;
  ...
  printf(
      " *INFO in complexfreq: if there are problems reading the .eig file this "
      "may be due to:\n");
  ...
  if (fread(&cyclicsymmetry, sizeof(ITG), 1, f1) != 1) {
    printf(
        " *ERROR in complexfreq reading the cyclic symmetry flag in the "
        "eigenvalue file");
    exit(0);
  }
  ...
  if (fread(&nherm, sizeof(ITG), 1, f1) != 1) {
    printf(
        " *ERROR in complexfreq reading the Hermitian flag in the eigenvalue "
        "file");
    exit(0);
  }
  ...
  if (nherm != 1) {
    printf(
        " *ERROR in complexfreq: the eigenvectors in the .eig-file result\n");
  ...
  if (fread(&iperturb[0], sizeof(ITG), 1, f1) != 1) {
    printf(
        " *ERROR in complexfreq reading the perturbation flag in the "
        "eigenvalue file");
    exit(0);
  }
  if (iperturbsav != iperturb[0]) {
    if (iperturb[0] == 0) {
      printf(
          " *ERROR in complexfreq: the .eig-file was created without "
          "perturbation info\n");
      printf(
          "        the present *COMPLEX FREQUENCY step, however, contains "
          "the\n");
      printf("        perturbation parameter on the *STEP card.\n");
    } else if (iperturb[0] == 1) {
      printf(
          " *ERROR in complexfreq: the .eig-file was created with perturbation "
          "info\n");
      printf(
          "        the present *COMPLEX FREQUENCY step, however, does not "
          "contain the\n");
      printf("        perturbation parameter on the *STEP card.\n");
    }
    FORTRAN(stop, ());
  ...
  if (iperturb[0] == 1) {
    if (fread(vold, sizeof(double), mt * *nk, f1) != mt * *nk) {
      printf(
          " *ERROR in complexfreq reading the reference displacements in the "
          "eigenvalue file...");
      exit(0);
    }
  }
  ...
  if (!cyclicsymmetry) {
    ...
    if (fread(&nev, sizeof(ITG), 1, f1) != 1) {
      printf(
          " *ERROR in complexfreq reading the number of eigenvalues in the "
          "eigenvalue file...");
      exit(0);
    }
    ...
    if (nherm == 1) {
      ...
      if (fread(d, sizeof(double), nev, f1) != nev) {
        printf(
            " *ERROR in complexfreq reading the eigenvalues in the eigenvalue "
            "file...");
        exit(0);
      }
    ...
    if (fread(ad, sizeof(double), neq[1], f1) != neq[1]) {
      printf(
          " *ERROR in complexfreq reading the diagonal of the stiffness matrix "
    ...
    if (fread(au, sizeof(double), nzs[2], f1) != nzs[2]) {
      printf(
          " *ERROR in complexfreq reading the off-diagonal terms of the "
    ...
    if (fread(adb, sizeof(double), neq[1], f1) != neq[1]) {
      printf(
          " *ERROR in complexfreq reading the diagonal of the mass matrix in "
          "eigenvalue file...");
      exit(0);
    }
    ...
    if (fread(aub, sizeof(double), nzs[1], f1) != nzs[1]) {
      printf(
          " *ERROR in complexfreq reading the off-diagonals of the mass matrix "
          "in the eigenvalue file...");
      exit(0);
    }
    ...
    do {
      ...
      if (nherm == 1) {
        if (fread(&d[nev], sizeof(double), nevd, f1) != nevd) {
          printf(
              " *ERROR in complexfreq reading the eigenvalues in the "
              "eigenvalue file...");
          exit(0);
        }
      } else {
      ...
      if (nev == 0) {
        ...
        if (fread(ad, sizeof(double), neq[1], f1) != neq[1]) {
          printf(
              " *ERROR in complexfreq reading the diagonal of the stiffness "
        ...
        if (fread(au, sizeof(double), nzs[1], f1) != nzs[1]) {
          printf(
              " *ERROR in complexfreq reading the off-diagonals of the "
              "stiffness matrix in the eigenvalue file...");
          exit(0);
        }
        ...
        if (fread(adb, sizeof(double), neq[1], f1) != neq[1]) {
          printf(
              " *ERROR in complexfreq reading the diagonal of the mass matrix "
              "in the eigenvalue file...");
          exit(0);
        }
        ...
        if (fread(aub, sizeof(double), nzs[1], f1) != nzs[1]) {
          printf(
              " *ERROR in complexfreq reading the off-diagonals of the mass "
              "matrix in the eigenvalue file...");
          exit(0);
        }
      }
      ...
      if (fread(&z[neq[1] * nev], sizeof(double), neq[1] * nevd, f1) !=
          neq[1] * nevd) {
        printf(
            " *ERROR in complexfreq reading eigenvectors in the eigenvalue "
            "file...");
        exit(0);
      }
      nev += nevd;
  ...
  if (nherm == 1) {
    ...
    for (i = nev - 2; i > -1; i--) {
      if (sqrt(d[2 * i] * d[2 * i] + d[2 * i + 1] * d[2 * i + 1]) <
          0.0001 *
              sqrt(d[2 * i + 2] * d[2 * i + 2] + d[2 * i + 3] * d[2 * i + 3]))
        setnull = 0.;
      d[2 * i] *= setnull;
      d[2 * i + 1] *= setnull;
    }
  ...
  if (*nmethod == 6) {
    ...
    if (cyclicsymmetry) {
      printf(
          " *ERROR in complexfreq: Coriolis is not allowed in combination with "
          "cyclic symmetry\n");
      FORTRAN(stop, ());
    }
    ...
    FORTRAN(mafillcorio,
            (co, nk, kon, ipkon, lakon, ne, nodeboun, ndirboun, xboun, nboun,
             ...
             mi, ncmat_, ttime, &time0, istep, &iinc, ibody, ielprop, prop));

    /*  zc = damping matrix * eigenmodes */

    NNEW(zc, double, neq[1] * nev);
    for (i = 0; i < nev; i++) {
      FORTRAN(op_corio, (&neq[1], &z[(long long)i * neq[1]], &zc[i * neq[1]],
                         adc, auc, jq, irow));
    }
    SFREE(adc);
    SFREE(auc);
    ...
    FORTRAN(coriolissolve, (cc, &nev, aa, bb, xx, eiga, eigb, eigxx, iter, d,
                            temp, &nevcomplex));
    ...
    FORTRAN(readforce,
            (zc, &neqact, &nev, nactdof, ikmpc, nmpc, ipompc, nodempc, mi,
             coefmpc, jobnamef, aa, &igeneralizedforce));
  ...
  FORTRAN(sortev, (&nev, &nmd, eigxx, &cyclicsymmetry, xx, eigxr, ipev,
                   istartnmd, iendnmd, aa, bb, &nevcomplex));
  ...
  if (nherm == 1) {
    ...
    for (l = 0; l < nev; l++) {
      eig[2 * l] =
          sqrt(sqrt(d[2 * l] * d[2 * l] + d[2 * l + 1] * d[2 * l + 1]) +
               d[2 * l]) /
          sqrt(2.);
      eig[2 * l + 1] =
          sqrt(sqrt(d[2 * l] * d[2 * l] + d[2 * l + 1] * d[2 * l + 1]) -
  ...
  if (cyclicsymmetry) {
    ...
    FORTRAN(calcmac, (&neq[1], z, zz, &nev, xmac, xmaccpx, istartnmd, iendnmd,
                      &nmd, &cyclicsymmetry, &neqact, bett, betm, &nevcomplex));
    ...
    for (l = 0; l < nevcomplex; l++) {
      for (j = 0; j < 2; j++) {
        for (i = 0; i < neq[1]; i++) {
          for (k = 0; k < nev; k++) {
            zz[(2 * l + j) * neq[1] + i] +=
                xx[2 * l * nev + 2 * k + j] * z[(long long)k * neq[1] + i];
          }
        }
      }
    }
  ...
  if (mei[3] == 1) {
    ...
    if (!cyclicsymmetry) {
      if ((f1 = fopen(fneig, "wb")) == NULL) {
        printf(
            " *ERROR in complexfreq: cannot open eigenvalue file for "
            "writing...");
        exit(0);
      }
      ...
      if (fwrite(&cyclicsymmetry, sizeof(ITG), 1, f1) != 1) {
        printf(
            " *ERROR in complexfreq saving the cyclic symmetry flag to the "
            "eigenvalue file...");
        exit(0);
      }
      ...
      if (fwrite(&nherm, sizeof(ITG), 1, f1) != 1) {
        printf(
            " *ERROR in complexfreq saving the Hermitian flag to the "
            "eigenvalue file...");
        exit(0);
      }
      ...
      if (fwrite(&nevcomplex, sizeof(ITG), 1, f1) != 1) {
        printf(
            " *ERROR in complexfreq saving the number of eigenfrequencies to "
            "the eigenvalue file...");
        exit(0);
      }
      ...
      for (i = 0; i < nevcomplex; i++) {
        eigx[2 * i] =
            eigxx[2 * i] * eigxx[2 * i] - eigxx[2 * i + 1] * eigxx[2 * i + 1];
        eigx[2 * i + 1] = 2. * eigxx[2 * i] * eigxx[2 * i + 1];
      }

      if (fwrite(eigx, sizeof(double), 2 * nevcomplex, f1) != 2 * nevcomplex) {
        printf(
            " *ERROR in complexfreq saving the eigenfrequencies to the "
            "eigenvalue file...");
        exit(0);
      }
      ...
      if (fwrite(ad, sizeof(double), neq[1], f1) != neq[1]) {
        printf(
            " *ERROR in complexfreq saving the diagonal of the stiffness "
            "matrix to the eigenvalue file...");
        exit(0);
      }
      if (fwrite(au, sizeof(double), nzs[2], f1) != nzs[2]) {
        printf(
            " *ERROR in complexfreq saving the off-diagonal entries of the "
            "stiffness matrix to the eigenvalue file...");
        exit(0);
      }
      ...
      if (fwrite(adb, sizeof(double), neq[1], f1) != neq[1]) {
        printf(
            " *ERROR in complexfreq saving the diagonal of the mass matrix to "
            "the eigenvalue file...");
        exit(0);
      }
      if (fwrite(aub, sizeof(double), nzs[1], f1) != nzs[1]) {
        printf(
            " *ERROR in complexfreq saving the off-diagonal entries of the "
            "mass matrix to the eigenvalue file...");
        exit(0);
      }
      ...
      for (j = 0; j < nevcomplex; ++j) {
        ...
        if (fwrite(&zz[lint], sizeof(double), 2 * neq[1], f1) != 2 * neq[1]) {
          printf(
              " *ERROR in complexfreq saving the eigenvectors to the "
              "eigenvalue file...");
          exit(0);
        }
      }
      ...
      if (fwrite(xmr, sizeof(double), nevcomplex * nevcomplex, f1) !=
          nevcomplex * nevcomplex) {
        printf(
            " *ERROR in complexfreq saving the real orthogonality matrix to "
            "the eigenvalue file...");
        exit(0);
      }

      if (fwrite(xmi, sizeof(double), nevcomplex * nevcomplex, f1) !=
          nevcomplex * nevcomplex) {
        printf(
            " *ERROR in complexfreq saving the imaginary orthogonality matrix "
      ...
      if (fwrite(&nm[0], sizeof(ITG), 1, f1) != 1) {
        printf(
            " *ERROR in complexfreq saving the nodal diameter to the "
            "eigqenvalue file...");
        exit(0);
      }
      if (fwrite(&nev, sizeof(ITG), 1, f1) != 1) {
        printf(
            " *ERROR in complexfreq saving the number of eigenvalues to the "
            "eigenvalue file...");
        exit(0);
      }
      ...
      if (fwrite(au, sizeof(double), *nzs, f1) != *nzs) {
        printf(
            " *ERROR in complexfreq saving the off-diagonal terms of the "
            "stiffness matrix to the eigenvalue file...");
        exit(0);
      }
      ...
      if (fwrite(aub, sizeof(double), *nzs, f1) != *nzs) {
        printf(
            " *ERROR in complexfreq saving the off-diagonal terms of the mass "
            "matrix to the eigenvalue file...");
        exit(0);
      }
  ...
  if (strcmp1(&filab[522], "ENER") == 0) NNEW(enernt, double, *nk *ngraph);
  ...
  if (strcmp1(&filab[174], "S   ") == 0) {
    if ((strcmp1(&filab[179], "L") == 0) && (*norien > 0)) {
      printf(
          "\n *WARNING in complexfreq: element fields in cyclic symmetry "
  ...
  for (j = 0; j < nevcomplex; ++j) {
    ...
    for (k = 0; k < neq[1]; k += neq[1] / 2) {
      ...
      if (*iperturb == 0) {
        results(co, nk, kon, ipkon, lakon, ne, &v[kkv], &stn[kk6], inum,
                ...
                ielmat, ielorien, norien, orab, ntmat_, t0, t0, ithermal,
                prestr, iprestr, filab, eme, &emn[kk6], &een[kk6], iperturb, f,
                &fn[kkv], nactdof, &iout, qa, vold, &zz[lint + k], nodeboun,
                ndirboun, xboun, nboun, ipompc, nodempc, coefmpcnew, labmpc,
                nmpc, nmethod, cam, &neq[1], veold, accold, &bet, &gam, &dtime,
                &time, ttime, plicon, nplicon, plkcon, nplkcon, xstateini,
                xstiff, xstate, npmat_, epn, matname, mi, &ielas, &icmd, ncmat_,
                nstate_, stiini, vini, ikboun, ilboun, ener, &enern[kk], emeini,
                ...
                springarea, &reltime, &ne0, thicke, shcon, nshcon, sideload,
                xload, xloadold, &icfd, inomat, pslavsurf, pmastsurf, &mortar,
                islavact, cdn, islavnode, nslavnode, ntie, clearini, islavsurf,
                ielprop, prop, energyini, energy, &iit, iponoel, inoel, nener,
                orname, &network, ipobody, xbody, ibody, typeboun, itiefac,
                tieset, smscale, &mscalmethod, nbody, t0g, t1g, islavquadel,
                aut, irowt, jqt, &mortartrafoflag, &intscheme, physcon);
      } else {
        results(co, nk, kon, ipkon, lakon, ne, &v[kkv], &stn[kk6], inum,
                &stx[kkx], elcon, nelcon, rhcon, nrhcon, alcon, nalcon, alzero,
                ielmat, ielorien, norien, orab, ntmat_, t0, t1old, ithermal,
                prestr, iprestr, filab, eme, &emn[kk6], &een[kk6], iperturb, f,
                &fn[kkv], nactdof, &iout, qa, vold, &zz[lint + k], nodeboun,
                ndirboun, xboun, nboun, ipompc, nodempc, coefmpcnew, labmpc,
                nmpc, nmethod, cam, &neq[1], veold, accold, &bet, &gam, &dtime,
    ...
    frd(cot, &nkt, kont, ipkont, lakont, &net, vt, stnt, inumt, nmethod, kode,
        ...
        nstate_, istep, &iinc, ithermal, qfn, &j, &nm[j], trab, inotrt, ntrans,

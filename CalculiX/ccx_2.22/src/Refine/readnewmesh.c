...
void readnewmesh(
  ...
  char masterrfnfile[132] = "", fnrfn[132] = "", *inpc = NULL, *labmpc = NULL,
       *lakon = NULL, masterurffile[132] = "";

  ITG *integerglob = NULL, iglob = 1, irefine = 1, *inodestet = NULL,
      nnodestet = 0, i, istart, j, iquadratic, nenew, nline, nset_ = 0,
      *ipoinp = NULL, *inp = NULL, *ipoinpc = NULL, idummy[2] = {0, 0},
      nuel_ = 0, inp_size, nentries = 19, nkold_, neold_, nkonold_,
      *ielprop = NULL, *iponor = NULL, *iponoel = NULL, *rig = NULL,
      *ne2boun = NULL, *ielorien = NULL, *inotr = NULL, im, mt = mi[1] + 1,
      *ielmat = NULL, *irandomtype = NULL, *iparentel = NULL, *ipompc = NULL,
      *ikmpc = NULL, *ilmpc = NULL, *nodempc = NULL, *kon = NULL, *ipkon = NULL,
      *iamt1 = NULL, *ipobody = NULL, limit, *ipobody2 = NULL, ifreebody2,
      index, index2, *iprfn = NULL, *konrfn = NULL, *jq = NULL, *irow = NULL,
      *icol = NULL, *loc = NULL, *irowt = NULL, *jqt = NULL, *itemp = NULL,
      *ixcol = NULL, *ipoface = NULL, *nodface = NULL;

  double *doubleglob = NULL, sigma = 0., *thickn = NULL, *thicke = NULL,
         *offset = NULL, *t0 = NULL, *t0g = NULL, *t1g = NULL, *prestr = NULL,
         *vold = NULL, *veold = NULL, *randomval = NULL, *t1 = NULL,
         *coefmpc = NULL, *co = NULL, *ratiorfn = NULL, *au = NULL;
  ...
  if (*istep == 1) {
    ...
    readinput(fnrfn, &inpc, &nline, &nset_, ipoinp, &inp, &ipoinpc, idummy,
              &nuel_, &inp_size);
    ...
    FORTRAN(
        calinput_rfn,
        (co, filab, set, istartset, iendset, ialset, nset, &nset_, nalset,
         nalset_, mi, kon, ipkon, lakon, nkon, ne, ne_, iponor, xnor, istep,
         ipoinp, inp, iaxial, ipoinpc, network, nlabel, iuel, &nuel_, ielmat,
         inpc, iperturb, iprestr, nk, nk_, ntie, tieset, iparentel, tietol));
    ...
    getglobalresults(masterrfnfile, &integerglob, &doubleglob, nboun, iamboun,
    ...
    FORTRAN(getnodesinitetmesh,
            (ne, lakon, ipkon, kon, istartset, iendset, ialset, set, nset,
             filab, inodestet, &nnodestet, nodface, ipoface, nk));
    ...
    *nmpc_ += 3 * nnodestet;
    ...
    FORTRAN(genmpc,
            (inodestet, &nnodestet, co, doubleglob, integerglob, ipompc,
    ...
    if (ithermal[0] > 0) {
      ...
      for (i = 0; i < *nk - nkold; i++) {
        ...
        for (j = 0; j < iprfn[i + 1] - iprfn[i]; j++) {
          t0[nkold + i] +=
              ratiorfn[iprfn[i] + j] * t0[konrfn[iprfn[i] + j] - 1];
        }
      }
    }
  }
  ...
  FORTRAN(modifympc,
          (inodestet, &nnodestet, co, doubleglob, integerglob, ipompc, nodempc,
           coefmpc, nmpc, nmpc_, labmpc, mpcfree, ikmpc, ilmpc, jq, irow, icol,
           loc, irowt, jqt, itemp, au, ixcol, ikboun, nboun, nodeboun, &mpcrfna,
           &mpcrfnb, nodempcref, coefmpcref, memmpcref_, mpcfreeref,
           maxlenmpcref, memmpc_, maxlenmpc, istep));

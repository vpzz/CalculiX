...
void crackpropagation(
  ...
  char *lakon = NULL, description[13] = "            ", *param = NULL;
  ...
  ITG *kontri = NULL, ntri, *iedg = NULL, *ipoed = NULL, *ieled = NULL, nedg,
      ...
      *ifront2 = NULL, *ifrontrel2 = NULL, *istartfront = NULL,
      *iendfront = NULL, nnfront, *istartcrackfro = NULL, *iendcrackfro = NULL,
      ncrack, i, j, *ibounnod2 = NULL, *istartcrackbou = NULL,
      *iendcrackbou = NULL, imat, *isubsurffront = NULL, *iedno2 = NULL, nkold,
      *ipkon = NULL, *kon = NULL, *iresort = NULL, *inum = NULL, kode = 1, iinc,
      ier = 0, nstepf, neold, nkonold, mode = -1, noddiam = -1, *inotr = NULL,
      *ielorien = NULL, *ipneigh = NULL, *neigh = NULL, ngraph = 1,
      *ielprop = NULL, *ielmat = NULL, icritic = 0, *ifrontprop = NULL,
      *ifronteq = NULL, *istartfronteq = NULL, *iendfronteq = NULL, nfronteq,
      ncyc, *idist = NULL, ncrconst, nstep, nproc, ncrtem, law, nstepf2,
      *iincglob = NULL, nparam, ncyctot = 0, ieqspace = 1, *integerglobf = NULL,
      lcf, *iamt1 = NULL, mt = mi[1] + 1, *iponor = NULL, one = 1, nkinc, im,
      ncenter, *ibounel = NULL, nbounel, *mastelnr = NULL;

  double *doubleglob = NULL, *stress = NULL, *xt = NULL, *xn = NULL, *xa = NULL,
         *acrack = NULL, *xk1 = NULL, *xk2 = NULL, *xk3 = NULL,
         *doubleglobf = NULL, *xkeq = NULL, *phi = NULL, *psi = NULL,
         *co = NULL, *da = NULL, *stress2 = NULL, *v = NULL, *stn = NULL,
         *een = NULL, *fn = NULL, time = 0., *epn = NULL, *enern = NULL,
         *sti = NULL, *xstaten = NULL, *qfn = NULL, *trab = NULL, *orab = NULL,
         *vr = NULL, *vi = NULL, *stnr = NULL, *stni = NULL, *vmax = NULL,
         *stnmax = NULL, *veold = NULL, *ener = NULL, *cs = NULL,
         *eenmax = NULL, *fnr = NULL, *fni = NULL, *emn = NULL, *thicke = NULL,
         *qfx = NULL, *cdn = NULL, *cdnr = NULL, *cdni = NULL, *prop = NULL,
         *costruc = NULL, *costruc2 = NULL, *dadn = NULL, *wk1glob = NULL,
         *wk2glob = NULL, *wk3glob = NULL, *dkeqglob = NULL, *phiglob = NULL,
         *dadnglob = NULL, *dnglob = NULL, *charlen, damax, *crcon = NULL,
         *angle = NULL, *posfront = NULL, *dist = NULL, *tempf = NULL,
         *stressf = NULL, *a = NULL, *amin = NULL, *shape = NULL, *dk = NULL,
         *p = NULL, *temp = NULL, *temp2 = NULL, *crconloc = NULL, datarget,
         phimax, *acrackglob = NULL, scaling, *hcfstress = NULL, *wk1 = NULL,
         *wk2 = NULL, *wk3 = NULL, *xkeqmin = NULL, *xkeqmax = NULL,
         *domstep = NULL, *dkeq = NULL, *domphi = NULL, *xkeqminglob = NULL,
         *xkeqmaxglob = NULL, *cg = NULL, *domstepglob = NULL, *hcftemp = NULL,
         *xk1f = NULL, *xk2f = NULL, *xk3f = NULL, *xkeqf = NULL, *phif = NULL,
         *psif = NULL, *rglob = NULL, *r = NULL, *xplanecrack = NULL,
         *t0 = NULL, *t1 = NULL, *t0g = NULL, *t1g = NULL, *t1old = NULL,
         *vold = NULL, *prestr = NULL, *offset = NULL, *eme = NULL,
         *xstate = NULL, *crackarea = NULL, *surfnor = NULL, *surfco = NULL,
         *resarea = NULL, *alambdapj = NULL;
  ...
  *nk = *nk + 1;
  ...
  nstep = 0;
  iglob = 1;
  getuncrackedresults(&jobnamec[396], &integerglob, &doubleglob, &iglob,
                      &nstep);
  ...
  if (mei[0] > 0) {
    nstepf = 0;
    iglob = -1;
    getuncrackedresults(&jobnamec[528], &integerglobf, &doubleglobf, &iglob,
                        &nstepf);
  }
  ...
  for (iinc = 0; iinc < jmax[0]; iinc++) {
    ...
    FORTRAN(catedges_crackprop,
            (ipoed, iedg, &ntri, ieled, kontri, &nedg, &ier));
    if (ier == 1) {
      SFREE(kontri);
      SFREE(ipoed);
      SFREE(iedg);
    ...
    FORTRAN(interpolextnodes,
            (ibounnod, &nbounnod, co, doubleglob, integerglob, stress, ifront,
             &nfront, ifrontrel, costruc, temp, &nstep));
    ...
    if (mei[0] > 0) {
      ...
      FORTRAN(interpolextnodesf,
              (ibounnod, &nbounnod, co, doubleglobf, integerglobf, hcfstress,
               hcftemp, &nstepf, &mei[0]));

      /* scaling the hcf stress */

      for (i = 0; i < 6 * nbounnod; i++) {
        hcfstress[i] *= scaling;
      }
    ...
    FORTRAN(adjacentbounodes,
            (ifront, ifrontrel, &nfront, iedno, iedg, &nnfront, ifront2,
             ifrontrel2, ibounnod, &nbounnod, istartfront, iendfront, ibounedg,
             istartcrackfro, iendcrackfro, &ncrack, ibounnod2, istartcrackbou,
             iendcrackbou, isubsurffront, iedno2, stress, stress2, iresort,
             ieled, kontri, costruc, costruc2, temp, temp2, &nstep, &ier));
    if (ier == 1) {
      SFREE(kontri);
      SFREE(ipoed);
      SFREE(iedg);
      ...
      SFREE(istartfront);
      SFREE(iendfront);
      SFREE(istartcrackfro);
      SFREE(iendcrackfro);
      SFREE(ibounnod2);
      SFREE(iresort);
      SFREE(istartcrackbou);
      SFREE(iendcrackbou);
      SFREE(isubsurffront);
      SFREE(iedno2);
      SFREE(temp2);
    ...
    FORTRAN(checkcrosssections,
            (co, doubleglob, integerglob, stress, &nnfront, ifront, ifrontrel,
             costruc, temp, &nstep, istartfront, iendfront));
    ...
    FORTRAN(createlocalsys,
            (&nnfront, istartfront, iendfront, ifront, co, xt, xn, xa, &nfront,
             ifrontrel, stress, iedno, ibounedg, ieled, kontri, isubsurffront,
             istartcrackfro, iendcrackfro, &ncrack, angle, &nstep, &ier));
    if (ier == 1) {
      SFREE(kontri);
      SFREE(ipoed);
      SFREE(iedg);
    ...
    FORTRAN(
        cracklength,
        (&ncrack, istartcrackfro, iendcrackfro, co, istartcrackbou,
         iendcrackbou, costruc, ibounnod, xt, acrack, istartfront, iendfront,
         &nnfront, isubsurffront, ifrontrel, ifront, posfront, doubleglob,
         integerglob, &nproc, &iinc, acrackglob, &ier, &nbounnod, &nfront));
    if (ier == 1) {
      SFREE(kontri);
      SFREE(ipoed);
      SFREE(iedg);
    ...
    FORTRAN(cracklength_smoothing,
            (&nnfront, isubsurffront, istartfront, iendfront, ifrontrel,
             costruc, dist, a, istartcrackfro, iendcrackfro, acrack, amin,
    ...
    FORTRAN(crackshape, (&nnfront, ifront, istartfront, iendfront,
    ...
    FORTRAN(contingentsurf,
            (&ncrack, xplanecrack, istartcrackbou, iendcrackbou, costruc, cg,
             crackarea, &nnfront, isubsurffront, istartcrackfro, iendcrackfro,
             istartfront, iendfront, acrack, xa, ifrontrel, integerglob,
             doubleglob, &nstep, surfnor, surfco, resarea, alambdapj, shape));
    SFREE(xplanecrack);
    SFREE(cg);
    SFREE(crackarea);
    SFREE(surfnor);
    ...
    if (mei[0] > 0) {
      ...
      nstepf2 = 2;
      FORTRAN(stressintensity,
              (&nfront, ifrontrel, stressf, xt, xn, xa, xk1f, xk2f, xk3f, xkeqf,
               phif, psif, acrack, shape, &nstepf2));
    ...
    FORTRAN(stressintensity_smoothing,
            (&nnfront, isubsurffront, istartfront, iendfront, ifrontrel,
             costruc, dist, istartcrackfro, iendcrackfro, xkeq, phi, &nfront,
             &ncrack, dk, p, idist, &phimax, &nstep));
    ...
    if (mei[0] > 0) {
      ...
      FORTRAN(stressintensity_smoothing,
              (&nnfront, isubsurffront, istartfront, iendfront, ifrontrel,
               costruc, dist, istartcrackfro, iendcrackfro, xkeqf, phif,
               &nfront, &ncrack, dk, p, idist, &phimax, &nstepf2));
    ...
    if (mei[0] > 0) {
      ...
      FORTRAN(crackrate,
              (&nfront, ifrontrel, xkeqf, phif, ifront, dadn, &ncyc, &icritic,
               &datarget, crcon, tempf, &ncrtem, crconloc, &ncrconst, xk1f,
               xk2f, xk3f, &nstepf2, acrack, wk1, wk2, wk3, xkeqmin, xkeqmax,
               dkeq, domstep, domphi, param, &nparam, &law, &ier, r));

      if ((icritic > 0) || (ier == 1)) {
        if (icritic > 0) {
          printf(
              " *WARNING: Exit because a critical value for Keq is reached "
              "along the crack front due to the modal loading \n");
        } else {
    ...
    if (lcf == 1) {
      ...
      FORTRAN(crackrate,
              (&nfront, ifrontrel, xkeq, phi, ifront, dadn, &ncyc, &icritic,
               &datarget, crcon, temp, &ncrtem, crconloc, &ncrconst, xk1, xk2,
               xk3, &nstep, acrack, wk1, wk2, wk3, xkeqmin, xkeqmax, dkeq,
               domstep, domphi, param, &nparam, &law, &ier, r));

      if ((icritic > 0) || (ier == 1)) {
        if (icritic > 0) {
          printf(
              " *WARNING: Exit because a critical value for Keq is reached "
              "along the crack front due to the static loading \n");
        } else {
          printf(" *WARNING: Exit because an error occurred in crackrate.f \n");
        }
        printf("           Number of iteration= %d\n\n", (iinc + 1));
    ...
    FORTRAN(crackprop,
            (ifrontrel, ibounnod, domphi, da, co, costruc, nk, xa, xn, &nnfront,
             istartfront, iendfront, doubleglob, integerglob, isubsurffront,
             dadn, &ncyc, ifrontprop, &nstep, acrack, acrackglob, &datarget,
    ...
    if (ieqspace == 0) {
      ...
      FORTRAN(eqspacednodes, (co, istartfront, iendfront, &nnfront, ifrontprop,
                              nk, &nfront, ifronteq, charlen, istartfronteq,
                              iendfronteq, &nfronteq, acrackglob, &ier,
    ...
    for (i = mi[2] * *ne; i < mi[2] * (*ne + (nfronteq + nfront)); i++) {
      ielmat[i] = 1;
    }
    RENEW(kon, ITG, *nkon + 9 * (*ne + (nfronteq + nfront)));

    FORTRAN(extendmesh, (&nnfront, istartfront, iendfront, ifront, ne, nkon,
                         lakon, ipkon, kon, isubsurffront, co, ifronteq,
    ...
    RENEW(wk1glob, double, *nk);
    for (i = nkinc; i < *nk; i++) {
      wk1glob[i] = 0.;
    }
    RENEW(wk2glob, double, *nk);
    for (i = nkinc; i < *nk; i++) {
      wk2glob[i] = 0.;
    }
    RENEW(wk3glob, double, *nk);
    for (i = nkinc; i < *nk; i++) {
      wk3glob[i] = 0.;
    }
    RENEW(xkeqminglob, double, *nk);
    for (i = nkinc; i < *nk; i++) {
      xkeqminglob[i] = 0.;
    }
    RENEW(xkeqmaxglob, double, *nk);
    for (i = nkinc; i < *nk; i++) {
      xkeqmaxglob[i] = 0.;
    }
    RENEW(dkeqglob, double, *nk);
    for (i = nkinc; i < *nk; i++) {
      dkeqglob[i] = 0.;
    }
    RENEW(rglob, double, *nk);
    for (i = nkinc; i < *nk; i++) {
      rglob[i] = 0.;
    }
    RENEW(phiglob, double, *nk);
    for (i = nkinc; i < *nk; i++) {
      phiglob[i] = 0.;
    }
    RENEW(dadnglob, double, *nk);
    for (i = nkinc; i < *nk; i++) {
      dadnglob[i] = 0.;
    }
    RENEW(domstepglob, double, *nk);
    for (i = nkinc; i < *nk; i++) {
      domstepglob[i] = 0.;
    }

    FORTRAN(globalcrackresults,
            (&nfront, ifront, wk1, wk2, wk3, dkeq, domphi, dadn, &ncyctot,
             wk1glob, wk2glob, wk3glob, dkeqglob, phiglob, dadnglob, dnglob,
             acrack, acrackglob, &nstep, xkeqmin, xkeqmax, xkeqminglob,
             xkeqmaxglob, &iinc, iincglob, domstep, domstepglob, r, rglob));
    ...
    if (icritic > 0) {
      printf(
          " *WARNING: Exit because crack propagation occurred due to the modal "
          "loading \n");
      printf("           Number of iteration= %d\n\n", (iinc + 1));
      break;
    } else if (icritic < 0) {
      printf(
          " *WARNING: Exit because no crack propagation anywhere along the "
          "crack front \n");
      printf("           Number of iteration= %d\n\n", (iinc + 1));
      break;
    }
  ...
  for (i = 6 * mi[0] * neold; i < 6 * mi[0] * *ne; i++) {
    sti[i] = 0.;
    eme[i] = 0.;
  }
  if (*nener == 1) {
  ...
  if (*nstate_ > 0) {
    if (*mortar == 0) {
      ...
      for (i = *nstate_ * mi[0] * (neold + *nslavs);
           i < *nstate_ * mi[0] * (*ne + *nslavs); i++)
        xstate[i] = 0.;
    } else if (*mortar == 1) {
      RENEW(xstate, double, *nstate_ *mi[0] * (*ne + *nintpoint));
      for (i = *nstate_ * mi[0] * (neold + *nintpoint);
           i < *nstate_ * mi[0] * (*ne + *nintpoint); i++)
        xstate[i] = 0.;
    }
  }
  ...
  frd(co, nk, kon, ipkon, lakon, ne, v, stn, inum, nmethod, &kode, filab, een,
      ...
      &iinc, ithermal, qfn, &mode, &noddiam, trab, inotr, ntrans, orab,
      ielorien, norien, description, ipneigh, neigh, mi, sti, vr, vi, stnr,
      stni, vmax, stnmax, &ngraph, veold, ener, ne, cs, set, nset, istartset,
      iendset, ialset, eenmax, fnr, fni, emn, thicke, jobnamec, output, qfx,
      cdn, mortar, cdnr, cdni, nmat, ielprop, prop, sti);

  /* storing the crack propagation fields in frd-format */

  if (strcmp1(&filab[4611], "KEQ ") == 0) {
    crackfrd(nk, &ngraph, &noddiam, cs, &kode, inum, nmethod, &time, istep,
             &iinc, &mode, description, set, nset, istartset, iendset, ialset,
             jobnamec, output, dkeqglob, wk1glob, wk2glob, wk3glob, phiglob,
             dadnglob, dnglob, acrackglob, xkeqminglob, xkeqmaxglob, iincglob,
             domstepglob, rglob);
  }

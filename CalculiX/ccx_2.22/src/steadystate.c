...
void steadystate(
    ...
    ITG *isolver, ITG *jq, char *output, ITG *mcs, ITG *nkon, ITG *ics,
    double *cs, ITG *mpcend, double *ctrl, ITG *ikforc, ITG *ilforc,
    double *thicke, ITG *nmat, char *typeboun, ITG *ielprop, double *prop,
    char *orname, ITG *ndamp, double *dacon, double *t0g, double *t1g) {
  char fneig[132] = "", description[13] = "            ", *lakon = NULL,
       *labmpc = NULL, *labmpcold = NULL, cflag[1] = " ";

  ITG nev, i, j, k,
      *inum = NULL, nsectors, im, intscheme = 0, *ibodysav = NULL, iinc = 0, l,
      iout, ielas, icmd = 0, iprescribedboundary, ndata, nmd, nevd, ndatatot,
      *iphaseforc = NULL, *iphaseload = NULL, *iphaseboun = NULL, *isave = NULL,
      nfour, ii, ir, ic, mode, noddiam = -1, *nm = NULL, *islavact = NULL,
      *kon = NULL, *ipkon = NULL, *ielmat = NULL, *ielorien = NULL,
      *inotr = NULL, *nodeboun = NULL, *ndirboun = NULL, *iamboun = NULL,
      *ikboun = NULL, jj, *ilboun = NULL, *nactdof = NULL, *ipompc = NULL,
      *nodempc = NULL, *ikmpc = NULL, *ilmpc = NULL, *ipompcold = NULL,
      *nodempcold = NULL, *ikmpcold = NULL, *ilmpcold = NULL, nmpcold,
      mpcendold, kflag = 2, *iamt1 = NULL, *itg = NULL, ntg = 0,
      symmetryflag = 0, inputformat = 0, dampmat = 0, nrhs = 1, *ipiv = NULL,
      info, nev2, ngraph = 1, nkg, neg, iflag = 1, idummy = 1, imax, nzse[3],
      mt = mi[1] + 1, *ikactmech = NULL, nactmech, id, nasym = 0,
      *imddof = NULL, nmddof, *imdnode = NULL, nmdnode, *imdboun = NULL,
      nmdboun, *imdmpc = NULL, nmdmpc, *izdof = NULL, nzdof, cyclicsymmetry,
      mortar = 0, *ikactmechr = NULL, *ikactmechi = NULL, nactmechr, nactmechi,
      intpointvar, iforc, iload, ne0, *iponoel = NULL, *inoel = NULL,
      *imdelem = NULL, nmdelem, *integerglob = NULL, *nshcon = NULL, nherm,
      icfd = 0, *inomat = NULL, *islavnode = NULL, *nslavnode = NULL,
      *islavsurf = NULL, iit = -1, network = 0, kscale = 0, nmethodact = 1,
      iperturbsav, coriolis, *itiefac = NULL, mscalmethod = 0,
      *islavquadel = NULL, *irowt = NULL, *jqt = NULL, mortartrafoflag = 0;

  long long i2;

  double *d = NULL, *z = NULL, *stiini = NULL, *vini = NULL, *freqnh = NULL,
         *xforcact = NULL, *xloadact = NULL, y, *fr = NULL, *fi = NULL,
         *cc = NULL, *t1act = NULL, *ampli = NULL, *aa = NULL, *bb = NULL,
         *vr = NULL, *vi = NULL, *stn = NULL, *stx = NULL, *een = NULL,
         *adb = NULL, *xstiff = NULL, ptime, *aub = NULL, *bjr = NULL,
         *bji = NULL, *xbodyr = NULL, *cdn = NULL, *f = NULL, *fn = NULL,
         *xbounact = NULL, *epn = NULL, *xstateini = NULL, *enern = NULL,
         *xstaten = NULL, *eei = NULL, *enerini = NULL, *qfn = NULL,
         ...
         *emeini = NULL, fmin, fmax, bias, *freq = NULL, *xforcr = NULL, dd, pi,
         vreal, constant, *xforci = NULL, *xloadr = NULL, *xloadi = NULL,
         *xbounr = NULL, *xbouni = NULL, *br = NULL, *bi = NULL, *ubr = NULL,
         *ubi = NULL, *mubr = NULL, *mubi = NULL, *wsave = NULL, *r = NULL,
         *xbounacttime = NULL, *btot = NULL, breal, tmin, tmax, *vold = NULL,
         *eme = NULL, *ener = NULL, *coefmpc = NULL, *fmpc = NULL,
         *coefmpcold = NULL, *t0 = NULL, *t1 = NULL, *t1old = NULL, *adc = NULL,
         *auc = NULL, *am = NULL, *bm = NULL, *zc = NULL, *e = NULL,
         *stnr = NULL, *stni = NULL, *vmax = NULL, *stnmax = NULL, *va = NULL,
         *vp = NULL, *fric = NULL, *springarea = NULL, *stna = NULL,
         *stnp = NULL, *bp = NULL, *eenmax = NULL, *clearini = NULL,
         *doubleglob = NULL, *shcon = NULL, *veold = NULL, *xmr = NULL,
         *xmi = NULL, *eig = NULL, *ax = NULL, *bx = NULL, *pslavsurf = NULL,
         *pmastsurf = NULL, xnull = 0., *cdnr = NULL, *cdni = NULL,
         *energyini = NULL, *energy = NULL, *v = NULL, *b = NULL, *cco = NULL,
         *smscale = NULL, *aut = NULL, *umubr = NULL, *umubi = NULL,
         *fnext = NULL;
  ...
  *nzl = 0;
  ...
  if (fread(&cyclicsymmetry, sizeof(ITG), 1, f1) != 1) {
    printf(
        " *ERROR in steadystate reading the cyclic symmetry flag in the "
        "eigenvalue file");
    printf(
        " *INFO  in steadystate: if there are problems reading the .eig file "
        "this may be due to:\n");
  ...
  if (fread(&nherm, sizeof(ITG), 1, f1) != 1) {
    printf(
        " *ERROR in steadystate reading the Hermitian flag in the eigenvalue "
        "file");
    printf(
        " *INFO  in steadystate: if there are problems reading the .eig file "
        "this may be due to:\n");
  ...
  if (fread(&iperturb[0], sizeof(ITG), 1, f1) != 1) {
    printf(
        " *ERROR in steadystate reading the perturbation flag in the "
        "eigenvalue file");
    printf(
        " *INFO  in steadystate: if there are problems reading the .eig file "
        "this may be due to:\n");
  ...
  if (iperturbsav != iperturb[0]) {
    if (iperturb[0] == 0) {
      printf(
          " *ERROR in steadystate: the .eig-file was created without "
          "perturbation info\n");
      printf(
          "        the present *STEADY STATE DYNAMICS step, however, contains "
          "the\n");
      printf("        perturbation parameter on the *STEP card.\n\n");
    } else if (iperturb[0] == 1) {
      printf(
          " *ERROR in steadystate: the .eig-file was created with perturbation "
          "info\n\n");
      printf(
          "        the present *STEADY STATE DYNAMICS step, however, does not "
          "contain the\n");
      printf("        perturbation parameter on the *STEP card.\n");
    }
    FORTRAN(stop, ());
  ...
  if (iperturb[0] == 1) {
    if (fread(vold, sizeof(double), mt * *nk, f1) != mt * *nk) {
      printf(
          " *ERROR in steadystate reading the reference displacements in the "
          "eigenvalue file...");
      printf(
          " *INFO  in steadystate: if there are problems reading the .eig file "
          "this may be due to:\n");
  ...
  FORTRAN(createmddof,
          (imddof, &nmddof, istartset, iendset, ialset, nactdof, ithermal, mi,
           imdnode, &nmdnode, ikmpc, ilmpc, ipompc, nodempc, nmpc, imdmpc,
           &nmdmpc, imdboun, &nmdboun, ikboun, nboun, nset, &ntie, tieset, set,
           lakon, kon, ipkon, labmpc, ilboun, filab, prlab, prset, nprint, ne,
           &cyclicsymmetry));
  ...
  if (nmdnode != 0) {
    if (!cyclicsymmetry) {
      for (i = 0; i < *nload; i++) {
        iload = i + 1;
        FORTRAN(addimdnodedload,
                (nelemload, sideload, ipkon, kon, lakon, &iload, imdnode,
                 &nmdnode, ikmpc, ilmpc, ipompc, nodempc, nmpc, imddof, &nmddof,
                 nactdof, mi, imdmpc, &nmdmpc, imdboun, &nmdboun, ikboun, nboun,
                 ilboun, ithermal));
      }

      for (i = 0; i < *nforc; i++) {
        iforc = i + 1;
        FORTRAN(addimdnodecload,
                (nodeforc, &iforc, imdnode, &nmdnode, xforc, ikmpc, ilmpc,
                 ipompc, nodempc, nmpc, imddof, &nmddof, nactdof, mi, imdmpc,
                 &nmdmpc, imdboun, &nmdboun, ikboun, nboun, ilboun, ithermal));
      }
    }
    ...
    FORTRAN(createmdelem,
            (imdnode, &nmdnode, ikmpc, ilmpc, ipompc, nodempc, nmpc, imddof,
             &nmddof, nactdof, mi, imdmpc, &nmdmpc, imdboun, &nmdboun, ikboun,
             nboun, ilboun, ithermal, imdelem, &nmdelem, iponoel, inoel, prlab,
             prset, nprint, lakon, set, nset, ialset, ipkon, kon, istartset,
             iendset, nforc, ikforc, ilforc));
  ...
  if (!cyclicsymmetry) {
    ...
    if (fread(&nev, sizeof(ITG), 1, f1) != 1) {
      printf(
          " *ERROR in steadystate reading the number of eigenvalues in the "
          "eigenvalue file");
      printf(
          " *INFO  in steadystate: if there are problems reading the .eig file "
          "this may be due to:\n");
    ...
    if (nherm == 1) {
      ...
      if (fread(d, sizeof(double), nev, f1) != nev) {
        printf(
            " *ERROR in steadystate reading the eigenvalues in the eigenvalue "
            "file...");
        printf(
            " *INFO  in steadystate: if there are problems reading the .eig "
            "file this may be due to:\n");
        printf("        1) the nonexistence of the .eig file\n");
        printf("        2) other boundary conditions than in the input deck\n");
        printf("           which created the .eig file\n\n");
        exit(0);
    ...
    if (fread(ad, sizeof(double), neq[1], f1) != neq[1]) {
      printf(
          " *ERROR in steadystate reading the diagonal of the stiffness matrix "
    ...
    if (fread(au, sizeof(double), nzs[2], f1) != nzs[2]) {
      printf(
          " *ERROR in steadystate reading the off-diagonals of the stiffness "
          "matrix in the eigenvalue file");
      printf(
          " *INFO  in steadystate: if there are problems reading the .eig file "
          "this may be due to:\n");
      printf("        1) the nonexistence of the .eig file\n");
    ...
    if (fread(adb, sizeof(double), neq[1], f1) != neq[1]) {
      printf(
          " *ERROR in steadystate reading the diagonal of the mass matrix in "
          "the eigenvalue file");
      printf(
          " *INFO  in steadystate: if there are problems reading the .eig file "
          "this may be due to:\n");
    ...
    if (fread(aub, sizeof(double), nzs[1], f1) != nzs[1]) {
      printf(
          " *ERROR in steadystate reading the off-diagonals of the mass matrix "
          "in the eigenvalue file");
      printf(
          " *INFO  in steadystate: if there are problems reading the .eig file "
          "this may be due to:\n");
    ...
    if (nherm == 1) {
      ...
      if (fread(z, sizeof(double), neq[1] * nev, f1) != neq[1] * nev) {
        printf(
            " *ERROR in complexfreq reading the eigenvectors in the eigenvalue "
            "file...");
        printf(
            " *INFO  in steadystate: if there are problems reading the .eig "
            "file this may be due to:\n");
    ...
    if (nherm != 1) {
      ...
      if (fread(xmr, sizeof(double), nev * nev, f1) != nev * nev) {
        printf(
            " *ERROR in steadystate reading the real orthogonality matrix to "
            "the eigenvalue file...");
        printf(
            " *INFO  in steadystate: if there are problems reading the .eig "
            "file this may be due to:\n");
      ...
      if (fread(xmi, sizeof(double), nev * nev, f1) != nev * nev) {
        printf(
            " *ERROR in steadystate reading the imaginary orthogonality matrix "
            "to the eigenvalue file...");
        printf(
            " *INFO  in steadystate: if there are problems reading the .eig "
            "file this may be due to:\n");
        printf("        1) the nonexistence of the .eig file\n");
    ...
    do {
      ...
      if (fread(&nevd, sizeof(ITG), 1, f1) != 1) {
        printf(
            " *ERROR in steadystate reading the number of eigenvalues for "
            "nodal diameter %" ITGFORMAT " in the eigenvalue file",
            nmd);
        printf(
            " *INFO  in steadystate: if there are problems reading the .eig "
            "file this may be due to:\n");
      ...
      if (nherm == 1) {
        if (fread(&d[nev], sizeof(double), nevd, f1) != nevd) {
          printf(
              " *ERROR in steadystate reading the eigenvalues for nodal "
              "diameter %" ITGFORMAT " in the eigenvalue file",
              nmd);
          printf(
              " *INFO  in steadystate: if there are problems reading the .eig "
              "file this may be due to:\n");
        ...
        if (fread(&d[nev], sizeof(double), 2 * nevd, f1) != 2 * nevd) {
          printf(
              " *ERROR in steadystate reading the eigenvalues in the "
              "eigenvalue file...");
          printf(
              " *INFO  in steadystate: if there are problems reading the .eig "
              "file this may be due to:\n");
      ...
      if (nev == 0) {
        ...
        if (fread(ad, sizeof(double), neq[1], f1) != neq[1]) {
          printf(
              " *ERROR in steadystate reading the diagonal of the stiffness "
              "matrix in the eigenvalue file");
          printf(
              " *INFO  in steadystate: if there are problems reading the .eig "
              "file this may be due to:\n");
        ...
        if (fread(au, sizeof(double), nzs[1], f1) != nzs[1]) {
          printf(
              " *ERROR in steadystate reading the off-diagonals of the "
              "stiffness matrix in the eigenvalue file");
          printf(
              " *INFO  in steadystate: if there are problems reading the .eig "
              "file this may be due to:\n");
          printf("        1) the nonexistence of the .eig file\n");
        ...
        if (fread(adb, sizeof(double), neq[1], f1) != neq[1]) {
          printf(
              " *ERROR in steadystate reading the diagonal of the mass matrix "
              "in the eigenvalue file");
          printf(
              " *INFO  in steadystate: if there are problems reading the .eig "
              "file this may be due to:\n");
        ...
        if (fread(aub, sizeof(double), nzs[1], f1) != nzs[1]) {
          printf(
              " *ERROR in steadystate reading the off-diagonals of the mass "
              "matrix in the eigenvalue file");
          printf(
              " *INFO  in steadystate: if there are problems reading the .eig "
              "file this may be due to:\n");
      ...
      if (fread(&z[(long long)neq[1] * nev], sizeof(double), neq[1] * nevd,
                f1) != neq[1] * nevd) {
        printf(
            " *ERROR in steadystate reading the eigenvectors for nodal "
            "diameter %" ITGFORMAT " in the eigenvalue file",
            nmd);
        printf(
            " *INFO  in steadystate: if there are problems reading the .eig "
      ...
      if (nherm != 1) {
        ...
        if (fread(xmi, sizeof(double), nev * nev, f1) != nev * nev) {
          printf(
              " *ERROR in steadystate reading the imaginary orthogonality "
              "matrix to the eigenvalue file...");
          printf(
              " *INFO  in steadystate: if there are problems reading the .eig "
              "file this may be due to:\n");
          printf("        1) the nonexistence of the .eig file\n");
    ...
    expand(co, nk, kon, ipkon, lakon, ne, nodeboun, ndirboun, xboun, nboun,
           ...
           nforc, nelemload, sideload, xload, nload, nactdof, neq, nmethod,
           ikmpc, ilmpc, ikboun, ilboun, elcon, nelcon, rhcon, nrhcon, alcon,
           nalcon, alzero, ielmat, ielorien, norien, orab, ntmat_, t0, ithermal,
           prestr, iprestr, vold, iperturb, sti, nzs, adb, aub, filab, eme,
           plicon, nplicon, plkcon, nplkcon, xstate, npmat_, matname, mi, ics,
           cs, mpcend, ncmat_, nstate_, mcs, nkon, ener, jobnamec, output, set,
           nset, istartset, iendset, ialset, nprint, prlab, prset, nener, trab,
           inotr, ntrans, ttime, fmpc, &nev, &z, iamboun, xbounold, &nsectors,
           nm, icol, irow, nzl, nam, ipompcold, nodempcold, coefmpcold,
           labmpcold, &nmpcold, xloadold, iamload, t1old, t1, iamt1, xstiff,
           &icole, &jqe, &irowe, isolver, nzse, &adbe, &aube, iexpl, ibody,
           xbody, nbody, cocon, ncocon, tieset, &ntie, imddof, &nmddof, imdnode,
           &nmdnode, imdboun, &nmdboun, imdmpc, &nmdmpc, &izdof, &nzdof, &nherm,
           xmr, xmi, typeboun, ielprop, prop, orname, itiefac, t0g, t1g);
  ...
  /* check whether there is structural damping or whether there are dashpot
     elements both lead to the creation of a damping matrix */
  ...
  if (dampmat) {
    if (cyclicsymmetry) {
      printf(
          " *ERROR in steadystate: structural damping and/or dashpot "
          "elements\n");
    ...
    if (nherm != 1) {
      printf(
          "ERROR in steadystate: structural damping and/or dashpot elements "
          "\n");
      printf(
          "      cannot be combined with non-Hermitian systems (in the present "
          "version of CalculiX)\n");
      FORTRAN(stop, ());
    }
  ...
  if (coriolis) {
    if (nherm != 1) {
      printf(
          " *WARNING in steadystate: centrifugal loading cannot be combined "
          "\n");
      printf(
          "          with non-Hermitian systems (in the present version of "
          "CalculiX)\n");
  ...
  if (*ithermal <= 1) {
    ...
    if ((strcmp1(&filab[174], "S") == 0) || (strcmp1(&filab[261], "E") == 0) ||
  ...
  if (nfour <= 0) {
    ...
    if (fabs(fmax - fmin) < 1.e-10) {
      ...
      if (nherm == 1) {
        ...
        for (i = 0; i < nev; i++) {
          e[i] = sqrt(sqrt(d[2 * i] * d[2 * i] + d[2 * i + 1] * d[2 * i + 1]) +
                      d[2 * i]) /
                 sqrt(2.);
        }
      }
          ...
          if (e[i] <= fmax) {
            for (j = 1; j < ndata; j++) {
              ...
              if (fabs(y) < 1.e-10) {
                ...
                freq[ndatatot + j] =
                    (freq[ndatatot] + e[i]) / 2. + (e[i] - freq[ndatatot]) *
                                                       pow(fabs(y), 1. / bias) *
                                                       y / (2. * fabs(y));
              }
            }
    ...
    if ((iprescribedboundary) && (cyclicsymmetry)) {
      printf(
          " *ERROR in steadystate: prescribed boundaries are not allowed in "
          "combination with cyclic symmetry\n");
      FORTRAN(stop, ());
    }
    ...
    if (xmodal[10] < 0) {
      ...
      for (i = 0; i < nev; i++) {
        if (nherm == 1) {
          if (sqrt(d[i]) > (1.e-10)) {
            ...
            printf(
                " *WARNING in steadystate: one of the frequencies is zero\n");
            printf("         no Rayleigh mass damping allowed\n");
            fric[i] = 0.;
          }
        } else {
          fric[2 * i] =
              sqrt(sqrt(d[2 * i] * d[2 * i] + d[2 * i + 1] * d[2 * i + 1]) +
                   d[2 * i]) /
              sqrt(2.);
          fric[2 * i + 1] =
              sqrt(sqrt(d[2 * i] * d[2 * i] + d[2 * i + 1] * d[2 * i + 1]) -
      ...
      /*copy the damping coefficients for every eigenfrequencie from
       * xmodal[11....] */

      if (nev < (ITG)xmodal[10]) {
        imax = nev;
        printf(
            " *WARNING in steadystate: too many modal damping coefficients "
            "applied\n");
        printf(
            "         damping coefficients corresponding to nonexisting "
    ...
    if (iprescribedboundary) {
      ...
      NNEW(fr, double,
           neq[1]); /* force corresponding to real particular solution */
      NNEW(fi, double,
           neq[1]); /* force corresponding to imaginary particular solution */
    ...
    if (nherm == 1) {
      ...
      NNEW(bb, double,
           2 * nev); /* modal coefficients of the imaginary loading */
    }
...
#ifdef SGI
        token = 1;
        sgi_factor(ad, au, adb, aub, &sigma, icol, irow, &neq[1], &nzs[1],
                   token);
#else
...
#ifdef PASTIX
        pastix_factor_main(ad, au, adb, aub, &sigma, icol, irow, &neq[1],
    ...
    for (l = 0; l < ndatatot; l = l + *jout) {
      ...
      if (dampmat || coriolis) {
        ...
        results(co, nk, kon, ipkon, lakon, ne, v, stn, inum, stx, elcon, nelcon,
                ...
                labmpc, nmpc, &nmethodact, cam, neq, veold, accold, &bet, &gam,
        ...
        if (dampmat) {
          ...
          mafilldmssmain(
              ...
              adc, auc, nactdof, jq, irow, neq, nmethod, ikmpc, ilmpc, elcon,
              nelcon, rhcon, nrhcon, alcon, nalcon, alzero, ielmat, ielorien,
              norien, orab, ntmat_, t0, t0, ithermal, vold, iperturb, sti, nzs,
              stx, iexpl, plicon, nplicon, plkcon, nplkcon, xstiff, npmat_,
              &dtime, matname, mi, ncmat_, physcon, ttime, &time, istep, &iinc,
              ibody, xloadold, &reltime, veold, springarea, nstate_, xstateini,
              xstate, thicke, integerglob, doubleglob, tieset, istartset,
              iendset, ialset, &ntie, &nasym, pslavsurf, pmastsurf, &mortar,
              clearini, ielprop, prop, &ne0, &freq[l], ndamp, dacon, set, nset);

          /*  zc = damping matrix * eigenmodes */

          NNEW(zc, double, neq[1] * nev);
          for (i = 0; i < nev; i++) {
            opmain(&neq[1], &z[(long long)i * neq[1]], &zc[i * neq[1]], adc,
                   auc, jq, irow);
          }
          SFREE(adc);
          SFREE(auc);
          ...
          for (i = 0; i < nev; i++) {
            for (j = 0; j <= i; j++) {
              for (k = 0; k < neq[1]; k++) {
                cc[i * nev + j] +=
                    z[(long long)j * neq[1] + k] * zc[i * neq[1] + k];
              }
            }
          }
          SFREE(zc);
          ...
          FORTRAN(
              ...
              (co, nk, kon, ipkon, lakon, ne, nodeboun, ndirboun, xboun, nboun,
               ipompc, nodempc, coefmpc, nmpc, nodeforc, ndirforc, xforc, nforc,
               nelemload, sideload, xload, nload, xbody, ipobody, nbody, cgr,
               adc, auc, nactdof, icol, jq, irow, neq, nzl, nmethod, ikmpc,
               ilmpc, ikboun, ilboun, elcon, nelcon, rhcon, nrhcon, alcon,
               nalcon, alzero, ielmat, ielorien, norien, orab, ntmat_, t0, t0,
               ithermal, prestr, iprestr, vold, iperturb, sti, nzs, stx, adb,
               aub, iexpl, plicon, nplicon, plkcon, nplkcon, xstiff, npmat_,
               &dtime, matname, mi, ncmat_, ttime, &time, istep, &iinc, ibody,
               ielprop, prop));
      ...
      rhsmain(co, nk, kon, ipkon, lakon, ne, ipompc, nodempc, coefmpc, nmpc,
              nodeforc, ndirforc, xforcr, nforc, nelemload, sideload, xloadr,
              nload, xbodyr, ipobody, nbody, cgr, br, nactdof, &neq[1], nmethod,
              ikmpc, ilmpc, elcon, nelcon, rhcon, nrhcon, alcon, nalcon, alzero,
              ielmat, ielorien, norien, orab, ntmat_, t0, t1act, ithermal,
              iprestr, vold, iperturb, iexpl, plicon, nplicon, plkcon, nplkcon,
        ...
        if (nherm == 1) {
              ...
              for (i = 0; i < nev; i++) {
                ...
                if (id != 0) {
                  if (izdof[id - 1] == ikactmechr[j]) {
                    aa[i] +=
                        z[(long long)i * nzdof + id - 1] * br[ikactmechr[j]];
                  } else {
          ...
          if (!cyclicsymmetry) {
            for (i = 0; i < nev; i++) {
              ...
              if (nactmechr < neq[1] / 2) {
                for (j = 0; j < nactmechr; j++) {
                  aa[2 * i] += z[(long long)2 * i * neq[1] + ikactmechr[j]] *
                               br[ikactmechr[j]];
                  aa[2 * i + 1] +=
                      z[(long long)(2 * i + 1) * neq[1] + ikactmechr[j]] *
                      br[ikactmechr[j]];
                }
              } else {
                for (j = 0; j < neq[1]; j++) {
                  ...
                  aa[2 * i + 1] +=
                      z[(long long)(2 * i + 1) * neq[1] + j] * br[j];
                }
              }
            }
          } else {
            ...
            for (j = 0; j < nactmechr; j++) {
              for (i = 0; i < nev; i++) {
                ...
                if (id != 0) {
                  if (izdof[id - 1] == ikactmechr[j]) {
                    aa[i] += z[(long long)2 * i * nzdof + id - 1] *
                             br[ikactmechr[j]];
                    aa[i] += z[(long long)(2 * i + 1) * nzdof + id - 1] *
                             br[ikactmechr[j]];
                  } else {
                    printf(" *ERROR in steadystate\n");
                    FORTRAN(stop, ());
      ...
      rhsmain(co, nk, kon, ipkon, lakon, ne, ipompc, nodempc, coefmpc, nmpc,
              nodeforc, ndirforc, xforci, nforc, nelemload, sideload, xloadi,
              nload, xbodyi, ipobody, nbody, cgr, bi, nactdof, &neq[1], nmethod,
              ikmpc, ilmpc, elcon, nelcon, rhcon, nrhcon, alcon, nalcon, alzero,
              ielmat, ielorien, norien, orab, ntmat_, t0, t1act, ithermal,
              iprestr, vold, iperturb, iexpl, plicon, nplicon, plkcon, nplkcon,
              npmat_, ttime, &time, istep, &iinc, &dtime, physcon, ibody,
        ...
        if (nherm == 1) {
              ...
              for (i = 0; i < nev; i++) {
                ...
                if (id != 0) {
                  if (izdof[id - 1] == ikactmechi[j]) {
                    bb[i] +=
                        z[(long long)i * nzdof + id - 1] * bi[ikactmechi[j]];
                  } else {
                    printf(" *ERROR in steadystate\n");
                    FORTRAN(stop, ());
                  }
          ...
          if (!cyclicsymmetry) {
            for (i = 0; i < nev; i++) {
              ...
              if (nactmechi < neq[1] / 2) {
                for (j = 0; j < nactmechi; j++) {
                  bb[2 * i] += z[(long long)2 * i * neq[1] + ikactmechi[j]] *
                               bi[ikactmechi[j]];
                  bb[2 * i + 1] +=
                      z[(long long)(2 * i + 1) * neq[1] + ikactmechi[j]] *
                      bi[ikactmechi[j]];
                }
              } else {
                for (j = 0; j < neq[1]; j++) {
                  ...
                  bb[2 * i + 1] +=
                      z[(long long)(2 * i + 1) * neq[1] + j] * bi[j];
                }
              }
            }
          } else {
            ...
            for (j = 0; j < nactmechi; j++) {
              for (i = 0; i < nev; i++) {
                ...
                if (id != 0) {
                  if (izdof[id - 1] == ikactmechi[j]) {
                    bb[2 * i] += z[(long long)2 * i * nzdof + id - 1] *
                                 bi[ikactmechi[j]];
                    bb[2 * i + 1] +=
                        z[(long long)(2 * i + 1) * nzdof + id - 1] *
                        bi[ikactmechi[j]];
                  } else {
                    printf(" *ERROR in steadystate\n");
                    FORTRAN(stop, ());
      ...
      if (nherm == 1) {
        if ((dampmat == 0) && (coriolis == 0)) {
          ...
          for (i = 0; i < nev; i++) {
            ...
            for (j = 0; j < nev; j++) {
              am[(j + nev) * nev2 + i] =
                  am[(j + nev) * nev2 + i] - cc[i * nev + j];  //*freq[l];
              am[j * nev2 + nev + i] =
                  am[j * nev2 + nev + i] + cc[i * nev + j];  //*freq[l];
            }
          }
        ...
        for (i = 0; i < nev; i++) {
          for (j = 0; j < nev; j++) {
            am[j * nev2 + i] =
                xmr[j * nev + i] * ax[j] + xmi[j * nev + i] * bx[j];
            am[(j + nev) * nev2 + i] =
                xmr[j * nev + i] * bx[j] - xmi[j * nev + i] * bx[j];
            am[j * nev2 + nev + i] =
                xmi[j * nev + i] * ax[j] - xmr[j * nev + i] * bx[j];
            am[(j + nev) * nev2 + nev + i] =
                xmi[j * nev + i] * bx[j] + xmr[j * nev + i] * ax[j];
          }
          bm[i] = aa[i] - bb[nev + i];
      ...
      if (iprescribedboundary) {
        ...
        FORTRAN(dynresults,
                (nk, vr, ithermal, nactdof, vold, nodeboun, ndirboun, xbounr,
                 nboun, ipompc, nodempc, coefmpc, labmpc, nmpc, br, bi, veold,
                 &dtime, mi, imdnode, &nmdnode, imdboun, &nmdboun, imdmpc,
                 &nmdmpc, nmethod, &timem));

        results(co, nk, kon, ipkon, lakon, ne, vr, stnr, inum, stx, elcon,
                nelcon, rhcon, nrhcon, alcon, nalcon, alzero, ielmat, ielorien,
                norien, orab, ntmat_, t0, t1, ithermal, prestr, iprestr, filab,
                eme, emn, een, iperturb, f, fn, nactdof, &iout, qa, vold, br,
                nodeboun, ndirboun, xbounr, nboun, ipompc, nodempc, coefmpc,
                labmpc, nmpc, nmethod, cam, &neq[1], veold, accold, &bet, &gam,
                &dtime, &time, &xnull, plicon, nplicon, plkcon, nplkcon,
                xstateini, xstiff, xstate, npmat_, epn, matname, mi, &ielas,
                &icmd, ncmat_, nstate_, stiini, vini, ikboun, ilboun, ener,
                enern, emeini, xstaten, eei, enerini, cocon, ncocon, set, nset,
                istartset, iendset, ialset, nprint, prlab, prset, qfx, qfn,
                ...
                typeboun, itiefac, tieset, smscale, &mscalmethod, nbody, t0g,
                t1g, islavquadel, aut, irowt, jqt, &mortartrafoflag, &intscheme,
                physcon);
      } else {
        /* calculating displacements/temperatures */

        FORTRAN(dynresults,
                (nk, vr, ithermal, nactdof, vold, nodeboun, ndirboun, xbounact,
                 nboun, ipompc, nodempc, coefmpc, labmpc, nmpc, br, bi, veold,
                 &dtime, mi, imdnode, &nmdnode, imdboun, &nmdboun, imdmpc,
                 &nmdmpc, nmethod, &timem));
      ...
      frd(co, &nkg, kon, ipkon, lakon, &neg, vr, stnr, inum, nmethod, kode,
          filab, een, t1, fn, &ptime, epn, ielmat, matname, enern, xstaten,
          nstate_, istep, &iinc, ithermal, qfn, &mode, &noddiam, trab, inotr,
          ntrans, orab, ielorien, norien, description, ipneigh, neigh, mi, stx,
          vr, vi, stnr, stni, vmax, stnmax, &ngraph, veold, ener, &neg, cs, set,
      ...
      if (iprescribedboundary) {
        ...
        FORTRAN(dynresults,
                (nk, vi, ithermal, nactdof, vold, nodeboun, ndirboun, xbouni,
                 nboun, ipompc, nodempc, coefmpc, labmpc, nmpc, bi, br, veold,
                 &dtime, mi, imdnode, &nmdnode, imdboun, &nmdboun, imdmpc,
                 &nmdmpc, nmethod, &time));

        results(co, nk, kon, ipkon, lakon, ne, vi, stni, inum, stx, elcon,
                nelcon, rhcon, nrhcon, alcon, nalcon, alzero, ielmat, ielorien,
                norien, orab, ntmat_, t0, t1, ithermal, prestr, iprestr, filab,
                eme, emn, een, iperturb, f, fn, nactdof, &iout, qa, vold, bi,
                nodeboun, ndirboun, xbouni, nboun, ipompc, nodempc, coefmpc,
                labmpc, nmpc, nmethod, cam, &neq[1], veold, accold, &bet, &gam,
                &dtime, &time, &xnull, plicon, nplicon, plkcon, nplkcon,
                xstateini, xstiff, xstate, npmat_, epn, matname, mi, &ielas,
                &icmd, ncmat_, nstate_, stiini, vini, ikboun, ilboun, ener,
        ...
        FORTRAN(dynresults,
                (nk, vi, ithermal, nactdof, vold, nodeboun, ndirboun, xbounact,
                 nboun, ipompc, nodempc, coefmpc, labmpc, nmpc, bi, br, veold,
                 &dtime, mi, imdnode, &nmdnode, imdboun, &nmdboun, imdmpc,
                 &nmdmpc, nmethod, &time));
        ...
        if (*ithermal <= 1) {
          if (nmdnode == 0) {
            for (i = 0; i < *nk; i++) {
              for (j = 1; j < 4; j++) {
                vreal = vr[mt * i + j];
                va[mt * i + j] = sqrt(vr[mt * i + j] * vr[mt * i + j] +
                                      vi[mt * i + j] * vi[mt * i + j]);
                if (va[mt * i + j] < 1.e-10) {
                  vp[mt * i + j] = 0.;
          ...
          if (nmdnode == 0) {
            for (i = 0; i < *nk; i++) {
              vreal = vr[mt * i];
              va[mt * i] =
                  sqrt(vr[mt * i] * vr[mt * i] + vi[mt * i] * vi[mt * i]);
              if (va[mt * i + j] < 1.e-10) {
                vp[mt * i + j] = 0.;
              } else if (fabs(vreal) < 1.e-10) {
                if (vi[mt * i] > 0) {
        ...
        if (*ithermal <= 1) {
          if (nmdnode == 0) {
            for (i = 0; i < *nk; i++) {
              for (j = 0; j < 6; j++) {
                vreal = stnr[6 * i + j];
                stna[6 * i + j] = sqrt(stnr[6 * i + j] * stnr[6 * i + j] +
                                       stni[6 * i + j] * stni[6 * i + j]);
      ...
      frd(co, &nkg, kon, ipkon, lakon, &neg, vi, stni, inum, nmethod, kode,
          filab, een, t1, fn, &ptime, epn, ielmat, matname, enern, xstaten,
          nstate_, istep, &iinc, ithermal, qfn, &mode, &noddiam, trab, inotr,
          ntrans, orab, ielorien, norien, description, ipneigh, neigh, mi, stx,
          va, vp, stna, stnp, vmax, stnmax, &ngraph, veold, ener, &neg, cs, set,
          nset, istartset, iendset, ialset, eenmax, fnr, fni, emn, thicke,
          jobnamec, output, qfx, cdn, &mortar, cdnr, cdni, nmat, ielprop, prop,
          sti);
    ...
    **********************************************************************/
    ...
    if (xmodal[10] < 0) {
      ...
      if (iprescribedboundary) {
        printf(
            " *ERROR in steadystate: prescribed boundaries are not allowed in "
            "combination with direct modal damping\n");
        FORTRAN(stop, ());
      }
    ...
    for (l = 0; l < nfour; l++) {
      ...
      FORTRAN(
          tempload,
          (xforcold, xforc, &xforcact[l * *nforc], iamforc, nforc, xloadold,
           xload, &xloadact[l * 2 * *nload], iamload, nload, ibody, xbody,
           nbody, xbodyold, &xbodyact[l * 7 * *nbody], t1old, t1, t1act, iamt1,
           nk, amta, namta, nam, ampli, &time, &reltime, ttime, &dtime,
           ithermal, nmethod, xbounold, xboun, &xbounact[l * *nboun], iamboun,
           nboun, nodeboun, ndirboun, nodeforc, ndirforc, istep, &iinc, co,
           vold, itg, &ntg, amname, ikboun, ilboun, nelemload, sideload, mi,
           ntrans, trab, inotr, veold, integerglob, doubleglob, tieset,
           istartset, iendset, ialset, &ntie, nmpc, ipompc, ikmpc, ilmpc,
           nodempc, coefmpc, ipobody, iponoel, inoel, ipkon, kon, ielprop, prop,
           ielmat, shcon, nshcon, rhcon, nrhcon, cocon, ncocon, ntmat_, lakon,
           set, nset));
    }
    ...
    if (fabs(fmax - fmin) < 1.e-10) {
      ...
      for (j = 1; j < ndata; j++) {
        ...
        if (fabs(y) < 1.e-10) {
          ...
          freqnh[ndatatot + j] =
              (freqnh[ndatatot] + fmax) / 2. + (fmax - freqnh[ndatatot]) *
                                                   pow(fabs(y), 1. / bias) * y /
                                                   (2. * fabs(y));
        }
      }
    ...
    for (ii = 0; ii < ndatatot; ii++) {
      ...
      for (l = 0; l < nfour; l++) {
        ...
        if ((dampmat || coriolis)) {
          ...
          results(
              ...
              &nmethodact, cam, neq, veold, accold, &bet, &gam, &dtime, &time,
          ...
          if (dampmat) {
            ...
            mafilldmssmain(
                ...
                adc, auc, nactdof, jq, irow, neq, nmethod, ikmpc, ilmpc, elcon,
                nelcon, rhcon, nrhcon, alcon, nalcon, alzero, ielmat, ielorien,
                norien, orab, ntmat_, t0, t0, ithermal, vold, iperturb, sti,
                nzs, stx, iexpl, plicon, nplicon, plkcon, nplkcon, xstiff,
                npmat_, &dtime, matname, mi, ncmat_, physcon, ttime, &time,
                istep, &iinc, ibody, xloadold, &reltime, veold, springarea,
                nstate_, xstateini, xstate, thicke, integerglob, doubleglob,
                tieset, istartset, iendset, ialset, &ntie, &nasym, pslavsurf,
                pmastsurf, &mortar, clearini, ielprop, prop, &ne0, &freq[l],
                ndamp, dacon, set, nset);
            ...
            FORTRAN(
                ...
                (co, nk, kon, ipkon, lakon, ne, nodeboun, ndirboun, xboun,
                 ...
                 xforc, nforc, nelemload, sideload, xload, nload, xbody,
                 ipobody, nbody, cgr, adc, auc, nactdof, icol, jq, irow, neq,
                 nzl, nmethod, ikmpc, ilmpc, ikboun, ilboun, elcon, nelcon,
                 rhcon, nrhcon, alcon, nalcon, alzero, ielmat, ielorien, norien,
                 orab, ntmat_, t0, t0, ithermal, prestr, iprestr, vold,
                 iperturb, sti, nzs, stx, adb, aub, iexpl, plicon, nplicon,
                 plkcon, nplkcon, xstiff, npmat_, &dtime, matname, mi, ncmat_,
        ...
        rhsmain(co, nk, kon, ipkon, lakon, ne, ipompc, nodempc, coefmpc, nmpc,
                nodeforc, ndirforc, xforcr, nforc, nelemload, sideload, xloadr,
                nload, xbodyr, ipobody, nbody, cgr, br, nactdof, &neq[1],
                nmethod, ikmpc, ilmpc, elcon, nelcon, rhcon, nrhcon, alcon,
                nalcon, alzero, ielmat, ielorien, norien, orab, ntmat_, t0,
                t1act, ithermal, iprestr, vold, iperturb, iexpl, plicon,
              ...
              for (i = 0; i < nev; i++) {
                ...
                if (id != 0) {
                  if (izdof[id - 1] == ikactmech[j]) {
                    aa[i] +=
                        z[(long long)i * nzdof + id - 1] * br[ikactmech[j]];
                  } else {
                    printf(" *ERROR in steadystate\n");
                    FORTRAN(stop, ());
                  }
        ...
        if (nmdnode == 0) {
          ...
          for (j = 0; j < nfour; j++) {
            ...
            for (i = 0; i < neq[1]; i++) {
              ...
              bp[j * neq[1] + i] -=
                  freq[l] * br[i] * sin(freq[l] * time + bi[i]);
            }
          }
        } else {
          /* magnitude and phase of the response */
      ...
      for (l = 0; l < nfour; l++) {
        ...
        *nmethod = 4;
        FORTRAN(dynresults,
                (nk, vr, ithermal, nactdof, vold, nodeboun, ndirboun,
                 &xbounacttime[l * *nboun], nboun, ipompc, nodempc, coefmpc,
                 labmpc, nmpc, &btot[l * neq[1]], &bp[l * neq[1]], veold,
                 &dtime, mi, imdnode, &nmdnode, imdboun, &nmdboun, imdmpc,
                 &nmdmpc, nmethod, &time));
        *nmethod = 5;

        results(
            co, nk, kon, ipkon, lakon, ne, vr, stn, inum, stx, elcon, nelcon,
            rhcon, nrhcon, alcon, nalcon, alzero, ielmat, ielorien, norien,
            orab, ntmat_, t0, t1, ithermal, prestr, iprestr, filab, eme, emn,
            een, iperturb, f, fn, nactdof, &iout, qa, vold, &btot[l * neq[1]],
            nodeboun, ndirboun, &xbounacttime[l * *nboun], nboun, ipompc,
            nodempc, coefmpc, labmpc, nmpc, nmethod, cam, &neq[1], veold,
            accold, &bet, &gam, &dtime, &time, &xnull, plicon, nplicon, plkcon,
            nplkcon, xstateini, xstiff, xstate, npmat_, epn, matname, mi,
            &ielas, &icmd, ncmat_, nstate_, stiini, vini, ikboun, ilboun, ener,
            enern, emeini, xstaten, eei, enerini, cocon, ncocon, set, nset,
            istartset, iendset, ialset, nprint, prlab, prset, qfx, qfn, trab,
            inotr, ntrans, fmpc, nelemload, nload, ikmpc, ilmpc, istep, &iinc,
            springarea, &reltime, &ne0, thicke, shcon, nshcon, sideload, xload,
            xloadold, &icfd, inomat, pslavsurf, pmastsurf, &mortar, islavact,
            cdn, islavnode, nslavnode, &ntie, clearini, islavsurf, ielprop,
            prop, energyini, energy, &iit, iponoel, inoel, nener, orname,
            &network, ipobody, xbodyact, ibody, typeboun, itiefac, tieset,
            smscale, &mscalmethod, nbody, t0g, t1g, islavquadel, aut, irowt,
            jqt, &mortartrafoflag, &intscheme, physcon);
        ...
        frd(co, &nkg, kon, ipkon, lakon, &neg, vr, stn, inum, nmethod, kode,
            filab, een, t1, fn, &ptime, epn, ielmat, matname, enern, xstaten,
            nstate_, istep, &iinc, ithermal, qfn, &mode, &noddiam, trab, inotr,
            ntrans, orab, ielorien, norien, description, ipneigh, neigh, mi,
            stx, vr, vi, stnr, stni, vmax, stnmax, &ngraph, veold, ener, &neg,
  ...
  if (!cyclicsymmetry) {
    ...
    *mpcend = mpcendold;
    ...
    if (*nload > 0) {
      if (*nam > 0) {
        FORTRAN(isortiiddc,
                (nelemload, iamload, xload, xloadold, sideload, nload, &kflag));
      } else {
        FORTRAN(isortiddc,
                (nelemload, xload, xloadold, sideload, nload, &kflag));
      }
    }

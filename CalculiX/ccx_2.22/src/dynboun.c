...
void dynboun(double *amta, ITG *namta, ITG *nam, double *ampli, double *time,
  ...
  double *xbounmin = NULL, *xbounplus = NULL, *bplus = NULL, *ba = NULL,
         deltatime, deltatime2, deltatimesq, timemin, ttimemin, timeplus,
         ttimeplus, *aux = NULL, *b1 = NULL, *b2 = NULL, *bnew = NULL;
  ...
  if (*init == 1) {
    ...
    FORTRAN(temploadmodal, (amta, namta, nam, ampli, &timemin, &ttimemin, dtime,
                            xbounold, xboun, xbounmin, iamboun, nboun, nodeboun,
                            ndirboun, amname, reltime));
  }
  ...
  FORTRAN(temploadmodal, (amta, namta, nam, ampli, &timeplus, &ttimeplus, dtime,
                          xbounold, xboun, xbounplus, iamboun, nboun, nodeboun,
                          ndirboun, amname, reltime));

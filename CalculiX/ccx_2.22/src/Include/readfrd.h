...
typedef struct {
  ...
  char **pheader; /* project header (remark: leading dataset-project-headers are
                     stored in the related dataset!) */
  ...
  int c; /* number of 'cuts' over all nodeBlocks (block-to-block interfaces for
            isaac) */
  ...
  int orignmax;   /* max-node-nr-of-original-nodes (w/o nodes for drawing
                     purposes) */

...
void checkdivergence(
  ...
  ITG ia, ngraph = 1, k, *ipneigh = NULL, *neigh = NULL, *inum = NULL,
          mt = mi[1] + 1, kscalemax;

  double *vr = NULL, *vi = NULL, *stnr = NULL, *stni = NULL, *vmax = NULL,
         *stnmax = NULL, *cs = NULL, *fn = NULL, *eenmax = NULL, *fnr = NULL,
         *fni = NULL, *qfx = NULL, *cdn = NULL, *cdnr = NULL, *cdni = NULL;

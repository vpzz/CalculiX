 ...
 *  [in] mi		(1) max # of integration points per element (2) max
 *degree of freedom per element [in] nk		number of nodes [in,out] nkon
 *size of kon
 *  [in,out] stxp		usually: (1:6,k,i) buckling stress of element i
 *in integration point k here: used to transmit contact variables [in] cdisp
 *mortar contact output CDISP, CSTRESS [in,out] fn		internal forces

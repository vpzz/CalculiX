...
static ITG *nk1, *kon1, *ipkon1, *ne1, *ipompc1, *nodempc1, *nmpc1, *nelemload1,
    *nload1, *ipobody1, *nbody1, *nactdoh1, *nmethod1, *ikmpc1, *ilmpc1,
    *nrhcon1, *ielmat1, *ntmat_1, *ithermal1, nzsv1, *mi1, *nshcon1, *istep1,
    *iinc1, *ibody1, *iturbulent1, *nelemface1, *nface1, compressible1,
    num_cpus, *ncocon1, *ipvar1, *ipvarf1, *ipface1, *irow1, *jq1, neq1,
    *ifreesurface1, nkstart1, nkend1, mt1, *inomat1,
    *ierr1 = NULL, iexplicit1, *iponoel1, *inoel1, *nodeboun1, *ndirboun1,
    *nboun1, *isolidsurf1, *nsolidsurf1, *nfreestream1, *ifreestream1, *ilboun1;

static double *co1, *coefmpc1, *xloadact1, *xbodyact1, *rhcon1,
    *bpar1 = NULL, *vold1, *vcon1, dtimef1, *physcon1, *shcon1, *ttime1, timef1,
    *xloadold1, *b1 = NULL, theta11, *v1, *cocon1, *depth1, dgravity1,
    *vmax1 = NULL, *vconmax1 = NULL, reltimef1, *var1, *varf1, *b2 = NULL,
    *aub1, *adl1, *sol1, *aux1, *sa1, shockcoef1, *xbounact1, *xsolidsurf1,
    *coefmodmpc1, *voldo1, ratio1;

void compfluidfem(
    double **cop, ITG *nk, ITG **ipkonp, ITG **konp, char **lakonp, ITG *ne,
    char **sidefacep, ITG *ifreestream, ITG *nfreestream, ITG *isolidsurf,
    ...
    ITG *ilboun, ITG *iturbulent, ITG *isolver, ITG *iexpl, double *ttime,
    ...
    ITG *ntg, char *amname, double *t0, ITG **nelemfacep, ITG *nface,
    ...
    ITG **inomatp, double *qfx, ITG *kode, ITG *ipface, ITG *ielprop,
    double *prop, char *orname, double *tincf, ITG *ifreesurface, ITG *nktot,
  ...
  ITG *ipointer = NULL, *mast1 = NULL, *irowv = NULL, *irowp = NULL,
      *icolv = NULL, *icolp = NULL, *jqv = NULL, *jqp = NULL, *nactdoh = NULL,
      i, j, *nx = NULL, *ny = NULL, *nz = NULL, nzs, neqp, nzsv, nzsp,
      iexplicit, nzlp, nnstep, iconvergence = 0, iit, symmetryflag = 0,
      inputformat = 0, compressible, *inum = NULL, iqfx = 0, isti = 0, nrhs = 1,
      mt = mi[1] + 1, *ipvar = NULL, *ipvarf = NULL, nvar_, nvarf_, nfield,
      ndim, iorienloc, *ithread = NULL, maxit = 1, *integerglob = NULL,
      *nodempc = NULL, *ipompc = NULL, *ikmpc = NULL, *ilmpc = NULL,
  ...
  double *yy = NULL, *xsolidsurf = NULL, *dt = NULL, *vcon = NULL, *x = NULL,
         *y = NULL, *z = NULL, *xo = NULL, *yo = NULL, *zo = NULL, *adbv = NULL,
         *aubv = NULL, *adbp = NULL, *aubp = NULL, timef, ttimef, ttimf, xg[3],
         dtimef, *sol = NULL, *aux = NULL, *stn = NULL, theta1, theta2,
         *adb = NULL, *qfn = NULL, *aub = NULL, sigma = 0., *dh = NULL,
         reltimef, *thicke = NULL, shockcoef, *sa = NULL, *varf = NULL,
         dgravity, *adlv = NULL, *adlp = NULL, *var = NULL, *vconini = NULL,
         *doubleglob = NULL, *coefmpc = NULL, *fmpc = NULL, *co = NULL,
         *vold = NULL, reltime, *dhel = NULL, *voldo = NULL, dtimefo, temp,
         ratio, *aubvr = NULL, *coefmodmpc = NULL, *voldini = NULL,
         *depth = NULL, *vcono = NULL, vconmax[7], vmax[7], *v = NULL;
  ...
  *kode = 0;
  ...
  mastructffem(nk, kon, ipkon, lakon, ne, nodeboun, ndirboun, nboun, ipompc,
               nodempc, nmpc, nactdoh, icolv, icolp, jqv, jqp, &mast1, &irowv,
               &irowp, &neqp, ipointer, &nzsv, &nzsp, &nzs, &compressible,
               inomat);
  ...
  FORTRAN(
      initialcfdfem,
      (yy, nk, co, ne, ipkon, kon, lakon, x, y, z, xo, yo, zo, nx, ny, nz,
       isolidsurf, neighsolidsurf, xsolidsurf, dh, nshcon, shcon, nrhcon, rhcon,
       vold, vcon, ntmat_, iponoel, inoel, nsolidsurf, iturbulent, physcon,
       &compressible, matname, inomat, mi, ithermal, dhel, jyy, ifreesurface,
  ...
  if (compressible) {
    ...
    FORTRAN(normmpc, (nmpc, ipompc, nodempc, coefmpc, inomat, coefmodmpc,
                      ikboun, nboun));
  }
  ...
  calcshapef(&nvar_, ipvar, &var, ne, lakon, co, ipkon, kon, nelemface,
             sideface, nface, &nvarf_, ipvarf, &varf, iturbulent, yy);
  ...
  FORTRAN(mafillvlhs, (nk, kon, ipkon, lakon, ne, icolv, jqv, irowv, &nzsv,
                       adbv, aubv, ipvar, var));
  ...
  if (compressible == 0) {
    ...
    FORTRAN(mafillplhs,
            (kon, ipkon, lakon, ne, ipompc, nodempc, coefmpc, nmpc, nactdoh,
...
#ifdef SGI
        token = 1;
        sgi_factor(adbp, aubp, adb, aub, &sigma, icolp, irowp, &neqp, &nzsp,
                   token);
#else
...
#ifdef PASTIX
        pastix_factor_main(adbp, aubp, adb, aub, &sigma, icolp, irowp, &neqp,
                           &nzsp, &symmetryflag, &inputformat, jqp, &nzsp);
#else
  ...
  if (compressible == 0) {
    ...
    nk1 = nk;
    vold1 = vold;
    isolidsurf1 = isolidsurf;
    nsolidsurf1 = nsolidsurf;
    xsolidsurf1 = xsolidsurf;
    nfreestream1 = nfreestream;
    ifreestream1 = ifreestream;
    iturbulent1 = iturbulent;
    vcon1 = vcon;
    shcon1 = shcon;
    nshcon1 = nshcon;
    ntmat_1 = ntmat_;
    ...
    ilmpc1 = ilmpc;
    labmpc1 = labmpc;
    coefmodmpc1 = coefmodmpc;
    iexplicit1 = iexplicit;

    NNEW(ithread, ITG, num_cpus);
    for (i = 0; i < num_cpus; i++) {
      ithread[i] = i;
      pthread_create(&tid[i], NULL, (void *)applybounfemmt,
                     (void *)&ithread[i]);
    }
    for (i = 0; i < num_cpus; i++) {
  ...
  do {
    ...
    do {
      ...
      if ((*nmethod == 4) ||
          ((*nmethod == 1) && ((iit / ipower) * ipower == iit))) {
        FORTRAN(compdt,
                (nk, dt, nshcon, shcon, vold, ntmat_, iponoel, inoel, &dtimef,
                 ielmat, dh, cocon, ncocon, ithermal, mi, vcon, &compressible,
                 tincf, &ierr, ifreesurface, &dgravity, &iit));
      ...
      if (*nmethod == 1) {
        ...
        if (iit == 1) {
          FORTRAN(
              ...
              (xforcold, xforc, xforcact, iamforc, nforc, xloadold, xload,
               ...
               time, &reltime, ttime, dtime, ithermal, nmethod, xbounold, xboun,
               xbounact, iamboun, nboun, nodeboun, ndirboun, nodeforc, ndirforc,
               istep, iinc, co, vold, itg, ntg, amname, ikboun, ilboun,
               nelemload, sideload, mi, ntrans, trab, inotr, vold, integerglob,
               doubleglob, tieset, istartset, iendset, ialset, ntie, nmpc,
               ipompc, ikmpc, ilmpc, nodempc, coefmpc, set, nset));
        }
        ...
        FORTRAN(
            ...
            (xforcold, xforc, xforcact, iamforc, nforc, xloadold, xload,
             ...
             t1old, t1, t1act, iamt1, nk, amta, namta, nam, ampli, &timef,
             &reltimef, &ttimef, &dtimef, ithermal, nmethod, xbounold, xboun,
             xbounact, iamboun, nboun, nodeboun, ndirboun, nodeforc, ndirforc,
             istep, iinc, co, vold, itg, ntg, amname, ikboun, ilboun, nelemload,
             sideload, mi, ntrans, trab, inotr, vold, integerglob, doubleglob,
             tieset, istartset, iendset, ialset, ntie, nmpc, ipompc, ikmpc,
             ilmpc, nodempc, coefmpc, set, nset));
      }
      ...
      for (i = 0; i < num_cpus; i++) {
        ithread[i] = i;
        pthread_create(&tid[i], NULL, (void *)mafillv1rhsmt,
                       (void *)&ithread[i]);
      }
      for (i = 0; i < num_cpus; i++) pthread_join(tid[i], NULL);
      ...
      for (i = 0; i < num_cpus; i++) {
        ithread[i] = i;
        pthread_create(&tid[i], NULL, (void *)collectingmt,
                       (void *)&ithread[i]);
      }
      for (i = 0; i < num_cpus; i++) pthread_join(tid[i], NULL);
      SFREE(ithread);
      ...
      NNEW(aux, double, *nk);
      for (i = istart; i < 4; i++) {
        solveeq(adbv, aubv, adlv, &b1[i * *nk], &v[i * *nk], aux, irowv, jqv,
                nk, &maxit, &num_cpus);
      }
      ...
      for (i = 0; i < num_cpus; i++) {
        ithread[i] = i;
        pthread_create(&tid[i], NULL, (void *)mafillprhsmt,
                       (void *)&ithread[i]);
      }
      for (i = 0; i < num_cpus; i++) pthread_join(tid[i], NULL);
      SFREE(ithread);
      ...
      if (compressible) {
        ...
        solveeq(adbv, aubv, adlv, &b1[4 * *nk], &v[4 * *nk], aux, irowv, jqv,
                nk, &maxit, &num_cpus);
        SFREE(aux);
...
#ifdef PARDISO
          pardiso_solve(&b1[4 * *nk], &neqp, &symmetryflag, &inputformat,
                        &nrhs);
#endif
        } else if (*isolver == 8) {
#ifdef PASTIX
        ...
        for (j = 0; j < *nk; j++) {
          b1[4 * *nk + j] =
              b1[4 * *nk + j] / (theta1 * theta2 * dtimef * dtimef);
        }
      ...
      if (compressible == 0) {
        ...
        for (i = 0; i < num_cpus; i++) {
          ithread[i] = i;
          pthread_create(&tid[i], NULL, (void *)mafillv2rhsmt,
                         (void *)&ithread[i]);
        }
        for (i = 0; i < num_cpus; i++) pthread_join(tid[i], NULL);
      ...
      NNEW(aux, double, *nk);
      for (j = 0; j < 3; j++) {
        solveeq(adbv, aubv, adlv, &b2[j * *nk], sol, aux, irowv, jqv, nk,
                &maxit, &num_cpus);
      ...
      if ((compressible) && (shockcoef > 0.)) {
        ...
        for (j = istart; j < 5; j++) {
          ...
          for (i = 0; i < num_cpus; i++) {
            ithread[i] = i;
            pthread_create(&tid[i], NULL, (void *)smoothshockmt,
                           (void *)&ithread[i]);
          }
          for (i = 0; i < num_cpus; i++) pthread_join(tid[i], NULL);
          SFREE(ithread);
      ...
      if ((iexplicit) && (shockcoef > 0.)) {
        ...
        for (i = 0; i < num_cpus; i++) {
          ithread[i] = i;
          pthread_create(&tid[i], NULL, (void *)presgradientmt,
                         (void *)&ithread[i]);
        }
        for (i = 0; i < num_cpus; i++) {
          pthread_join(tid[i], NULL);
      ...
      FORTRAN(cfdconv, (nmethod, &iconvergence, ithermal, &iit, iturbulent,
                        &dtimef, vconmax, vmax));
      ...
      if (((iit / jout[1]) * jout[1] == iit) || (iconvergence == 1) ||
        ...
        if ((isti == 1) || (iqfx == 1)) {
          FORTRAN(
              calcstressheatfluxfem,
              (kon, lakon, ipkon, ielmat, ntmat_, vold, matname, mi, shcon,
               nshcon, iturbulent, &compressible, ipvar, var, sti, qfx, cocon,
        ...
        if ((strcmp1(&filab[3306], "SF  ") == 0) ||
          ...
          NNEW(inum, ITG, *nk);
          FORTRAN(extrapolatefem,
                  (sti, stn, ipkon, inum, kon, lakon, &nfield, nk, ne, mi,
                   &ndim, orab, ielorien, co, &iorienloc));
          SFREE(inum);
        }
        ...
        if (strcmp1(&filab[3393], "HFLF") == 0) {
          ...
          NNEW(inum, ITG, *nk);
          FORTRAN(extrapolatefem,
                  (qfx, qfn, ipkon, inum, kon, lakon, &nfield, nk, ne, mi,
                   &ndim, orab, ielorien, co, &iorienloc));
          SFREE(inum);
        }
        ...
        if ((strcmp1(&filab[1914], "MACH") == 0) ||
          ...
          FORTRAN(calcmach,
                  (vold, v, nk, ntmat_, shcon, nshcon, physcon, inomat, mi));
        }
        ...
        FORTRAN(printoutfluidfem,
                (set, nset, istartset, iendset, ialset, nprint, prlab, prset, v,
                 ipkon, lakon, sti, mi, ithermal, co, kon, qfx, &ttimf, trab,
                 inotr, ntrans, orab, ielorien, norien, vold, ielmat, thicke,
                 physcon, ielprop, prop, orname, vcon, nk, nknew, nelnew));

        /* lift and drag force */

        FORTRAN(printoutfacefem,
                (co, ntmat_, vold, shcon, nshcon, &compressible, istartset,
                 iendset, ipkon, lakon, kon, ialset, prset, &ttimf, nset, set,
        ...
        nnstep = 6;
        FORTRAN(frdfluidfem,
                (co, nk, kon, ipkon, lakon, ne, v, vold, kode, &ttimf, ielmat,
                 matname, &nnstep, physcon, filab, inomat, ntrans, inotr, trab,
                 mi, stn, qfn, istep, sa, &compressible, nactdoh, yy, jyy,
                 ithermal, shcon, nshcon, rhcon, nrhcon, ntmat_, vcon, depth,
                 xg, nodfreesurf, dt, &shockcoef, &iexplicit, nkold, nelold));
  ...
  SFREE(adbv);
  SFREE(aubv);
  if ((compressible == 0) || (iexplicit)) {
    SFREE(adbp);
    SFREE(aubp);
  }
  SFREE(adlv);
  if (iexplicit) SFREE(adlp);
...
void *mafillv1rhsmt(ITG *i) {
  ...
  FORTRAN(
      mafillv1rhs,
      (co1, nk1, kon1, ipkon1, lakon1, ne1, ipompc1, nodempc1, coefmpc1, nmpc1,
       nelemload1, sideload1, xloadact1, nload1, xbodyact1, ipobody1, nbody1,
       &b2[indexb2], nactdoh1, nmethod1, ikmpc1, ilmpc1, rhcon1, nrhcon1,
       ielmat1, ntmat_1, ithermal1, vold1, vcon1, mi1, physcon1, shcon1,
       nshcon1, ttime1, &timef1, istep1, ibody1, xloadold1, iturbulent1,
       nelemface1, sideface1, nface1, &compressible1, &nea, &neb, &dtimef1,
       ipvar1, var1, ipvarf1, varf1, ipface1, ifreesurface1, depth1, &dgravity1,
       cocon1, ncocon1, iinc1, &theta11, &reltimef1, &b1[indexb1]));
...
void *mafillprhsmt(ITG *i) {
  ...
  FORTRAN(mafillprhs, (nk1, kon1, ipkon1, lakon1, ipompc1, nodempc1, coefmpc1,
                       nmpc1, &b1[indexb1], nactdoh1, mi1, v1, &theta11, &nea,
                       &neb, &dtimef1, ipvar1, var1, &compressible1));
...
void *smoothshockmt(ITG *i) {
  ...
  FORTRAN(smoothshock, (aub1, adl1, sol1, aux1, irow1, jq1, &neqa, &neqb, sa1));
...
void *con2physmt(ITG *i) {
  ...
  FORTRAN(con2phys,
          (vold1, vcon1, nk1, ntmat_1, shcon1, nshcon1, rhcon1, nrhcon1,
           physcon1, ithermal1, &compressible1, iturbulent1, inomat1, mi1,
           &ierr1[*i], ifreesurface1, &dgravity1, depth1, &nka, &nkb));
...
void *phys2conmt(ITG *i) {
  ...
  FORTRAN(phys2con,
          (inomat1, vold1, ntmat_1, shcon1, nshcon1, physcon1, &compressible1,
           vcon1, rhcon1, nrhcon1, ithermal1, mi1, ifreesurface1, &ierr1[*i],
           &dgravity1, depth1, nk1, &nka, &nkb));
...
void *presgradientmt(ITG *i) {
  ...
  FORTRAN(presgradient, (iponoel1, inoel1, sa1, &shockcoef1, &dtimef1, ipkon1,
                         kon1, lakon1, vold1, mi1, nactdoh1, &nka, &nkb));
...
void *applybounfemmt(ITG *i) {
  ITG nbouna, nbounb, nboundelta, nmpca, nmpcb, nmpcdelta, nfreestreama,
      nfreestreamb, nfreestreamdelta, nsolidsurfa, nsolidsurfb, nsolidsurfdelta;
  ...
  FORTRAN(
      applybounfem,
      (nodeboun1, ndirboun1, xbounact1, nk1, vold1, isolidsurf1, xsolidsurf1,
       ifreestream1, iturbulent1, vcon1, shcon1, nshcon1, ntmat_1, physcon1, v1,
       &compressible1, nodempc1, ipompc1, coefmpc1, inomat1, mi1, ilboun1,
       ilmpc1, labmpc1, coefmodmpc1, &iexplicit1, &nbouna, &nbounb, &nmpca,
       &nmpcb, &nfreestreama, &nfreestreamb, &nsolidsurfa, &nsolidsurfb));

...
void writenewmesh(ITG *nktet, ITG *netet_, double *cotet, ITG *iquad,
  ...
  ITG nknew, nenew, *ipkonnew = NULL, *konnew = NULL, i, j, netet, *inum = NULL,
                    nmethod = 0, kode = 1, *ielmatnew = NULL, nstate_ = 0,
                    istep, iinc, mode = -1, noddiam = -1, *inotr = NULL, ntrans,
                    *ielorien = NULL, norien, *ipneigh = NULL, *neigh = NULL,
                    ngraph, nset, *istartset = NULL, *iendset = NULL,
                    *ialset = NULL, mortar = 0, *ielprop = NULL;

  double *conew = NULL, *v = NULL, *stn = NULL, *een = NULL, *t1 = NULL,
         *fn = NULL, time = 0., *epn = NULL, *enern = NULL, *xstaten = NULL,
         *qfn = NULL, *trab = NULL, *orab = NULL, *stx = NULL, *vr = NULL,
         *vi = NULL, *stnr = NULL, *stni = NULL, *vmax = NULL, *stnmax = NULL,
         *veold = NULL, *ener = NULL, *cs = NULL, *eenmax = NULL, *fnr = NULL,
         *fni = NULL, *emn = NULL, *thicke = NULL, *qfx = NULL, *cdn = NULL,
  ...
  frd(conew, &nknew, konnew, ipkonnew, lakonnew, &nenew, v, stn, inum, &nmethod,
      &kode, filabnew, een, t1, fn, &time, epn, ielmatnew, matname, enern,
      xstaten, &nstate_, &istep, &iinc, ithermal, qfn, &mode, &noddiam, trab,
      inotr, &ntrans, orab, ielorien, &norien, description, ipneigh, neigh, mi,
      stx, vr, vi, stnr, stni, vmax, stnmax, &ngraph, veold, ener, &nenew, cs,
      set, &nset, istartset, iendset, ialset, eenmax, fnr, fni, emn, thicke,
      fnewmesh, outputnew, qfx, cdn, &mortar, cdnr, cdni, nmat, ielprop, prop,
      sti);

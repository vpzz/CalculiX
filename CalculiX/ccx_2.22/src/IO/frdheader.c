...
void frdheader(ITG *icounter, double *oner, double *time, double *pi,
  ...
  if ((*nmethod == 2) || (*nmethod == 6) || (*nmethod == 7) ||
      (*nmethod == 13) || ((*nmethod == 12) && (*noddiam > -1))) {
    strcpy1(&text[0], "    1PGM", 8);
    for (i = 8; i < 70; i++) text[i] = ' ';
    text[70] = '\0';
    sprintf(&text[24], "%12.6E", *oner);
    text[36] = ' ';
    fprintf(f1, "%s\n", text);
    ...
    for (i = 8; i < 70; i++) text[i] = ' ';
    text[70] = '\0';
    sprintf(&text[24], "%12.6E", (*time * 2. * *pi) * (*time * 2. * *pi));
    text[36] = ' ';
    fprintf(f1, "%s\n", text);

    strcpy1(&text[0], "    1PHID", 9);
    for (i = 9; i < 70; i++) text[i] = ' ';
    text[70] = '\0';
    sprintf(&text[24], "%12" ITGFORMAT "", *noddiam);
    text[36] = ' ';
    fprintf(f1, "%s\n", text);
    ...
    for (i = 10; i < 70; i++) text[i] = ' ';
    text[70] = '\0';
    sprintf(&text[24], "%12" ITGFORMAT "", *null);
    text[36] = ' ';
    fprintf(f1, "%s\n", text);
    ...
    for (i = 10; i < 70; i++) text[i] = ' ';
    text[70] = '\0';
    sprintf(&text[24], "%12" ITGFORMAT "", *mode + 1);
    text[36] = ' ';
    fprintf(f1, "%s\n", text);
  }

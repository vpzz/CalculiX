...
static ITG *nelt1, *ia1, *ja1, *isym1, *itol1, *itmax1,
    *iter1 = NULL, *igwk1 = NULL, *lrgw1, *ligw1, *iwork1, *nestart1, *iunit1,
    *ierr1 = NULL;

static double *b1, *x1, *a1, *tol1 = NULL, *err1 = NULL, *sb1, *sx1,
                             *rgwk1 = NULL, *rwork1;
...
void *dgmres1mt(ITG *i) {
  ...
  FORTRAN(dgmres1,
          (&n, &b1[nestart1[*i]], &x1[nestart1[*i]], nelt1, ia1,
           &ja1[nestart1[*i]], a1, isym1, itol1, &tol1[*i], itmax1, &iter1[*i],
           &err1[*i], &ierr1[*i], iunit1, sb1, sx1, &rgwk1[indexrgwk], lrgw1,
           &igwk1[indexigwk], ligw1, &rwork1[nestart1[*i]], iwork1));

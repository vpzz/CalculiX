...
void premortar(
    ...
    ITG *islavquadel, ITG *islavsurf, ITG *iponoels, ITG *inoels, ITG *mortar,
    ...
    ITG *idamping, ITG *iforbou, ITG *iperturb_sav, ITG *itietri, double *cg,
  ...
  ITG im, i, k,
      mt = mi[1] + 1, *irowc2 = NULL, *icolc2 = NULL, *jqc2 = NULL,
      *irowbd = NULL, *jqbd = NULL, *irowbdtil = NULL, *jqbdtil = NULL,
      *irowbdtil2 = NULL, *jqbdtil2 = NULL, *irowdd = NULL, *jqdd = NULL,
      *irowddtil = NULL, *jqddtil = NULL, *irowddinv = NULL, *jqddinv = NULL,
      *irowddtil2 = NULL, *jqddtil2 = NULL, *irowtemp = NULL, *icoltemp = NULL,
      *jqtemp = NULL, *inum = NULL, mortartrafoflag = 1;

  double alpha,
      *auc2 = NULL, *adc2 = NULL, *aubd = NULL, *aux2 = NULL, *cv = NULL,
      *aubdtil = NULL, *aubdtil2 = NULL, *f = NULL, *fext = NULL, *cvini = NULL,
      *audd = NULL, *auddtil = NULL, *auddinv = NULL, *auddtil2 = NULL,
      *v = NULL, *stx = NULL, *fn = NULL, *fini = NULL, *fextini = NULL,
      *fmpc2 = NULL, *aub = NULL, *adb = NULL, *adc = NULL, *auc = NULL,
      *volddummy = NULL, *vectornull = NULL, *f_cs = NULL, *f_cm = NULL,
      *fnext = NULL;
  ...
  if (*nslavquadel > 0) {
    ...
    *iout = -1;
    ...
    results(co, nk, kon, ipkon, lakon, ne, v, stn, inum, stx, elcon, nelcon,
            ...
            qfx, qfn, trab, inotr, ntrans, fmpc2, nelemload, nload, ikmpc,
            ilmpc, istep, iinc, springarea, reltime, ne0, thicke, shcon, nshcon,
            sideload, xloadact, xloadold, icfd, inomat, pslavsurf, pmastsurf,
            mortar, islavact, cdn, islavnode, nslavnode, ntie, clearini,
            islavsurf, ielprop, prop, energyini, energy, kscale, iponoel, inoel,
            nener, orname, network, ipobody, xbodyact, ibody, typeboun, itiefac,
    ...
    *rhsi = 1;
    ...
    mafillsmmain(
        ...
        nodempc, coefmpc, nmpc, nodeforc, ndirforc, xforcact, nforc, nelemload,
        sideload, xloadact, nload, xbodyact, ipobody, nbody, cgr, ad, au, fext,
        ...
        buckling, rhsi, intscheme, physcon, shcon, nshcon, cocon, ncocon, ttime,

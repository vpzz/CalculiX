...
void inimortar(double **enerp, ITG *mi, ITG *ne, ITG *nslavs, ITG *nk,
  ...
  ITG k, i, j, node,
      mt = mi[1] + 1, *ipkon = NULL, *kon = NULL, *islavtie = NULL,
      *islavact = NULL, *islavactini = NULL, *islavnodeinv = NULL,
      *islavquadel = NULL, *irowt = NULL, *jqt = NULL, nmspc, nmmpc, nsspc,
      nsmpc, *irowtinv = NULL, *jqtinv = NULL, *irowbhelp = NULL,
      *jqbhelp = NULL, *irowb = NULL, *jqb = NULL, *irowd = NULL, *jqd = NULL,
  ...
  double *ener = NULL, *xstate = NULL, *bp = NULL, *gap = NULL, *cdisp = NULL,
         *cstress = NULL, *cfs = NULL, *bpini = NULL, *cstressini = NULL,
         *pslavdual = NULL, *aut = NULL, *autinv = NULL, *Bd = NULL,
         *Bdhelp = NULL, *Dd = NULL, *Ddtil = NULL, *Bdtil = NULL;
  ...
  cfs = *cfsp;
  bpini = *bpinip;
  islavactini = *islavactinip;
  cstressini = *cstressinip;
  islavnodeinv = *islavnodeinvp;
  islavquadel = *islavquadelp;
  pslavdual = *pslavdualp;
  aut = *autp;
  irowt = *irowtp;
  jqt = *jqtp;
  autinv = *autinvp;
  ...
  buildtquad(ntie, ipkon, kon, nk, lakon, nslavnode, itiefac, tieset, islavnode,
             islavsurf, &irowt, jqt, &aut, &irowtinv, jqtinv, &autinv);

  FORTRAN(genislavquadel,
          (islavquadel, jqt, lakon, ipkon, kon, ne, nasym, nslavquadel));
  ...
  FORTRAN(spcmpcmortar,
          (ntie, islavnode, imastnode, nslavnode, nmastnode, nboun, nmpc,
           ipompc, nodempc, ikboun, ilboun, ikmpc, ilmpc, nslavspc, islavspc,
           &nsspc, nslavmpc, islavmpc, &nsmpc, nmastspc, imastspc, &nmspc,
           nmastmpc, imastmpc, &nmmpc, jobnamef));
  ...
  *cfsp = cfs;
  *bpinip = bpini;
  *islavactinip = islavactini;
  *cstressinip = cstressini;
  *islavnodeinvp = islavnodeinv;
  *islavquadelp = islavquadel;
  *pslavdualp = pslavdual;
  *autp = aut;
  *irowtp = irowt;
  *jqtp = jqt;
  *autinvp = autinv;

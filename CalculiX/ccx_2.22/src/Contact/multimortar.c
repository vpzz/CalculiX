...
/*
   embedding the contact conditions into the matrix system
         ...
         see phd-thesis Sitzmann equation (4.15) for quad-quad/quad-lin method
  or (4.24) for PG quad-lin method
...
void multimortar(
  ...
  ITG i, j, k, l, m,
      mt = mi[1] + 1, nodesf, nodem, irow_ln, irow_lm, irow_li, irow_la,
      impclack, dim, nzs_nn, nzs_nm, nzs_ni, nzs_na, nzs_mn, nzs_mm, nzs_mi,
      nzs_ma, nzs_in, nzs_im, nzs_ii, nzs_ia, nzs_an, nzs_am, nzs_ai, nzs_aa,
      nzs_bd1, nzs_bdtil2, nzs_ddtil2i, nzs_ddtil2a, nzsbdtil2, nzs_mmf,
      nzs_iif, nzs_aaf, nzs_intmn, nzs_intmm, nzs_intmi, nzs_intma, nzs_mntil,
      nzs_mmtil, nzs_mitil, nzs_matil, ifree_nn, ifree_nm, ifree_ni, ifree_na,
      ifree_mn, ifree_mm, ifree_mi, ifree_ma, ifree_in, ifree_im, ifree_ii,
      ifree_ia, ifree_an, ifree_am, ifree_ai, ifree_aa, ifree, *irow = NULL,
      *irow_iid = NULL, *irow_nn = NULL, *irow_nm = NULL, *irow_ni = NULL,
      *irow_na = NULL, *irow_mn = NULL, *irow_mm = NULL, *irow_mi = NULL,
      *irow_ma = NULL, *irow_in = NULL, *irow_im = NULL, *irow_ii = NULL,
      *irow_ia = NULL, *irow_an = NULL, *irow_am = NULL, *irow_ai = NULL,
      *irow_aa = NULL, *jq_iid = NULL, *jq_nn = NULL, *jq_nm = NULL,
      *jq_ni = NULL, *jq_na = NULL, *jq_mn = NULL, *jq_mm = NULL, *jq_mi = NULL,
      *jq_ma = NULL, *jq_in = NULL, *jq_im = NULL, *jq_ii = NULL, *jq_ia = NULL,
      *jq_an = NULL, *jq_am = NULL, *jq_ai = NULL, *jq_aa = NULL, *irowc = NULL,
      *irow_bdtil2 = NULL, *jq_bdtil2 = NULL, *irow_ddtil2i = NULL,
      *jq_ddtil2i = NULL, *irow_ddtil2a = NULL, *jq_ddtil2a = NULL,
      *irow_bd1 = NULL, *jq_bd1 = NULL, *irow_aad = NULL, *irow_mmd = NULL,
      *jq_aad = NULL, *jq_mmd = NULL, *irow_mmf = NULL, *jq_mmf = NULL,
      *irow_mmtil = NULL, *jq_mmtil = NULL, *irow_mntil = NULL,
      *jq_mntil = NULL, *irow_mitil = NULL, *jq_mitil = NULL,
      *irow_matil = NULL, *jq_matil = NULL, *irow_intmn = NULL,
      *jq_intmn = NULL, *irow_intmm = NULL, *jq_intmm = NULL,
      *irow_intmi = NULL, *jq_intmi = NULL, *irow_intma = NULL,
      *jq_intma = NULL, *irow_iif = NULL, *jq_iif = NULL, *irow_aaf = NULL,
      *jq_aaf = NULL, *irow_antil = NULL, *jq_antil = NULL, *irow_amtil = NULL,
      *jq_amtil = NULL, *irow_aitil = NULL, *jq_aitil = NULL,
      *irow_aatil = NULL, *jq_aatil = NULL, *irow_t = NULL, *jq_t = NULL,
      nzs_t = *nzs, *mast1 = NULL, *l_flag = NULL, *n_flag = NULL,
      *m_flag = NULL, *a_flag = NULL, *i_flag = NULL, iact, *n_flagr = NULL,
      *m_flagr = NULL, *i_flagr = NULL, *a_flagr = NULL, nzsddtil2a, nzsddtil2i,
      nzs_sym;

  double *auc = NULL, *au = NULL, *ad_nn = NULL, *ad_mm = NULL, *ad_ii = NULL,
         *ad_aa, *au_bd1 = NULL, *au_bdtil2 = NULL, *au_ddtil2i = NULL,
         *au_ddtil2a = NULL, *au_nn = NULL, *au_nm = NULL, *au_ni = NULL,
         *au_na = NULL, *au_mn = NULL, *au_mm = NULL, *au_mi = NULL,
         *au_ma = NULL, *au_in = NULL, *au_im = NULL, *au_ii = NULL,
         *au_ia = NULL, *au_an = NULL, *au_am = NULL, *au_ai = NULL,
         *au_aa = NULL, *au_mmf = NULL, *au_mmtil = NULL, *au_mntil = NULL,
         ...
         *au_t = NULL, *f_a = NULL, *f_m = NULL, *f_i = NULL, *v_r = NULL,
         *f_atil = NULL;
  ...
  transpose(au, jq, irow, &dim, au_t, jq_t, irow_t);

  add_rect(au, irow, jq, neq[1], neq[1], au_t, irow_t, jq_t, neq[1], neq[1],
           &auc, &irowc, jqc, nzsc);
  ...
  *nzsc = jqc[neq[1]] - 1;
  ...
  add_rect(ad_mm, irow_mmd, jq_mmd, irow_lm, irow_lm, au_mm, irow_mm, jq_mm,
           irow_lm, irow_lm, &au_mmf, &irow_mmf, jq_mmf, &nzs_mmf);
  ...
  add_rect(ad_ii, irow_iid, jq_iid, irow_li, irow_li, au_ii, irow_ii, jq_ii,
           irow_li, irow_li, &au_iif, &irow_iif, jq_iif, &nzs_iif);
  ...
  add_rect(ad_aa, irow_aad, jq_aad, irow_la, irow_la, au_aa, irow_aa, jq_aa,
           irow_la, irow_la, &au_aaf, &irow_aaf, jq_aaf, &nzs_aaf);
  SFREE(au_ii);
  SFREE(irow_ii);
  SFREE(jq_ii);
  SFREE(au_aa);
  ...
  multi_rect(au_bd1, irow_bd1, jq_bd1, irow_la, irow_lm, au_an, irow_an, jq_an,
             irow_la, irow_ln, &au_intmn, &irow_intmn, jq_intmn, &nzs_intmn);

  nzs_mntil = nzs_mn + 1;
  NNEW(jq_mntil, ITG, irow_ln + 1);
  NNEW(au_mntil, double, nzs_mntil);
  NNEW(irow_mntil, ITG, nzs_mntil);
  add_rect(au_intmn, irow_intmn, jq_intmn, irow_lm, irow_ln, au_mn, irow_mn,
           jq_mn, irow_lm, irow_ln, &au_mntil, &irow_mntil, jq_mntil,
           &nzs_mntil);
  ...
  multi_rect(au_bd1, irow_bd1, jq_bd1, irow_la, irow_lm, au_am, irow_am, jq_am,
             irow_la, irow_lm, &au_intmm, &irow_intmm, jq_intmm, &nzs_intmm);

  nzs_mmtil = nzs_mmf;
  NNEW(jq_mmtil, ITG, irow_lm + 1);
  NNEW(au_mmtil, double, nzs_mmtil);
  NNEW(irow_mmtil, ITG, nzs_mmtil);
  add_rect(au_intmm, irow_intmm, jq_intmm, irow_lm, irow_lm, au_mmf, irow_mmf,
           jq_mmf, irow_lm, irow_lm, &au_mmtil, &irow_mmtil, jq_mmtil,
           &nzs_mmtil);
  ...
  multi_rect(au_bd1, irow_bd1, jq_bd1, irow_la, irow_lm, au_ai, irow_ai, jq_ai,
             irow_la, irow_li, &au_intmi, &irow_intmi, jq_intmi, &nzs_intmi);

  nzs_mitil = max(nzs_mi, nzs_intmi);
  NNEW(jq_mitil, ITG, irow_li + 1);
  NNEW(au_mitil, double, nzs_mitil);
  NNEW(irow_mitil, ITG, nzs_mitil);
  add_rect(au_intmi, irow_intmi, jq_intmi, irow_lm, irow_li, au_mi, irow_mi,
           jq_mi, irow_lm, irow_li, &au_mitil, &irow_mitil, jq_mitil,
           &nzs_mitil);
  ...
  multi_rect(au_bd1, irow_bd1, jq_bd1, irow_la, irow_lm, au_aaf, irow_aaf,
             jq_aaf, irow_la, irow_la, &au_intma, &irow_intma, jq_intma,
             &nzs_intma);
  ...
  add_rect(au_intma, irow_intma, jq_intma, irow_lm, irow_la, au_ma, irow_ma,
           jq_ma, irow_lm, irow_la, &au_matil, &irow_matil, jq_matil,
           &nzs_matil);
  ...
  /* call trafoNT: transformation of the last two rows of the matrix with the
     normal and tangential vectors at the contact faces **/
  ...
  trafontmortar2(
      neq, nzs, islavactdof, islavact, nslavnode, f_a, f_atil, au_an, irow_an,
      jq_an, au_am, irow_am, jq_am, au_ai, irow_ai, jq_ai, au_aaf, irow_aaf,
      jq_aaf, &au_antil, &irow_antil, jq_antil, &au_amtil, &irow_amtil,
      jq_amtil, &au_aitil, &irow_aitil, jq_aitil, &au_aatil, &irow_aatil,
      jq_aatil, gap, Bd, irowb, jqb, Dd, irowd, jqd, Ddtil, irowdtil, jqdtil,
      au_bdtil2, irow_bdtil2, jq_bdtil2, au_ddtil2i, irow_ddtil2i, jq_ddtil2i,
      au_ddtil2a, irow_ddtil2a, jq_ddtil2a, m_flagr, i_flagr, a_flagr, a_flag,
      i_flag, m_flag, &irow_ln, &irow_lm, &irow_li, &irow_la, slavnor, slavtan,
      vold, vini, cstress, cstressini, bp_old, nactdof, islavnode, ntie, mi, nk,
      nboun, ndirboun, nodeboun, xboun, ipompc, nodempc, coefmpc, ikboun,
      ilboun, ikmpc, ilmpc, nslavspc, islavspc, nslavmpc, islavmpc, tieset,
      islavtie, nelcon, elcon, tietol, ncmat_, ntmat_, plicon, nplicon, npmat_,
      dtime, irowt, jqt, aut, irowtinv, jqtinv, autinv, islavnodeinv, iit, bet,
    ...
    switch (l_flag[j]) {
      case 0: {
        ...
        for (l = jq_nn[loc_n - 1] - 1; l < jq_nn[loc_n] - 1; l++) {
          // NN
          insertas(&irow, &mast1, &n_flagr[irow_nn[l] - 1], &m, &ifree, nzs,
                   &au_nn[l], &au);
        }
        ...
        for (l = jq_in[loc_n - 1] - 1; l < jq_in[loc_n] - 1; l++) {
          // IN
          insertas(&irow, &mast1, &i_flagr[irow_in[l] - 1], &m, &ifree, nzs,
                   &au_in[l], &au);
        }
      ...
      case 1: {
        ...
        for (l = jq_nm[loc_m - 1] - 1; l < jq_nm[loc_m] - 1; l++) {
          // NM
          insertas(&irow, &mast1, &n_flagr[irow_nm[l] - 1], &m, &ifree, nzs,
                   &au_nm[l], &au);
        }
        for (l = jq_mmtil[loc_m - 1] - 1; l < jq_mmtil[loc_m] - 1; l++) {
          ...
          if ((m == m_flagr[irow_mmtil[l] - 1])) {
            ...
            insertas(&irow, &mast1, &m_flagr[irow_mmtil[l] - 1], &m, &ifree,
                     nzs, &au_mmtil[l], &au);
          }
        }
        for (l = jq_im[loc_m - 1] - 1; l < jq_im[loc_m] - 1; l++) {
          // IM
          insertas(&irow, &mast1, &i_flagr[irow_im[l] - 1], &m, &ifree, nzs,
                   &au_im[l], &au);
        }
      ...
      case 2: {
        ...
        for (l = jq_ni[loc_i - 1] - 1; l < jq_ni[loc_i] - 1; l++) {
          // NI
          insertas(&irow, &mast1, &n_flagr[irow_ni[l] - 1], &m, &ifree, nzs,
                   &au_ni[l], &au);
        }
      ...
      case 3: {
        ...
        for (l = jq_na[loc_a - 1] - 1; l < jq_na[loc_a] - 1; l++) {
          // NA
          insertas(&irow, &mast1, &n_flagr[irow_na[l] - 1], &m, &ifree, nzs,
                   &au_na[l], &au);
        }
        ...
        for (l = jq_ia[loc_a - 1] - 1; l < jq_ia[loc_a] - 1; l++) {
          // IA
          insertas(&irow, &mast1, &i_flagr[irow_ia[l] - 1], &m, &ifree, nzs,
                   &au_ia[l], &au);
        }
        for (l = jq_aatil[loc_a - 1] - 1; l < jq_aatil[loc_a] - 1; l++) {
          ...
          if (m == a_flagr[irow_aatil[l] - 1]) {
            ...
            insertas(&irow, &mast1, &a_flagr[irow_aatil[l] - 1], &m, &ifree,
                     nzs, &au_aatil[l], &au);
          }
        }
        break;

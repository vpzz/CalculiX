...
void inicont(ITG *nk, ITG *ncont, ITG *ntie, char *tieset, ITG *nset, char *set,
             ...
             char *lakon, ITG *ipkon, ITG *kon, ITG **koncontp, ITG *nslavs,
             ...
             ITG *nkon, ITG **iponoelsp, ITG **inoelsp, ITG **ipep, ITG **imep,
  ...
  ITG *itietri = NULL, *koncont = NULL, *itiefac = NULL, *islavsurf = NULL, im,
      ...
      *nmastnode = NULL, nmasts, *ipe = NULL, *ime = NULL, *imastop = NULL,
  ...
  islavnode = *islavnodep;
  imastnode = *imastnodep;
  nslavnode = *nslavnodep;
  nmastnode = *nmastnodep;
  imastop = *imastopp, iponoels = *iponoelsp;
  inoels = *inoelsp;
  ipe = *ipep;
  ime = *imep;
  xnoels = *xnoelsp;
  ...
  FORTRAN(findsurface, (ipoface, nodface, ne, ipkon, kon, lakon, ntie, tieset));

  NNEW(itiefac, ITG, 2 * *ntie);
  RENEW(islavsurf, ITG, 2 * 6 * *ne);
  DMEMSET(islavsurf, 0, 12 * *ne, 0);
  ...
  FORTRAN(tiefaccont,
          (lakon, ipkon, kon, ntie, tieset, nset, set, istartset, iendset,
           ialset, itiefac, islavsurf, islavnode, imastnode, nslavnode,
           nmastnode, nslavs, &nmasts, ifacecount, iponoels, inoels,
           &ifreenoels, mortar, ipoface, nodface, nk, xnoels));
  ...
  *islavnodep = islavnode;
  *imastnodep = imastnode;
  *nslavnodep = nslavnode;
  *nmastnodep = nmastnode;
  *imastopp = imastop;
  *iponoelsp = iponoels;
  *inoelsp = inoels;
  *ipep = ipe;

...
static ITG *nobject1, *nodedesiboun1, ndesiboun1, *nx1, *ny1, *nz1, num_cpus,
    ifree1, *iobject1, *ndesi1, *nk1, *nodenum1;
...
static double *xo1, *yo1, *zo1, *x1, *yy1, *z1, *co1, *dgdxglob1, *extnor1,
    *g01;
...
void packagingmain(double *co, ITG *nobject, ITG *nk, ITG *nodedesi, ITG *ndesi,
  ...
  ITG *nx = NULL, *ny = NULL, *nz = NULL, ifree, i, j, *ithread = NULL,
      ndesiboun, *nodedesiboun = NULL, *nodenum = NULL;
  ...
  FORTRAN(prepackaging,
          (co, xo, yo, zo, x, y, z, nx, ny, nz, &ifree, nodedesiinv, &ndesiboun,
           nodedesiboun, set, nset, objectset, iobject, istartset, iendset,
           ialset, nodenum));
  ...
  nobject1 = nobject;
  nodedesiboun1 = nodedesiboun;
  ndesiboun1 = ndesiboun;
...
void *packagingmt(ITG *i) {
  ...
  // printf("indexr=%" ITGFORMAT","ndesia=%" ITGFORMAT",ndesib=%"
  // ITGFORMAT"\n",indexr,ndesia,ndesib);

  FORTRAN(packaging,
          (nodedesiboun1, &ndesiboun1, objectset1, xo1, yo1, zo1, x1, yy1, z1,
           nx1, ny1, nz1, co1, &ifree1, &ndesia, &ndesib, iobject1, ndesi1,
           dgdxglob1, nk1, extnor1, &g01[indexg0], nodenum1));

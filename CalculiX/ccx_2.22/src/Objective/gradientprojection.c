...
void gradientprojection(ITG *nobject, char *objectset, double *dgdxglob,
  ...
  ITG nzss, *mast1 = NULL, *irows = NULL, *icols = NULL, *jqs = NULL,
            *ipointer = NULL, symmetryflag = 0, inputformat = 0, i, iconst,
            iter = 0, nactiveold, *ipoactiold = NULL, *iconstactiold = NULL,
            iscaleflag, nrhs = 1, *inameactiold = NULL, istart;

  double *au = NULL, *ad = NULL, *adb = NULL, *aub = NULL, sigma = 0,
         *rhs = NULL, *vector = NULL, *xlambd = NULL, *xtf = NULL, *dfdx = NULL;
  ...
  for (i = 0; i < *nobject; i++) {
    istart = i + 1;
    FORTRAN(scalesen, (dgdxglob, dfdx, nk, nodedesi, ndesi, objectset,
  ...
  while ((*nactive < nactiveold) && (*nactive > 0)) {
    ...
    mastructnmatrix(icols, jqs, &mast1, &irows, ipointer, &nzss, nactive,
                    nnlconst);
    ...
    FORTRAN(preprojectgrad,
            (vector, ndesi, nodedesi, dgdxglob, nactive, nobject, nnlconst,
             ipoacti, nk, rhs, objectset, xtf));
    ...
    for (iconst = 1; iconst <= *nactive; iconst++) {
      ...
      FORTRAN(projectgrad, (vector, ndesi, nodedesi, dgdxglob, nactive, nobject,
                            nnlconst, ipoacti, nk, rhs, &iconst, objectset,
                            xlambd, xtf, objnorm, gradproj, g0));
    }
    ...
    FORTRAN(checkprojectgrad,
            (&nactiveold, nactive, ipoacti, ipoactiold, objectset, xlambd,
             nnlconst, iconstacti, iconstactiold, inameacti, inameactiold, g0,
  ...
  FORTRAN(calcfeasibledirection_gp,

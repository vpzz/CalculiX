...
void thicknessmain(double *co, ITG *nobject, ITG *nk, ITG *nodedesi, ITG *ndesi,
  ...
  FORTRAN(prethickness, (co, xo, yo, zo, x, y, z, nx, ny, nz, &ifree,
                         nodedesiinv, &ndesiboun, nodedesiboun, set, nset,
                         objectset, iobject, istartset, iendset, ialset));
...
void *thicknessmt(ITG *i) {
  ...
  FORTRAN(thickness,
          (nodedesiboun1, &ndesiboun1, objectset1, xo1, yo1, zo1, x1, yy1, z1,
           nx1, ny1, nz1, co1, &ifree1, &ndesia, &ndesib, iobject1, dgdxglob1,
           nk1, extnor1, &g01[indexg0], coini1));

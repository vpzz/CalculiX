...
static double *au1 = NULL, *ad1 = NULL, *aub1 = NULL, *adb1 = NULL,
              *area1 = NULL, *co1;
...
void filterbackwardmain(double *co, double *dgdxglob, ITG *nobject, ITG *nk,
  ...
  ITG *nx = NULL, *ny = NULL, *nz = NULL, i, j, *mast = NULL, *irow = NULL,
      *icol = NULL, *jq = NULL, *ipointer = NULL, nzs, symmetryflag = 0,
      inputformat = 0, nrhs = 1, iobject, inode, icopy, *nodedesipos = NULL,
      *irowf = NULL, *icolf = NULL, *jqf = NULL, ndesifaces, *idesiface = NULL;

  double *xo = NULL, *yo = NULL, *zo = NULL, *x = NULL, *y = NULL, *z = NULL,
         filterrad, *weighting = NULL, *ad = NULL, *adb = NULL, *au = NULL,
         *aub = NULL, sigma = 0, *rhs = NULL, *adf = NULL, *auf = NULL,
         *temparray = NULL, *area = NULL;
  ...
  if (strcmp1(&objectset[89], "E") == 0) {
    printf(
        " Calculation of backward filtered sensitivities with explicit "
        "method\n\n");
    ...
    FORTRAN(filterbackward_exp,
            (adf, auf, jqf, irowf, ndesi, nodedesi, dgdxglob, dgdx, nobject, nk,
             nobjectstart, weighting));
    ...
    printf(
        " Calculation of backward filtered sensitivities with implicit "
        "method\n\n");

...
void getlocalresults(ITG **integerglobp, double **doubleglobp, ITG *nktet,
  ...
  ITG *ifatetl = NULL, *kon = NULL, *ipkon = NULL, *kontyp = NULL,
      *iparent = NULL, *ielemnr = NULL, *integerglob = NULL, nfaces, netet,
      *nnx = NULL, *nny = NULL, *nnz = NULL, i, j, nkon, ne, n1, n2, n3, n4,
      kflag = 2;
  ...
  memcpy(&doubleglob[*nktet + 4 * nfaces + 6 * netet], &cotet[0],

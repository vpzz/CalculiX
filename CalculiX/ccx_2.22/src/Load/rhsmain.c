...
static ITG *nk1, *kon1, *ipkon1, *ne1, *ipompc1, *nodempc1, *nmpc1, *nodeforc1,
    *ndirforc1, *nforc1, *nelemload1, *nload1, *ipobody1, *nbody1, *nactdof1,
    *neq1, *nmethod1 = NULL, *ikmpc1, *ilmpc1, *nelcon1, *nrhcon1, *nalcon1,
           *ielmat1, *ielorien1, *norien1, *ntmat_1, *ithermal1, *iprestr1,
           *iperturb1, *iexpl1, *nplicon1, *nplkcon1, *npmat_1, *istep1, *iinc1,
           *ibody1, *mi1, *ikactmech1, *nactmech1, *ielprop1, *nstate_1,
           *ntrans1, *inotr1, num_cpus, *neapar = NULL, *nebpar = NULL;

static double *co1, *coefmpc1, *xforcact1, *xloadact1, *xbodyact1, *xbodyact1,
    *cgr1, *elcon1, *rhcon1, *alcon1, *alzero1, *orab1, *t01, *t1act1, *vold1,
    *plicon1, *plkcon1, *ttime1, *time1, *dtime1, *physcon1, *xbodyold1,
    *reltime1, *veold1, *prop1, *sti1, *xstateini1, *xstate1, *trab1,
    *fext1 = NULL, *fnext1 = NULL;
...
void rhsmain(double *co, ITG *nk, ITG *kon, ITG *ipkon, char *lakon, ITG *ne,
  ...
  FORTRAN(merge_ikactmech1,
          (ikactmech1, nactmech1, neq, ikactmech, nactmech, &num_cpus));

  SFREE(ikactmech1);
  SFREE(nactmech1);

  FORTRAN(rhsnodef,
          (co, kon, ne, ipompc, nodempc, coefmpc, nmpc, nodeforc, ndirforc,
           xforcact, nforc, fext, nactdof, nmethod, ikmpc, ntmat_, iperturb, mi,
           ikactmech, nactmech, ntrans, inotr, trab, fnext));
}
...
void *rhsmt(ITG *i) {
  ...
  FORTRAN(rhs,
          (co1, nk1, kon1, ipkon1, lakon1, ne1, ipompc1, nodempc1, coefmpc1,
           nmpc1, nodeforc1, ndirforc1, xforcact1, nforc1, nelemload1,
           sideload1, xloadact1, nload1, xbodyact1, ipobody1, nbody1, cgr1,
           &fext1[indexf], nactdof1, neq1, &nmethod1[*i], ikmpc1, ilmpc1,
           elcon1, nelcon1, rhcon1, nrhcon1, alcon1, nalcon1, alzero1, ielmat1,
           ielorien1, norien1, orab1, ntmat_1, t01, t1act1, ithermal1, iprestr1,
           vold1, iperturb1, iexpl1, plicon1, nplicon1, plkcon1, nplkcon1,

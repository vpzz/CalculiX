...
void arpackcs(
  ...
  char bmat[2] = "G", which[3] = "LM", howmny[2] = "A", *lakont = NULL,
       ...
       filabcp[9] = "        ", lakonl[2] = " \0", *lakon = NULL,
       jobnamef[396] = "", *turdir = NULL;

  ITG *inum = NULL, k, ido, ldz, iparam[11], ipntr[14], lworkl, idir, nherm = 1,
      info, rvec = 1, *select = NULL, lfin, j, lint, iout = 1, nm, index, inode,
      id, i, idof, ielas = 1, icmd = 0, kk, l, nkt, icntrl, *kont = NULL,
      *ipkont = NULL, *inumt = NULL, *ielmatt = NULL, net, imag, icomplex, kkv,
      kk6, iinc = 1, nev, ncv, kscale = 1, mxiter, lprev, ilength, ij, i1, i2,
      iel, ielset, node, indexe, nope, ml1, *inocs = NULL, *ielcs = NULL, jj,
      l1, l2, ngraph, is, jrow, kflag = 2, *inotrt = NULL, symmetryflag = 0,
      inputformat = 0, ifreebody, *iy = NULL, mass = 1, stiffness = 1,
      buckling = 0, rhsi = 0, intscheme = 0, *ncocon = NULL, coriolis = 0,
      iworsttime, l3, iray, mt, kkx, im, ne0, *integerglob = NULL,
      ...
      *nmastnode = NULL, *imastop = NULL, *iponoels = NULL, *inoels = NULL,
      *ipe = NULL, *ime = NULL, mpcfree, memmpc_, icascade, maxlenmpc, nkon0,
      iit = -1, *irow = NULL, nasym = 0, kmax1, kmax2, icfd = 0, *inomat = NULL,
      *ipkon = NULL, *kon = NULL, *ielmat = NULL, *ielorien = NULL,
      *islavact = NULL, *islavsurfold = NULL, nslavs_prev_step, maxprevcontel,
      iflagact = 0, *nmc = NULL, icutb = 0, ialeatoric = 0, *iponoel = NULL,
      *inoel = NULL, network = 0, ioffr, nrhs = 1, ioffrl, igreen = 0,
      mscalmethod = 0, kref, *jqw = NULL, *iroww = NULL, nzsw,
      *islavquadel = NULL, *irowt = NULL, *jqt = NULL, mortartrafoflag = 0;

  double *stn = NULL, *v = NULL, *resid = NULL, *z = NULL, *workd = NULL,
         *vr = NULL, *workl = NULL, *d = NULL, sigma, *temp_array = NULL,
         *vini = NULL, dtset, *een = NULL, cam[5], *f = NULL, *fn = NULL, qa[4],
         *fext = NULL, *emn = NULL, *epn = NULL, *stiini = NULL, *fnr = NULL,
         *fni = NULL, fnreal, fnimag, *emeini = NULL, *xstateini = NULL,
         theta = 0, pi, *coefmpcnew = NULL, *xstiff = NULL, *vi = NULL,
         *vt = NULL, *fnt = NULL, *stnt = NULL, *eent = NULL, *cot = NULL, t[3],
         ctl, stl, *t1t = NULL, freq, *stx = NULL, *enern = NULL,
         *enernt = NULL, *xstaten = NULL, *eei = NULL, *enerini = NULL,
         *cocon = NULL, *qfx = NULL, *qfn = NULL, *qfnt = NULL, tol, fmin, fmax,
         xreal, ximag, *cgr = NULL, *xloadold = NULL, reltime = 1., constant,
         vreal, vimag, *stnr = NULL, *stni = NULL, stnreal, stnimag,
         *vmax = NULL, *stnmax = NULL, vl[4], stnl[6], dd, v1, v2, v3, bb, cc,
         al[3], cm, cn, tt, worstpsmax, vray[3], worstumax, p1[3], p2[3], q[3],
         tan[3], *springarea = NULL, *stxt = NULL, *eenmax = NULL, eenl[6],
         *emnt = NULL, *clearini = NULL, *doubleglob = NULL, *shcon = NULL,
         *cg = NULL, *straight = NULL, *cdn = NULL, *xmastnor = NULL,
         *areaslav = NULL, *dc = NULL, *di = NULL, *xnoels = NULL,
         *workev = NULL, *ener = NULL, *xstate = NULL, cdnimag,
         *temp_array2 = NULL, sigmai = 0, amp, ampmax, *zstorage = NULL,
         *au = NULL, *ad = NULL, cdnreal, *b = NULL, *aub = NULL, *adb = NULL,
         *pslavsurf = NULL, *pmastsurf = NULL, *cdnt = NULL, *cdnr = NULL,
         *cdni = NULL, *eme = NULL, alea = 0.1, sum, *pslavsurfold = NULL,
         *energyini = NULL, *energy = NULL, xn[3], e1[3], e2[3],
         *smscale = NULL, *auw = NULL, *aut = NULL, *dstorage = NULL,
         *distorage = NULL, *physcon = NULL, dtvol, wavespeed[*nmat];
  ...
  if (*nbody > 0) {
    if (*inewton == 1) {
      printf(
          " *ERROR in arpackcs: generalized gravity loading is not allowed in "
  ...
  if (*iperturb != 0) {
    ...
    inicont(nk, &ncont, ntie, tieset, nset, set, istartset, iendset, ialset,
            &itietri, lakon, ipkon, kon, &koncont, nslavs, tietol,
            &ismallsliding, &itiefac, &islavsurf, &islavnode, &imastnode,
            &nslavnode, &nmastnode, mortar, &imastop, nkon, &iponoels, &inoels,
            &ipe, &ime, ne, ifacecount, iperturb, ikboun, nboun, co, istep,
            &xnoels);
    ...
    if (ncont != 0) {
      ...
      if (*mortar == 0) {
        ...
        if ((maxprevcontel == 0) && (*nslavs != 0)) {
          ...
          for (k = *nstate_ * mi[0] * *ne;
               k < *nstate_ * mi[0] * (*ne + *nslavs); k++) {
            xstate[k] = 0.;
          }
        }
        maxprevcontel = *nslavs;
        ...
        *nintpoint = 0;
        ...
        precontact(&ncont, ntie, tieset, nset, set, istartset, iendset, ialset,
                   itietri, lakon, ipkon, kon, koncont, ne, cg, straight, co,
                   vold, istep, &iinc, &iit, itiefac, islavsurf, islavnode,
                   imastnode, nslavnode, nmastnode, imastop, mi, ipe, ime,
                   tietol, nintpoint, &pslavsurf, xmastnor, cs, mcs, ics,
                   clearini, nslavs);
          ...
          if ((*nintpoint > 0) && (maxprevcontel > 0)) {
            ...
            FORTRAN(interpolatestate,
                    (ne, ipkon, kon, lakon, &ne0, mi, xstate, pslavsurf,
                     nstate_, xstateini, islavsurf, islavsurfold, pslavsurfold,
                     tieset, ntie, itiefac));
          }
      ...
      contact(&ncont, ntie, tieset, nset, set, istartset, iendset, ialset,
              ...
              nmethod, iperturb, ikboun, nboun, mi, imastop, nslavnode,
              ...
              jobnamef, &alea, auw, jqw, iroww, &nzsw);

      printf("number of contact spring elements=%" ITGFORMAT "\n\n", *ne - ne0);

      /* determining the structure of the stiffness/mass matrix */

      remastructar(ipompc, &coefmpc, &nodempc, nmpc, &mpcfree, nodeboun,
                   ndirboun, nboun, ikmpc, ilmpc, ikboun, ilboun, labmpc, nk,
                   &memmpc_, &icascade, &maxlenmpc, kon, ipkon, lakon, ne,
                   nactdof, icol, jq, &irow, isolver, neq, nzs, nmethod,
                   ithermal, iperturb, &mass, mi, ics, cs, mcs, mortar,
                   typeboun, &iit, &network, iexpl, ielmat, matname);
    }
  }
  ...
  if (*iperturb == 0) {
    results(
        co, nk, kon, ipkon, lakon, ne, v, stn, inum, stx, elcon, nelcon, rhcon,
        nrhcon, alcon, nalcon, alzero, ielmat, ielorien, norien, orab, ntmat_,
        t0, t0, ithermal, prestr, iprestr, filab, eme, emn, een, iperturb, f,
        fn, nactdof, &iout, qa, vold, b, nodeboun, ndirboun, xboun, nboun,
        ...
        &reltime, &ne0, thicke, shcon, nshcon, sideload, xload, xloadold, &icfd,
        inomat, pslavsurf, pmastsurf, mortar, islavact, cdn, islavnode,
        nslavnode, ntie, clearini, islavsurf, ielprop, prop, energyini, energy,
        &kscale, iponoel, inoel, nener, orname, &network, ipobody, xbody, ibody,
        typeboun, itiefac, tieset, smscale, &mscalmethod, nbody, t0g, t1g,
        islavquadel, aut, irowt, jqt, &mortartrafoflag, &intscheme, physcon);
  } else {
    results(
        co, nk, kon, ipkon, lakon, ne, v, stn, inum, stx, elcon, nelcon, rhcon,
        nrhcon, alcon, nalcon, alzero, ielmat, ielorien, norien, orab, ntmat_,
        t1old, t1old, ithermal, prestr, iprestr, filab, eme, emn, een, iperturb,
        f, fn, nactdof, &iout, qa, vold, b, nodeboun, ndirboun, xboun, nboun,
        ipompc, nodempc, coefmpc, labmpc, nmpc, nmethod, cam, &neq[1], veold,
        accold, &bet, &gam, &dtime, &time, ttime, plicon, nplicon, plkcon,
        nplkcon, xstateini, xstiff, xstate, npmat_, epn, matname, mi, &ielas,
        &icmd, ncmat_, nstate_, stiini, vini, ikboun, ilboun, ener, enern,
    ...
    if (ielset < 0) {
      ...
      for (i1 = istartset[ielset - 1] - 1; i1 < iendset[ielset - 1]; i1++) {
        if (ialset[i1] > 0) {
          ...
          ielcs[iel] = i;
          indexe = ipkon[iel];
          if (strcmp1(&lakon[8 * iel + 3], "2") == 0)
            nope = 20;
          else if (strcmp1(&lakon[8 * iel + 3], "8") == 0)
            nope = 8;
          else if (strcmp1(&lakon[8 * iel + 3], "10") == 0)
            nope = 10;
          else if (strcmp1(&lakon[8 * iel + 3], "4") == 0)
            nope = 4;
          else if (strcmp1(&lakon[8 * iel + 3], "15") == 0)
            nope = 15;
          else if (strcmp1(&lakon[8 * iel + 3], "6") == 0)
            nope = 6;
  ...
  for (nm = cs[1]; nm <= cs[2]; ++nm) {
    ...
    if (*iperturb == 0) {
      FORTRAN(
          ...
          (co, nk, kon, ipkon, lakon, ne, nodeboun, ndirboun, xboun, nboun,
           ...
           nelemload, sideload, xload, nload, xbody, ipobody, nbody, cgr, ad,
           au, fext, nactdof, icol, jq, irow, &neq[1], nzl, nmethod, ikmpc,
           ...
           mi, ics, cs, &nm, ncmat_, labmpc, &mass, &stiffness, &buckling,
      ...
      FORTRAN(
          ...
          (co, nk, kon, ipkon, lakon, ne, nodeboun, ndirboun, xboun, nboun,
           ...
           au, fext, nactdof, icol, jq, irow, &neq[1], nzl, nmethod, ikmpc,
           ilmpc, ikboun, ilboun, elcon, nelcon, rhcon, nrhcon, alcon, nalcon,
           alzero, ielmat, ielorien, norien, orab, ntmat_, t0, t1old, ithermal,
           prestr, iprestr, vold, iperturb, sti, nzs, stx, adb, aub, iexpl,
           plicon, nplicon, plkcon, nplkcon, xstiff, npmat_, &dtime, matname,
           mi, ics, cs, &nm, ncmat_, labmpc, &mass, &stiffness, &buckling,
           &rhsi, &intscheme, mcs, &coriolis, ibody, xloadold, &reltime, ielcs,
      ...
      if (nasym == 1) {
        ...
        FORTRAN(
            ...
            (co, nk, kon, ipkon, lakon, ne, nodeboun, ndirboun, xboun, nboun,
             ...
             plicon, nplicon, plkcon, nplkcon, xstiff, npmat_, &dtime, matname,
             mi, ics, cs, &nm, ncmat_, labmpc, &mass, &stiffness, &buckling,
             &rhsi, &intscheme, mcs, &coriolis, ibody, xloadold, &reltime,
             ielcs, veold, springarea, thicke, integerglob, doubleglob, tieset,
             istartset, iendset, ialset, ntie, &nasym, nstate_, xstateini,
    ...
    if (*nmethod == 0) {
      ...
      frd(co, nk, kon, ipkon, lakon, ne, v, stn, inum, nmethod, kode, filab,
          een, t1, fn, &time, epn, ielmat, matname, enern, xstaten, nstate_,
          istep, &iinc, ithermal, qfn, &j, &nm, trab, inotr, ntrans, orab,
          ielorien, norien, description, ipneigh, neigh, mi, sti, vr, vi, stnr,
          stni, vmax, stnmax, &ngraph, veold, ener, ne, cs, set, nset,
    ...
    if (*isolver == 0) {
#ifdef SPOOLES
      spooles_factor(ad, au, adb, aub, &sigma, icol, irow, &neq[1], nzs,
      ...
      matrixstorage(ad, &au, adb, aub, &sigma, icol, &irow, &neq[1], &nzs[1],
                    ...
                    lakon, kon, ne, mei, nboun, nmpc, cs, mcs, ithermal,
                    nmethod);
    ...
    if (igreen == 0) {
      ...
      if (nasym == 1) {
        ...
        FORTRAN(dnaupd, (&ido, bmat, &neq[1], which, &nev, &tol, resid, &ncv, z,
                         &ldz, iparam, ipntr, workd, workl, &lworkl, &info));
      } else {
        lworkl = ncv * (8 + ncv);
        NNEW(workl, double, lworkl);
        FORTRAN(dsaupd, (&ido, bmat, &neq[1], which, &nev, &tol, resid, &ncv, z,
                         &ldz, iparam, ipntr, workd, workl, &lworkl, &info));
      }
      ...
      while ((ido == -1) || (ido == 1) || (ido == 2)) {
        if (ido == -1) {
          if (nasym == 1) {
            FORTRAN(opas, (&neq[1], &workd[ipntr[0] - 1], temp_array, adb, aub,
                           jq, irow, nzs));
          } else {
            opmain(&neq[1], &workd[ipntr[0] - 1], temp_array, adb, aub, jq,
                   irow);
          }
        }
          ...
          if (ido == -1) {
            if (*isolver == 0) {
...
#ifdef PARDISO
              pardiso_solve(temp_array, &neq[1], &symmetryflag, &inputformat,
                            &nrhs);
#endif
            } else if (*isolver == 8) {
#ifdef PASTIX
              ...
              if (pastix_solve(temp_array, &neq[1], &symmetryflag, &nrhs) == -1)
                printf(
                    " *WARNING in arpackcs: solving step did not converge! "
                    "Continuing anyway!\n");
#endif
#endif
            }
            ...
            if (*isolver == 0) {
              ...
              pardiso_solve(&workd[ipntr[2] - 1], &neq[1], &symmetryflag,
                            &inputformat, &nrhs);
#else
              if (pastix_solve(&workd[ipntr[2] - 1], &neq[1], &symmetryflag,
                               &nrhs) == -1)
                printf(
                    " *WARNING in arpackcs: solving step did not converge! "
                    "Continuing anyway!\n");
        ...
        if (ido == 2) {
          if (nasym == 1) {
            ...
            opmain(&neq[1], &workd[ipntr[0] - 1], &workd[ipntr[1] - 1], adb,
                   aub, jq, irow);
          }
        }
        ...
        if (nasym == 1) {
          FORTRAN(dnaupd,
                  (&ido, bmat, &neq[1], which, &nev, &tol, resid, &ncv, z, &ldz,
      ...
      if (nasym == 1) {
        ...
        FORTRAN(dneupd, (&rvec, howmny, select, d, di, z, &ldz, &sigma, &sigmai,
                         workev, bmat, &neq[1], which, &nev, &tol, resid, &ncv,
        ...
        for (j = 0; j < nev; j++) {
          temp_array2[j] = sqrt(sqrt(d[j] * d[j] + di[j] * di[j]));
          iy[j] = j;
        }
      } else {
        NNEW(d, double, nev);
        FORTRAN(dseupd, (&rvec, howmny, select, d, z, &ldz, &sigma, bmat,
                         &neq[1], which, &nev, &tol, resid, &ncv, z, &ldz,
                         iparam, ipntr, workd, workl, &lworkl, &info));
        for (j = 0; j < nev; j++) {
          temp_array2[j] = d[j];
          iy[j] = j;
      ...
      for (j = 0; j < nev; j++) {
        if (iy[j] != j) {
          ...
          if (nasym == 1) {
            NNEW(dstorage, double, nev);
            NNEW(distorage, double, nev);
          }
          for (k = 0; k < nev; k++) {
            memcpy(&zstorage[k * neq[1]], &z[iy[k] * neq[1]],
                   sizeof(double) * neq[1]);
            if (nasym == 1) {
              dstorage[k] = d[iy[k]];
              distorage[k] = di[iy[k]];
          ...
          memcpy(z, zstorage, sizeof(double) * nev * neq[1]);
          SFREE(zstorage);
          break;
        }
      }
      ...
      if (nasym == 1) {
        ...
        for (j = 0; j < nev; j++) {
          ...
          dc[2 * j + 1] =
              sqrt(sqrt(d[j] * d[j] + di[j] * di[j]) - d[j]) / sqrt(2.);
      ...
      for (j = 0; j < nev; j++) {
        ...
        if (nasym == 1) {
          FORTRAN(opas,
                  (&neq[1], &z[kref], temp_array, adb, aub, jq, irow, nzs));
        } else {
          opmain(&neq[1], &z[kref], temp_array, adb, aub, jq, irow);
        }
        sum = 0;
        for (k = 0; k < neq[1]; k++) {
          sum += z[kref + k] * temp_array[k];
        }
    ...
    if (mei[3] == 1) {
      ...
      if (*nevtot == 0) {
        if ((f1 = fopen(fneig, "wb")) == NULL) {
          printf(
              " *ERROR in arpack: cannot open eigenvalue file for writing...");
          exit(0);
        }
        ...
        if (fwrite(&one, sizeof(ITG), 1, f1) != 1) {
          printf(
              " *ERROR saving the cyclic symmetry flag to the eigenvalue "
              "file...");
          exit(0);
        }
        ...
        if (fwrite(&iperturb[0], sizeof(ITG), 1, f1) != 1) {
          printf(
              " *ERROR saving the perturbation flag to the eigenvalue file...");
          exit(0);
        }
        ...
        if (iperturb[0] == 1) {
          if (fwrite(vold, sizeof(double), mt * *nk, f1) != mt * *nk) {
            printf(
                " *ERROR saving the reference displacements to the eigenvalue "
                "file...");
            exit(0);
          }
        }
      ...
      if (fwrite(&nev, sizeof(ITG), 1, f1) != 1) {
        printf(
            " *ERROR saving the number of eigenfrequencies to the eigenvalue "
            "file...");
        exit(0);
      }
      ...
      if (*nevtot == 0) {
        ...
        if (fwrite(ad, sizeof(double), neq[1], f1) != neq[1]) {
          printf(
              " *ERROR saving the diagonal of the stiffness matrix to the "
              "eigenvalue file...");
          exit(0);
        }
        if (fwrite(au, sizeof(double), nzs[1], f1) != nzs[1]) {
          printf(
              " *ERROR saving the off-diagonal terms of the stiffness matrix "
        ...
        if (fwrite(adb, sizeof(double), neq[1], f1) != neq[1]) {
          printf(
              " *ERROR saving the diagonal of the mass matrix to the "
              "eigenvalue file...");
          exit(0);
        }
        if (fwrite(aub, sizeof(double), nzs[1], f1) != nzs[1]) {
          printf(
              " *ERROR saving the off-diagonal terms of the mass matrix to the "
              "eigenvalue file...");
          exit(0);
        }
      }
    ...
    if (igreen == 0) {
      ...
      if (*ithermal != 2) {
        FORTRAN(effectivemodalmass,
                (neq, nactdof, mi, adb, aub, jq, irow, &nev, z, co, nk));
      }
    }
    ...
    if (((strcmp1(&filab[2175], "CONT") == 0) ||
         (strcmp1(&filab[3915], "PCON") == 0)) &&
        (*mortar == 1))
      NNEW(cdn, double, 12 * *nk);
    ...
    if (strcmp1(&filab[87], "NT  ") == 0) NNEW(t1t, double, *nk *ngraph);
    if ((strcmp1(&filab[174], "S   ") == 0) ||
        (strcmp1(&filab[1479], "PHS ") == 0) ||
        (strcmp1(&filab[1044], "ZZS ") == 0) ||
        (strcmp1(&filab[1044], "ERR ") == 0))
    ...
    if (((strcmp1(&filab[2175], "CONT") == 0) ||
         (strcmp1(&filab[3915], "PCON") == 0)) &&
        (*mortar == 1))
      NNEW(cdnt, double, 2 * 6 * *nk * ngraph);
    ...
    // stresses at the integration points for the error estimator and contact
    // conditions
    ...
    FORTRAN(rectcyl, (cot, v, fn, stn, qfn, een, cs, nk, &icntrl, t, filab,
                      &imag, mi, emn));
    ...
    FORTRAN(rectcyl, (cot, vt, fnt, stnt, qfnt, eent, cs, &nkt, &icntrl, t,
                      filab, &imag, mi, emnt));
    ...
    if (strcmp1(&filab[174], "S   ") == 0) {
      if ((strcmp1(&filab[179], "L") == 0) && (*norien > 0)) {
        printf(
            "\n*WARNING in arpackcs: element fields in cyclic symmetry "
            "calculations\n cannot be requested in local orientations;\n the "
            "global orientation will be used \n\n");
    ...
    for (j = 0; j < nev; ++j) {
      ...
      if (igreen == 0) {
        ...
        if (nactdof[mt * (node - 1) + idir] == 0) {
          printf(
              " *ERROR in linstatic: degree of freedom corresponding to node "
              "%d \n and direction %d is not active: no unit force can be "
              "applied\n",
              node, idir);
          FORTRAN(stop, ());
        }
      ...
      for (k = 0; k < neq[1]; k += neq[1] / 2) {
        ...
        if (*iperturb == 0) {
          results(
              co, nk, kon, ipkon, lakon, ne, &v[kkv], &stn[kk6], inum,
              &stx[kkx], elcon, nelcon, rhcon, nrhcon, alcon, nalcon, alzero,
              ielmat, ielorien, norien, orab, ntmat_, t0, t0, ithermal, prestr,
              iprestr, filab, &eme[kkx], &emn[kk6], &een[kk6], iperturb, f,
              &fn[kkv], nactdof, &iout, qa, vold, &z[lint + k], nodeboun,
              ndirboun, xboun, nboun, ipompc, nodempc, coefmpcnew, labmpc, nmpc,
              ...
              stiini, vini, ikboun, ilboun, ener, &enern[kk], emeini, xstaten,
              ...
              &icfd, inomat, pslavsurf, pmastsurf, mortar, islavact, &cdn[kk6],
              islavnode, nslavnode, ntie, clearini, islavsurf, ielprop, prop,
              energyini, energy, &kscale, iponoel, inoel, nener, orname,
              &network, ipobody, xbody, ibody, typeboun, itiefac, tieset,
          ...
          results(
              co, nk, kon, ipkon, lakon, ne, &v[kkv], &stn[kk6], inum,
              &stx[kkx], elcon, nelcon, rhcon, nrhcon, alcon, nalcon, alzero,
              ielmat, ielorien, norien, orab, ntmat_, t1old, t1old, ithermal,
              prestr, iprestr, filab, &eme[kkx], &emn[kk6], &een[kk6], iperturb,
              f, &fn[kkv], nactdof, &iout, qa, vold, &z[lint + k], nodeboun,
              ndirboun, xboun, nboun, ipompc, nodempc, coefmpcnew, labmpc, nmpc,
              nmethod, cam, &neq[1], veold, accold, &bet, &gam, &dtime, &time,
              ttime, plicon, nplicon, plkcon, nplkcon, xstateini, xstiff,
              xstate, npmat_, epn, matname, mi, &ielas, &icmd, ncmat_, nstate_,
      ...
      FORTRAN(turningdirection,
              (v, e1, e2, xn, mi, nk, &turdir[j], lakon, ipkon, kon, ne, co));
          ...
          if (ialset[i1] > 0) {
            ...
            do {
              ...
              for (l3 = 0; l3 < 360; l3++) {
                ...
                v1 = stnl[0] + stnl[1] + stnl[2];
                v2 =
                    stnl[1] * stnl[2] + stnl[0] * stnl[2] + stnl[0] * stnl[1] -
                    (stnl[5] * stnl[5] + stnl[4] * stnl[4] + stnl[3] * stnl[3]);
                v3 = stnl[0] * (stnl[1] * stnl[2] - stnl[5] * stnl[5]) -
                     stnl[3] * (stnl[3] * stnl[2] - stnl[4] * stnl[5]) +
                     stnl[4] * (stnl[3] * stnl[5] - stnl[4] * stnl[1]);
          ...
          if (ialset[i1] > 0) {
            ...
            do {
              ...
              for (l3 = 0; l3 < 360; l3++) {
                ...
                v1 = eenl[0] + eenl[1] + eenl[2];
                v2 =
                    eenl[1] * eenl[2] + eenl[0] * eenl[2] + eenl[0] * eenl[1] -
                    (eenl[5] * eenl[5] + eenl[4] * eenl[4] + eenl[3] * eenl[3]);
                v3 = eenl[0] * (eenl[1] * eenl[2] - eenl[5] * eenl[5]) -
                     eenl[3] * (eenl[3] * eenl[2] - eenl[4] * eenl[5]) +
                     eenl[4] * (eenl[3] * eenl[5] - eenl[4] * eenl[1]);
      ...
      FORTRAN(rectcyl, (co, v, fn, stn, qfn, een, cs, nk, &icntrl, t, filab,
                        &imag, mi, emn));

      if ((strcmp1(&filab[0], "U  ") == 0) ||
          (strcmp1(&filab[870], "PU  ") == 0)) {
        for (l = 0; l < mt * *nk; l++) {
          vt[l] = v[l];
        }
        for (l = 0; l < mt * *nk; l++) {
          vt[l + mt * *nk * ngraph] = v[l + mt * *nk];
        }
      }
      ...
      if ((strcmp1(&filab[1044], "ZZS ") == 0) ||
          (strcmp1(&filab[1044], "ERR ") == 0) ||
          ((strcmp1(&filab[2175], "CONT") == 0) && (*mortar == 0))) {
        for (l = 0; l < 6 * mi[0] * *ne; l++) {
          stxt[l] = stx[l];
        }
        for (l = 0; l < 6 * mi[0] * *ne; l++) {
          stxt[l + 6 * mi[0] * *ne * ngraph] = stx[l + 6 * mi[0] * *ne];
        }
      }
      if (strcmp1(&filab[2697], "ME  ") == 0) {
        for (l = 0; l < 6 * *nk; l++) {
          ...
          if ((strcmp1(&filab[174], "S   ") == 0) ||
            ...
            for (l1 = 0; l1 < *nk; l1++) {
              if (inocs[l1] == jj) {
                ...
                for (l2 = 0; l2 < 6; l2++) {
                  l = 6 * l1 + l2;
                  stnt[l + 6 * *nk * (i + ngraph)] =
                      stl * stn[l] + ctl * stn[l + 6 * *nk];
                }
              }
            }
          }
          ...
          if (strcmp1(&filab[261], "E   ") == 0) {
            for (l1 = 0; l1 < *nk; l1++) {
              if (inocs[l1] == jj) {
                ...
                for (l2 = 0; l2 < 6; l2++) {
                  l = 6 * l1 + l2;
                  eent[l + 6 * *nk * (i + ngraph)] =
                      stl * een[l] + ctl * een[l + 6 * *nk];
                }
              }
            }
          }
          ...
          if (strcmp1(&filab[2697], "ME  ") == 0) {
            for (l1 = 0; l1 < *nk; l1++) {
              if (inocs[l1] == jj) {
                ...
                for (l2 = 0; l2 < 6; l2++) {
                  l = 6 * l1 + l2;
                  emnt[l + 6 * *nk * (i + ngraph)] =
                      stl * emn[l] + ctl * emn[l + 6 * *nk];
                }
              }
            }
          }
          ...
          if (((strcmp1(&filab[2175], "CONT") == 0) ||
            ...
            for (l1 = 0; l1 < *nk; l1++) {
              if (inocs[l1] == jj) {
                ...
                for (l2 = 0; l2 < 6; l2++) {
                  l = 6 * l1 + l2;
                  cdnt[l + 6 * *nk * (i + ngraph)] =
                      stl * cdn[l] + ctl * cdn[l + 6 * *nk];
                }
              }
            }
          }
          ...
          if ((strcmp1(&filab[348], "RF  ") == 0) ||
            ...
            for (l1 = 0; l1 < *nk; l1++) {
              if (inocs[l1] == jj) {
                ...
                for (l2 = 0; l2 < 4; l2++) {
                  l = mt * l1 + l2;
                  fnt[l + mt * *nk * (i + ngraph)] =
                      stl * fn[l] + ctl * fn[l + mt * *nk];
                }
              }
            }
          }
      ...
      FORTRAN(rectcylvi,
              (cot, &vt[mt * *nk * ngraph], &fnt[mt * *nk * ngraph],
               &stnt[6 * *nk * ngraph], qfnt, &eent[6 * *nk * ngraph], cs, &nkt,
               &icntrl, t, filab, &imag, mi, &emnt[6 * *nk * ngraph]));
      ...
      frd(cot, &nkt, kont, ipkont, lakont, &net, vt, stnt, inumt, nmethod, kode,
          filab, eent, t1t, fnt, &freq, epn, ielmatt, matname, enernt, xstaten,
          nstate_, istep, &iinc, ithermal, qfn, &j, &nm, trab, inotrt, ntrans,
          orab, ielorien, norien, description, ipneigh, neigh, mi, stxt, vr, vi,
          stnr, stni, vmax, stnmax, &ngraph, veold, ener, &net, cs, set, nset,
          istartset, iendset, ialset, eenmax, fnr, fni, emnt, thicke, jobnamec,
          output, qfx, cdnt, mortar, cdnr, cdni, nmat, ielprop, prop, sti);
      if (nm > cs[0] / 2) {
        for (k = 5; k < 11; k++) {
          cs[k] = -cs[k];
        }
    ...
    if (igreen == 0) {
      if ((fmax > -0.5) && (fmax * fmax > d[nev - 1])) {
        printf(
            "\n*WARNING: not all frequencies in the requested interval might "

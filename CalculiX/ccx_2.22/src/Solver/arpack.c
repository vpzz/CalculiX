...
void arpack(double *co, ITG *nk, ITG **konp, ITG **ipkonp, char **lakonp,
  ...
  ITG *inum = NULL, k, ido, ldz, iparam[11], ipntr[14], lworkl, ngraph = 1, im,
      info, rvec = 1, *select = NULL, lfin, j, lint, iout, ielas = 1, icmd = 0,
      mt = mi[1] + 1, iinc = 1, nev, ncv, mxiter, jrow, iprestrsav = 0,
      mass[2] = {1, 1}, stiffness = 1, buckling = 0, rhsi = 0, intscheme = 0,
      noddiam = -1, coriolis = 0, symmetryflag = 0, inputformat = 0,
      *ipneigh = NULL, *neigh = NULL, ne0, *integerglob = NULL, nasym = 0,
      zero = 0, ncont = 0, *itietri = NULL, kref, *koncont = NULL,
      ismallsliding = 0, *itiefac = NULL, *islavsurf = NULL, *islavnode = NULL,
      *imastnode = NULL, *nslavnode = NULL, *nmastnode = NULL, *imastop = NULL,
      *iponoels = NULL, *inoels = NULL, *ipe = NULL, *ime = NULL, mpcfree,
      memmpc_, icascade, maxlenmpc, iit = -1, *irow = NULL, nherm = 1, icfd = 0,
      *inomat = NULL, *ipkon = NULL, *kon = NULL, *ielmat = NULL,
      *ielorien = NULL, *islavact = NULL, maxprevcontel, nslavs_prev_step,
      icutb = 0, iflagact = 0, *islavsurfold = NULL, ialeatoric = 0, kscale = 1,
      network = 0, *iponoel = NULL, *inoel = NULL, nrhs = 1, igreen = 0, node,
      idir, mscalmethod = 0, *jqw = NULL, *iroww = NULL, nzsw,
      *islavquadel = NULL, *irowt = NULL, *jqt = NULL, mortartrafoflag = 0;

  double *stn = NULL, *v = NULL, *resid = NULL, *z = NULL, *workd = NULL, dtset,
         *workl = NULL, *d = NULL, sigma = 1, *temp_array = NULL,
         *pslavsurfold = NULL, *een = NULL, sum, cam[5], *f = NULL, *fn = NULL,
         qa[4], *fext = NULL, *epn = NULL, *fnr = NULL, *fni = NULL,
         *emn = NULL, *emeini = NULL, *xstateini = NULL, *xstiff = NULL,
         *stiini = NULL, *vini = NULL, freq, *stx = NULL, *enern = NULL,
         *xstaten = NULL, *eei = NULL, *enerini = NULL, *fnext = NULL,
         *physcon = NULL, *qfx = NULL, *qfn = NULL, tol, fmin, fmax, pi,
         *cgr = NULL, *xloadold = NULL, reltime = 1., *vr = NULL, *vi = NULL,
         *stnr = NULL, *stni = NULL, *vmax = NULL, *stnmax = NULL,
         *springarea = NULL, *eenmax = NULL, *doubleglob = NULL, *cg = NULL,
         *straight = NULL, *clearini = NULL, *xmastnor = NULL, *areaslav = NULL,
         *xnoels = NULL, theta = 0., *di = NULL, sigmai = 0, *workev = NULL,
         *ener = NULL, *xstate = NULL, *dc = NULL, *au = NULL, *ad = NULL,
         *b = NULL, *aub = NULL, *adb = NULL, *pslavsurf = NULL,
         *pmastsurf = NULL, *cdn = NULL, *energyini = NULL, *energy = NULL,
         *cdnr = NULL, *cdni = NULL, *eme = NULL, alea = 0.1, *smscale = NULL,
         *auw = NULL, *aut = NULL, dtvol, wavespeed[*nmat];
  ...
  if ((strcmp1(&filab[870], "PU  ") == 0) ||
    ...
    printf(
        " *WARNING in arpack: PU, PHS, MAXU or MAX was selected in a frequency "
        "calculation without cyclic symmetry;\n this is not correct; output "
        "request is removed;\n");
    strcpy1(&filab[870], "    ", 4);
  ...
  if (*nbody > 0) {
    if (*inewton == 1) {
      printf(
          " *ERROR in arpack: generalized gravity loading is not allowed in "
  ...
  if (*iperturb != 0) {
    ...
    if (ncont != 0) {
      ...
      remastructar(ipompc, &coefmpc, &nodempc, nmpc, &mpcfree, nodeboun,
                   ...
                   ithermal, iperturb, mass, mi, ics, cs, mcs, mortar, typeboun,
                   &iit, &network, iexpl, ielmat, matname);
    }
  }
  ...
  if (*iperturb == 0) {
    mafillsmmain(
        co, nk, kon, ipkon, lakon, ne, nodeboun, ndirboun, xboun, nboun, ipompc,
        nodempc, coefmpc, nmpc, nodeforc, ndirforc, xforc, nforc, nelemload,
        sideload, xload, nload, xbody, ipobody, nbody, cgr, ad, au, fext,
        nactdof, icol, jq, irow, neq, nzl, nmethod, ikmpc, ilmpc, ikboun,
        ilboun, elcon, nelcon, rhcon, nrhcon, alcon, nalcon, alzero, ielmat,
        ielorien, norien, orab, ntmat_, t0, t0, ithermal, prestr, iprestr, vold,
        iperturb, sti, nzs, stx, adb, aub, iexpl, plicon, nplicon, plkcon,
        nplkcon, xstiff, npmat_, &dtime, matname, mi, ncmat_, mass, &stiffness,
        &buckling, &rhsi, &intscheme, physcon, shcon, nshcon, cocon, ncocon,
        ttime, &time, istep, &iinc, &coriolis, ibody, xloadold, &reltime, veold,
        springarea, nstate_, xstateini, xstate, thicke, integerglob, doubleglob,
    ...
    mafillsmmain(
        ...
        nactdof, icol, jq, irow, neq, nzl, nmethod, ikmpc, ilmpc, ikboun,
        ilboun, elcon, nelcon, rhcon, nrhcon, alcon, nalcon, alzero, ielmat,
        ielorien, norien, orab, ntmat_, t0, t1old, ithermal, prestr, iprestr,
        vold, iperturb, sti, nzs, stx, adb, aub, iexpl, plicon, nplicon, plkcon,
        nplkcon, xstiff, npmat_, &dtime, matname, mi, ncmat_, mass, &stiffness,
        &buckling, &rhsi, &intscheme, physcon, shcon, nshcon, cocon, ncocon,
        ttime, &time, istep, &iinc, &coriolis, ibody, xloadold, &reltime, veold,
        springarea, nstate_, xstateini, xstate, thicke, integerglob, doubleglob,
    ...
    if (nasym == 1) {
      ...
      mafillsmasmain(
          ...
          nelemload, sideload, xload, nload, xbody, ipobody, nbody, cgr, ad, au,
          fext, nactdof, icol, jq, irow, neq, nzl, nmethod, ikmpc, ilmpc,
          ikboun, ilboun, elcon, nelcon, rhcon, nrhcon, alcon, nalcon, alzero,
          ielmat, ielorien, norien, orab, ntmat_, t0, t1old, ithermal, prestr,
          iprestr, vold, iperturb, sti, nzs, stx, adb, aub, iexpl, plicon,
          nplicon, plkcon, nplkcon, xstiff, npmat_, &dtime, matname, mi, ncmat_,
          mass, &stiffness, &buckling, &rhsi, &intscheme, physcon, shcon,
          nshcon, cocon, ncocon, ttime, &time, istep, &iinc, &coriolis, ibody,
          xloadold, &reltime, veold, springarea, nstate_, xstateini, xstate,
          thicke, integerglob, doubleglob, tieset, istartset, iendset, ialset,
          ntie, &nasym, pslavsurf, pmastsurf, mortar, clearini, ielprop, prop,
  ...
  if (*nmethod == 0) {
    ...
    frd(co, nk, kon, ipkon, lakon, ne, v, stn, inum, nmethod, kode, filab, een,
        t1, fn, &time, epn, ielmat, matname, enern, xstaten, nstate_, istep,
        &iinc, ithermal, qfn, &j, &noddiam, trab, inotr, ntrans, orab, ielorien,
        norien, description, ipneigh, neigh, mi, sti, vr, vi, stnr, stni, vmax,
        stnmax, &ngraph, veold, ener, ne, cs, set, nset, istartset, iendset,
  ...
  if (igreen == 0) {
    ...
    while ((ido == -1) || (ido == 1) || (ido == 2)) {
        ...
        if (ido == -1) {
          if (*isolver == 0) {
            ...
            if (pastix_solve(temp_array, &neq[1], &symmetryflag, &nrhs) == -1)
              printf(
                  " *WARNING in arpack: solving step didn't converge! "
                  "Continuing anyway\n");
#endif
#endif
          }
      ...
      if (ido == 2) {
        if (nasym == 1) {
          ...
          opmain(&neq[1], &workd[ipntr[0] - 1], &workd[ipntr[1] - 1], adb, aub,
                 jq, irow);
        }
      }
    ...
    if (nasym == 1) {
      ...
      FORTRAN(dneupd, (&rvec, howmny, select, d, di, z, &ldz, &sigma, &sigmai,
                       workev, bmat, &neq[1], which, &nev, &tol, resid, &ncv, z,
                       &ldz, iparam, ipntr, workd, workl, &lworkl, &info));
      SFREE(workev);
      ...
      NNEW(d, double, nev);
      FORTRAN(dseupd, (&rvec, howmny, select, d, z, &ldz, &sigma, bmat, &neq[1],
                       which, &nev, &tol, resid, &ncv, z, &ldz, iparam, ipntr,
    ...
    for (j = 0; j < nev; j++) {
      kref = j * neq[1];
      if (nasym == 1) {
        FORTRAN(opas, (&neq[1], &z[kref], temp_array, adb, aub, jq, irow, nzs));
      } else {
  ...
  if (mei[3] == 1) {
    ...
    if (fwrite(&zero, sizeof(ITG), 1, f1) != 1) {
      printf(
          " *ERROR saving the cyclic symmetry flag to the eigenvalue file...");
      exit(0);
    }
    ...
    if (fwrite(&nev, sizeof(ITG), 1, f1) != 1) {
      printf(
          " *ERROR saving the number of eigenvalues to the eigenvalue file...");
      exit(0);
    }
    ...
    if (fwrite(au, sizeof(double), nzs[2], f1) != nzs[2]) {
      printf(
          " *ERROR saving the off-diagonal terms of the stiffness matrix to "
          "the eigenvalue file...");
      exit(0);
    }
    ...
    if (fwrite(adb, sizeof(double), neq[1], f1) != neq[1]) {
      printf(
          " *ERROR saving the diagonal of the mass matrix to the eigenvalue "
          "file...");
      exit(0);
    }
  ...
  for (j = 0; j < nev; ++j) {
    ...
    if (igreen == 0) {
      ...
      if (nactdof[mt * (node - 1) + idir] == 0) {
        printf(
            " *ERROR in linstatic: degree of freedom corresponding to node %d "
      ...
      if (neq[1] > 0) {
        if (*isolver == 0) {
          ...
          if (pastix_solve(z, &neq[1], &symmetryflag, &nrhs) == -1)
            printf(
                " *WARNING in arpack: solving step didn't converge! Continuing "
                "anyway\n");
#endif
#endif
        }
    ...
    if (*iperturb == 0) {
      results(co, nk, kon, ipkon, lakon, ne, v, stn, inum, stx, elcon, nelcon,
              ...
              orab, ntmat_, t0, t0, ithermal, prestr, iprestr, filab, eme, emn,
              een, iperturb, f, fn, nactdof, &iout, qa, vold, &z[lint],
              nodeboun, ndirboun, xboun, nboun, ipompc, nodempc, coefmpc,
              labmpc, nmpc, nmethod, cam, &neq[1], veold, accold, &bet, &gam,
              &dtime, &time, ttime, plicon, nplicon, plkcon, nplkcon, xstateini,
              ...
              tieset, smscale, &mscalmethod, nbody, t0g, t1g, islavquadel, aut,
              irowt, jqt, &mortartrafoflag, &intscheme, physcon);
    } else {
      results(co, nk, kon, ipkon, lakon, ne, v, stn, inum, stx, elcon, nelcon,
              rhcon, nrhcon, alcon, nalcon, alzero, ielmat, ielorien, norien,
              orab, ntmat_, t1old, t1old, ithermal, prestr, iprestr, filab, eme,
              emn, een, iperturb, f, fn, nactdof, &iout, qa, vold, &z[lint],
              nodeboun, ndirboun, xboun, nboun, ipompc, nodempc, coefmpc,
              labmpc, nmpc, nmethod, cam, &neq[1], veold, accold, &bet, &gam,
              &dtime, &time, ttime, plicon, nplicon, plkcon, nplkcon, xstateini,
              xstiff, xstate, npmat_, epn, matname, mi, &ielas, &icmd, ncmat_,
    ...
    if (*iperturb == 0) {
      frd(co, nk, kon, ipkon, lakon, ne, v, stn, inum, nmethod, kode, filab,
          een, t1, fn, &freq, epn, ielmat, matname, enern, xstaten, nstate_,
          istep, &iinc, ithermal, qfn, &j, &noddiam, trab, inotr, ntrans, orab,
          ielorien, norien, description, ipneigh, neigh, mi, stx, vr, vi, stnr,
      ...
      frd(co, nk, kon, ipkon, lakon, ne, v, stn, inum, nmethod, kode, filab,
          een, t1old, fn, &freq, epn, ielmat, matname, enern, xstaten, nstate_,
          istep, &iinc, ithermal, qfn, &j, &noddiam, trab, inotr, ntrans, orab,
          ielorien, norien, description, ipneigh, neigh, mi, stx, vr, vi, stnr,
          stni, vmax, stnmax, &ngraph, veold, ener, ne, cs, set, nset,
          istartset, iendset, ialset, eenmax, fnr, fni, emn, thicke, jobnamec,
  ...
  if (igreen == 0) {
    if ((fmax > -0.5) && (fmax * fmax > d[nev - 1])) {
      printf(
          "\n*WARNING: not all frequencies in the requested interval might be "

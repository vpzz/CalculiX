...
void frdvector(double *v, ITG *iset, ITG *ntrans, char *filabl, ITG *nkcoords,
  ...
  ITG i, k, l, nksegment, *inodeset = NULL, nnodeset, nnodeset_, *iy = NULL,
                          kflag;
    ...
    if ((*ntrans == 0) || (strcmp1(&filabl[5], "G") == 0)) {
      for (i = 0; i < *nkcoords; i++) {
        ...
        if (strcmp1(output, "asc") == 0) {
          ...
          fl = (float)v[(mi[1] + 1) * i + 1];
          fwrite(&fl, sizeof(float), 1, f1);
          fl = (float)v[(mi[1] + 1) * i + 2];
          fwrite(&fl, sizeof(float), 1, f1);
          fl = (float)v[(mi[1] + 1) * i + 3];
          fwrite(&fl, sizeof(float), 1, f1);
        } else {
          iw = (int)(i + 1);
          fwrite(&iw, sizeof(int), 1, f1);
      ...
      for (i = 0; i < *nkcoords; i++) {
        ...
        if (inotr[2 * i] == 0) {
          ...
          FORTRAN(transformatrix,
                  (&trab[7 * (inotr[2 * i] - 1)], &co[3 * i], a));
          if (strcmp1(output, "asc") == 0) {
            fprintf(f1, "%3s%10" ITGFORMAT "%12.5E%12.5E%12.5E\n", m1, i + 1,
                    (float)(v[(mi[1] + 1) * i + 1] * a[0] +
                            v[(mi[1] + 1) * i + 2] * a[1] +
                            v[(mi[1] + 1) * i + 3] * a[2]),
                    (float)(v[(mi[1] + 1) * i + 1] * a[3] +
                            v[(mi[1] + 1) * i + 2] * a[4] +
                            v[(mi[1] + 1) * i + 3] * a[5]),
                    (float)(v[(mi[1] + 1) * i + 1] * a[6] +
                            v[(mi[1] + 1) * i + 2] * a[7] +
                            v[(mi[1] + 1) * i + 3] * a[8]));
          } else if (strcmp1(output, "bin") == 0) {
            iw = (int)(i + 1);
            fwrite(&iw, sizeof(int), 1, f1);
            fl = (float)v[(mi[1] + 1) * i + 1] * a[0] +
                 v[(mi[1] + 1) * i + 2] * a[1] + v[(mi[1] + 1) * i + 3] * a[2];
            fwrite(&fl, sizeof(float), 1, f1);
            fl = (float)v[(mi[1] + 1) * i + 1] * a[3] +
                 v[(mi[1] + 1) * i + 2] * a[4] + v[(mi[1] + 1) * i + 3] * a[5];
            fwrite(&fl, sizeof(float), 1, f1);
            fl = (float)v[(mi[1] + 1) * i + 1] * a[6] +
                 v[(mi[1] + 1) * i + 2] * a[7] + v[(mi[1] + 1) * i + 3] * a[8];
            fwrite(&fl, sizeof(float), 1, f1);
          } else {
            iw = (int)(i + 1);
            fwrite(&iw, sizeof(int), 1, f1);
            db = v[(mi[1] + 1) * i + 1] * a[0] + v[(mi[1] + 1) * i + 2] * a[1] +
                 v[(mi[1] + 1) * i + 3] * a[2];
            fwrite(&db, sizeof(double), 1, f1);
            db = v[(mi[1] + 1) * i + 1] * a[3] + v[(mi[1] + 1) * i + 2] * a[4] +
                 v[(mi[1] + 1) * i + 3] * a[5];
            fwrite(&db, sizeof(double), 1, f1);
            db = v[(mi[1] + 1) * i + 1] * a[6] + v[(mi[1] + 1) * i + 2] * a[7] +
                 v[(mi[1] + 1) * i + 3] * a[8];
            fwrite(&db, sizeof(double), 1, f1);
          }
        }

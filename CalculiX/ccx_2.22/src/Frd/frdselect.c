...
void frdselect(double *field1, double *field2, ITG *iset, ITG *nkcoords,
  ...
  ITG i, j, k, l, n, nksegment, ioutall = 0, *inodeset = NULL, nnodeset,
                                nnodeset_, *iy = NULL, kflag;
          ...
          for (j = 0; j < min(6, *ncomp); j++) {
            if (ifield[j] == 1) {
              if (strcmp1(output, "asc") == 0) {
                ...
                fwrite(&field1[i * nfield[0] + icomp[j]], sizeof(double), 1,
                       f1);
              }
            } else {
              if (strcmp1(output, "asc") == 0) {
                ...
                fwrite(&field2[i * nfield[1] + icomp[j]], sizeof(double), 1,
                       f1);
              }
            }
          }
